...
CUSTOM_FLD_MAPPING = $(if $($(subst /,_,$(patsubst %/,%,$(subst //,/,$(subst \,/,$(call lc, $(1))))))), \
                     ...
                     $(if $(wildcard $(subst //,/,$(subst \,/,$(call lc, $(1))))/$(BOARD_VER)/$(strip $(ORIGINAL_FLAVOR))),\
                     $(subst //,/,$(subst \,/,$(call lc, $(1))))/$(BOARD_VER)/$(strip $(ORIGINAL_FLAVOR)),\
...
ifneq ($(ACTION),remake)
  ifneq ($(strip $(MODIS_CONFIG)),TRUE)
	...
	@$(IF_EXIST) $(COMPDETS_DIR) $(THEN) \
		perl ./tools/pack_dep_gcc.pl $(TARGDEP) $(COMPDETS_DIR)\
		$(CMD_END)
    else ifeq ($(strip $(COMPILER)),RVCT)
    ...
    ifeq ($(strip $(MODIS_COMPILER)),MINGW)
	@$(IF_EXIST) $(COMPDETS_DIR) $(THEN) perl ./tools/pack_dep_gcc.pl $(TARGDEP) $(COMPDETS_DIR) $(CMD_END)
    endif
  endif
