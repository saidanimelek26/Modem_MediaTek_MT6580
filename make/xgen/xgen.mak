...
XGEN_INC_DIR += service/tst/local_inc
...
XGEN_INC_DIR += service/tst/database/gv \
                service/tst/database/unionTag \
...
ifeq ($(strip $(MODIS_CONFIG)),TRUE)
  ...
  XGEN_INC_DIR := service/tst/database_modis/gv \
                  service/tst/database_modis/unionTag \
