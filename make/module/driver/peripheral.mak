...
ifeq ($(strip $(PMIC)),MT6350)
   SRC_LIST    += driver/peripheral/src/dcl_pmic6350.c \
				driver/peripheral/src/dcl_pmic6350_init.c \
				driver/peripheral/src/pmic_wrap.c
endif
...
INC_DIR =  \
         ...
         custom/driver/drv/misc_drv/$(strip $(BOARD_VER))/DEFAULT
