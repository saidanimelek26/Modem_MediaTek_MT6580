...
if($LEVEL == 1) {
  ...
  if(-e "$AAPMC_TEMP_FOLDER/~ModemReservedSize_AutoConfig.tmp") {
    ...
    print "perl tools/ModemReservedSize_AutoConfig.pl $AAPMC_MAP_FILE $AAPMC_SYM_FILE $AAPMC_LINKER_SCRIPT $AAPMC_CUSTOM_FOLDER_PATH \"$AAPMC_MAKEFILE\" $AAPMC_TEMP_FOLDER/~ModemReservedSize_AutoConfig.tmp $AAPMC_LOG> $AAPMC_LOG_FOLDER/ModemReservedSize_AutoConfig.log 2>&1\n" if($DEBUG);
    $out_str = "Calculating correct Modem Reserved Size value...";
    $result = system("perl tools/ModemReservedSize_AutoConfig.pl $AAPMC_MAP_FILE $AAPMC_SYM_FILE $AAPMC_LINKER_SCRIPT $AAPMC_CUSTOM_FOLDER_PATH \"$AAPMC_MAKEFILE\" $AAPMC_TEMP_FOLDER/~ModemReservedSize_AutoConfig.tmp $AAPMC_LOG> $AAPMC_LOG_FOLDER/ModemReservedSize_AutoConfig.log 2>&1") ;
