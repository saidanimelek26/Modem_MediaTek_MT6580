...
#****************************************************************************
# subroutine:  custom_EMI_c_file_body_for_sp
# return:      custom_EMI.c file content for SP
#****************************************************************************
sub custom_EMI_c_file_body_for_sp
{
    my ($bb) = @_;
    my $template;
...
// temp solution to avoid build error for custom release
