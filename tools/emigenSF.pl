...
#if defined(MT6251) || defined(MT6255)
        "COMBO_MEM_SFI",
...
typedef enum {
   ...
   ,SFC_Reserved           = 0x6      // Write operation status (Write In Progress Bit)
   ,SFC_DLY_CTL4           = 0x3      // Write operation status (Write In Progress Bit)
   ,SFC_DLY_CTL5           = 0x4      // Write operation status (Write In Progress Bit)
} SF_SFC_Control_Reg_Enum;
#endif
