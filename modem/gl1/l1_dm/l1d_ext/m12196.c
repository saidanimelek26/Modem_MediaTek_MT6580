...
/*MT6166*/          {
/*MT6166*/    #if IS_OPTIMIZED_AFC_INIT_FLOW_SUPPORT
/*MT6166*/             if( l1d_rf.is_nvram_data_ready==1 )
/*MT6166*/    #endif
/*MT6166*/             {
...
/*MT6580RF*/
/*MT6570RF*/ #if IS_RF_MT6570RF
/*MT6570RF*/ #define POR_CW88         0x05841EC4L
/*MT6580RF*/ #else
/*MT6580RF*/ #define POR_CW88         0x05841EC5L
/*MT6580RF*/ #endif
/*MT6580RF*/
/*MT6580RF*/ #if IS_MT6580_CHANGE_POR_SUPPORT
/*MT6580RF*/ #define POR_CW88_GFE2    0x05841EC4L
/*MT6580RF*/ #endif
/*MT6570RF*/ #if IS_MT6570_CHANGE_SIP_LBW_SUPPORT
/*MT6570RF*/ #define POR_CW82_SIP     0x05201260L
/*MT6570RF*/ #endif
...
/*MT6580RF*/ #define POR_CW107        0x06B00024L
/*MT6580RF*/ #define POR_CW94         0x05E0016BL
/*MT6580RF*/
/*MT6580RF*/ unsigned long SDATA_TABLE[]=
/*MT6580RF*/ {
...
/*MT6580RF*/    POR_CW107,  /* Change STX TCL gain */
/*MT6580RF*/    POR_CW94,   /* Raise MMD default supply up for safty */
/*MT6580RF*/    POR_CW99    /* Solve additional channel division number truncation problem */
/*MT6580RF*/ };
/*MT6580RF*/
...
/*MT6580RF*/    IMM_SEND_BSI( SCTRL_IMOD(0,30), BSI_CW(0xBA, 0x000FF) );     //CW186: Change "TXDYN reset" back to Normal Control
...
/*MT6580RF*/
/*MT6580RF*/ #if IS_MT6580_CHANGE_POR_SUPPORT
/*MT6580RF*/ void L1D_RF_Init_change_revisedPOR( void )
/*MT6580RF*/ {
/*MT6580RF*/    extern void L1D_RF_Info_Trace( kal_uint16 idx, kal_int32 v1, kal_int32 v2 );
/*MT6580RF*/    kal_uint32 efuse_ic;
/*MT6580RF*/    efuse_ic = (HW_READ((APBADDR32)(0xA0009314))&0x7);
/*MT6580RF*/    if (efuse_ic == MT6580_GFE2_CODE)
/*MT6580RF*/    {  SDATA_TABLE[POR_CW88_IDX] = POR_CW88_GFE2;  }
/*MT6580RF*/    L1D_RF_Info_Trace( 204, efuse_ic, SDATA_TABLE[POR_CW88_IDX] );
/*MT6580RF*/ }
/*MT6580RF*/ #endif
/*MT6570RF*/
/*MT6570RF*/ #if IS_MT6570_CHANGE_SIP_LBW_SUPPORT
/*MT6570RF*/ void L1D_RF_Init_change_sip_revisedPOR( void )
/*MT6570RF*/ {
/*MT6570RF*/    extern void L1D_RF_Info_Trace( kal_uint16 idx, kal_int32 v1, kal_int32 v2 );
/*MT6570RF*/    kal_uint32 efuse_sip;
/*MT6570RF*/    efuse_sip = (HW_READ((APBADDR32)(0xA0009040))&MT6570_SIP_MASK);
/*MT6570RF*/    if (efuse_sip == MT6570_SIP_CODE)
/*MT6570RF*/    {  SDATA_TABLE[POR_CW82_IDX] = POR_CW82_SIP;  
/*MT6570RF*/       l1d_rf.is_sip = 1;
/*MT6570RF*/    }
/*MT6570RF*/    else
/*MT6570RF*/    {
/*MT6570RF*/       l1d_rf.is_sip = 0;
/*MT6570RF*/    }
/*MT6570RF*/    L1D_RF_Info_Trace( 205, l1d_rf.is_sip, SDATA_TABLE[POR_CW82_IDX] );
/*MT6570RF*/ }
/*MT6570RF*/ #endif
#endif
