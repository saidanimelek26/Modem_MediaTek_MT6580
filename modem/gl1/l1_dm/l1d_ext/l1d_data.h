 ...
 * .
 *
 * 04 02 2013 chunyen.wu
 * [MOLY00013385] [L1D][Modify] Change the order of CAPID and AFC DAC setting & delete _SET_BPI_IMM_MODE_BEGIN&end
 * .
 *
 * 03 19 2013 ola.lee
 ...
 *
 * 08 23 2012 cs.wu
 * [MOLY00001491] [MT6517+3001][Lab test][Beijing][RRM][3.3.3.10.5]4.3.9.6_fail
 * .
 *
...
#define  TQ_FSWIN_STOP_FSYNC                 (TQ_VALIDATE+10)
   ...
   #if IS_CHIP_MT6571
#define  TQ_BSI_READ_TIME                    (TQ_SLOT0_BEGIN+TQ_SLOT_LEN)
   #else
...
#if IS_CHIP_MT6205_AND_LATTER_VERSION || IS_EDGE_CHIP_MT6229_AND_LATTER_VERSION
   #if IS_FDD_DUAL_MODE_SUPPORT || IS_TDD_DUAL_MODE_SUPPORT
      #if IS_EDGE_SAIC_CHIP_MT6270A_AND_LATTER_VERSION || IS_CHIP_MT6268H || IS_AST_B2S_SUPPORT || IS_CHIP_MT6280 || IS_CHIP_MT6583_MD1 || IS_CHIP_MT6583_MD2 || IS_CHIP_MT6572
...
#define FHC_PROC_UTS_GAIN_RF_IDX       0x08
   #endif
/*
   #if IS_GPRS
...
extern CONST short   txpc_epsk_tp_3rd_slope_lb;
extern CONST short   txpc_epsk_tp_3rd_slope_hb;
extern CONST short   txpc_epsk_tp_turn_slope_temp_h;
extern CONST short   txpc_epsk_tp_turn_slope_temp_l;
      #endif
   #endif
