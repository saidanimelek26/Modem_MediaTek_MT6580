...
#define GGE_MIPI_EVNET_TIMING_CHECK_MARGIN 4 /* (1/60MHz)*(256+N) ~= 4.2Qb , 256 Data table size */
   #else
#error "Please define mipi event gap (GGE_MIPI_EVNET_TIMING_CHECK_MARGIN) at l1d_mipi_data.c"
   #endif

#define GGE_MIPI_TXMID_EVNET_TIMING_CHECK_MARGIN 5 /* GGE_MIPI_EVNET_TIMING_CHECK_MARGIN + 1QB, since ST2M_G8/ST2M_8G has more BSI data */
