 ...
 * .
 *
 * 10 02 2015 hosen.chen
 * [MOLY00143931] [Rainier][UL1D][RF] FDD band TX addition channel solution modified
 * 	.
 *
 * 08 25 2015 siyu.li
 ...
 * .
 *
 * 03 07 2013 hosen.chen
 * [MOLY00010389] [L1D][Modify] Add retry mechanism for SPI conflict with TDD
 * .
 *
 ...
 * [MOLY00009340] [EE][CMCC case][FT][MT6589+GEMINI][Hangzhou][2 round][C1.1][M]_�S��?���G-3_��7?_13:31:21_?��Externel (EE),0,0,99,/data/core/,1,modem,md2_B����
 * .
 *
...
#endif
#if IS_CHIP_MT6580
   unsigned char first_tx_slot;
#endif
#if IS_MT6570_CHANGE_SIP_LBW_SUPPORT
   unsigned short is_sip;
#endif
}  sRFSETTING;
...
{
   int            arfcn;
#if IS_EPSK_TX_SUPPORT || IS_RF_MT6162 || IS_RF_MT6163 || IS_RF_MT6280RF || IS_RF_MT6167 || IS_RF_MT6166 || IS_RF_MT6165 || IS_RF_MT6580RF
   ...
   #elif IS_RF_MT6256RF || IS_RF_MT6280RF || IS_RF_MT6167 || IS_RF_MT6166 || IS_RF_MT6165 || IS_RF_MT6580RF
      #if IS_EPSK_TX_SUPPORT
   unsigned short tx_gain_setting[TXPC_SLOT_MAX];
      #endif
   #endif
#endif
#if IS_RF_MT6280RF || IS_RF_MT6167 || IS_RF_MT6166 || IS_RF_MT6580RF
   char           is_2g_on;                 /* for 3G to check if 2G is on and decide if doing RF_Power_On or RF_Power_Off */
   ...
   #elif IS_RF_MT6167
   unsigned short tmeas_sbcal;              /* TMEAS_SBCAL[1:0] for CW225 FBX setting */
   #endif
...
#if IS_RF_MT6256RF || IS_RF_MT6251RF || IS_RF_MT6255RF || IS_RF_MT6280RF || IS_RF_MT6167 || IS_RF_MT6166 || IS_RF_MT6165 || IS_RF_MT6580RF
...
#if IS_RF_MT6167
unsigned long L1D_RF_GetRxFBXSetting(int rf_band, int arfcn);
#endif
...
#define TX_GAINSTEP_CAL_ON       0x02
#define RCAL_CAL_ON              0x04

/* For Check Power On Cal. Done Flag */
#define RXRC_CAL_DONE            0x01
#define TXGAIN_STEP_CAL_DONE     0x02
#define RCAL_CAL_DONE            0x04

/* RCAL */
#define POR_CW135                0x08742050L
#define CALR_CONST_MASK          0x0000001FL  //  5 bits length

/* RX RC Value */
#define POR_CW23                 0x01708000L
#define RXIF_RCK_MASK            0x0000003FL  //  6 bits length

/* For Tx Gain Step Cal. */
#define POR_CW80                 0x05000002L
#define POR_CW79                 0x04F001FBL//0x04F00003L
#define POR_CW75                 0x04B00E60L
#define POR_CW36                 0x02420180L
#define POR_CW41                 0x02900000L
#define POR_CW42                 0x02A40030L
#define POR_CW34                 0x02298000L
#define POR_CW37                 0x02520030L
...
/* For SRX Setting */
#define POR_CW100                0x06400000L
#define POR_CW225                0x0E130000L
#define POR_CW234                0x0EA41C00L
#define POR_CW223                0x0DF00024L
...
#define RXLNA_NODET_EN           (0x1<<15)          // Dual Talk Setting
   #elif IS_CHIP_MT6571
#define RXLNA_NODET_EN           (0x0<<15)          // Single Talk Setting
   #else
#error "Please use correct setting for dual talk/single talk"
   #endif
...
/* For Gain Setting */
#define POR_CW131                0x083519A8L
#define GAIN_SETTING_MASK        (0x00003FE0)
#define GAIN_PA                  1120 /*     35(dB)  * 32, S10.5 */
...
/* RX RC Value */
#define POR_CW144                0x09080040L
#define RXIF_RCK_MASK            0x0000007FL  //  7 bits length

/* For Tx Gain Step Cal. */
#define POR_CW87                 0x05700000L
#define POR_CW36                 0x02400180L
#define POR_CW41                 0x02900000L
#define POR_CW42                 0x02A40020L
#define POR_CW34                 0x022A8020L
#define POR_CW35                 0x02310000L
#define POR_CW43                 0x02B2D040L
#define POR_CW45                 0x02D11000L
#define POR_CW47                 0x02F00000L
#define TX_2GHB_EN               (0x1<<0)
#define TX_2GLB_EN               (0x1<<4)
#define TX_DAC_EN_M              (0x1<<4)
#define TX_DAC_EN_MAN            (0x1<<6)
...
/* For STX Setting */
#define POR_CW99                 0x06300000L
#define POR_CW117                0x07508874L

/* For Co-Clock Setting */
#define POR_CW247                0x0F78CCFFL

/* For DCXO Setting */
#define POR_CW250                0x0FA61D40L
#endif
...
kal_uint32 L1D_MIPI_Parity_Bit_Ext(kal_uint32 addr, kal_uint32 usId, kal_uint8 bc);
...
/*    BSI codeword marco                                                         */
/*===============================================================================*/
#if IS_CHIP_MT6256 || IS_CHIP_MT6251 || IS_CHIP_MT6255 || IS_CHIP_MT6250 || IS_CHIP_MT6280 || IS_CHIP_MT6583_MD1 || IS_CHIP_MT6572
...
#if IS_RF_MT6163 || IS_RF_MT6280RF || IS_RF_MT6167 || IS_RF_MT6166 || IS_RF_MT6165 || IS_RF_MT6580RF
#define CLK_BUF_NUM              (4)
#else
#error "Please check the maximum clock buffer number of RF"
#endif
...
#endif /* IS_RF_MT6280RF || IS_RF_MT6167 || IS_RF_MT6166*/
...
/*===============================================================================*/
/* For MT6572/MT6571 & AST3002 RF power-on/off check                             */
/*===============================================================================*/
...
/*===============================================================================*/
   ...
   #if L1D_CUSTOM_DYNAMIC_SUPPORT
#define  L1D_CUSTOM_GPIO_MAX_NUM_OF_DEFINED_DETECT_PIN_NAME  4
...
extern signed long IPC_RPC_ADC_GetValue( unsigned long ADCNumber, unsigned long *ADCValue );
      #endif
      #if L1D_CUSTOM_MEMORY_DATA_ENABLE
extern signed long IPC_RPC_MemoryData_GetValue(unsigned int MemoryDataNumber,unsigned int * MemoryDataValue);
      #endif
   #endif
...
/*===============================================================================*/
/* for MT6580 CHANGE POR support                                                 */
/*===============================================================================*/
#if IS_MT6580_CHANGE_POR_SUPPORT
#define MT6580_GFE2_CODE         0x04
#define POR_CW88_IDX             13
void L1D_RF_Init_change_revisedPOR( void );
#endif

/*===============================================================================*/
/* for MT6570 CHANGE SIP POR support                                             */
/*===============================================================================*/
#if IS_MT6570_CHANGE_SIP_LBW_SUPPORT
#define MT6570_SIP_MASK          0x80000000
#define MT6570_SIP_CODE          0x80000000
#define POR_CW82_IDX             29
void L1D_RF_Init_change_sip_revisedPOR( void );
#endif
