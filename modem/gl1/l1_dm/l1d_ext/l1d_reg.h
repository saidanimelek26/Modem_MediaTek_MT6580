 ...
 * [MOLY00009340] [EE][CMCC case][FT][MT6589+GEMINI][Hangzhou][2 round][C1.1][M]_特殊?景二-3_第7?_13:31:21_?屏Externel (EE),0,0,99,/data/core/,1,modem,md2_B手机
 * .
 *
 * 01 09 2013 sean.yang
...
#define MIPI_SCTRL_WORD( dev_sel, bit_count, port, event_id )  ((unsigned long)(((dev_sel)<<15)|((bit_count-1)<<8)|((port)<<6)|(event_id&0x3F)))
#define MIPI_SCTRL_IMOD( dev_sel, bit_count, port           )  ((unsigned long)(((dev_sel)<<15)|((bit_count-1)<<8)|((port)<<6)|(         0x3F)))
   #endif
#endif
...
{  long     _d32, _d_idx=data_idx;                                                                         \
   ...
   _reg = BSI_Dn_CON( _d_idx );                                                                            \
   _d32 = ctrl5;  HW_WRITE( _reg, TO_WORD(_d32) );      _reg += 2;                                         \
...
{  long     _d32, _d_idx=data_idx;                                                                                      \
   ...
   _reg = BSI_Dn_CON( _d_idx );                                                                                         \
   _d32 = ctrl6;  HW_WRITE( _reg, TO_WORD(_d32) );      _reg += 2;                                                      \
...
{  long     _d32, _d_idx=data_idx;                                                                                                   \
   ...
   _reg = BSI_Dn_CON( _d_idx );                                                                                                      \
   _d32 = ctrl7;  HW_WRITE( _reg, TO_WORD(_d32) );      _reg += 2;                                                                   \
...
{  long     _d32, _d_idx=data_idx;                                                                                                                 \
   ...
   _reg = BSI_Dn_CON( _d_idx );                                                                                                                    \
   _d32 = ctrl8;  HW_WRITE( _reg, TO_WORD(_d32) );      _reg += 2;                                                                                 \
...
{  long     _d32, _d_idx=data_idx;                                                                                                                               \
   ...
   _reg = BSI_Dn_CON( _d_idx );                                                                                                                                  \
   _d32 = ctrl9;  HW_WRITE( _reg, TO_WORD(_d32) );      _reg += 2;                                                                                               \
...
{  long     _d32, _d_idx=data_idx;                                                                                                                                                \
   ...
   _reg = BSI_Dn_CON( _d_idx );                                                                                                                                                   \
   _d32 = ctrl10; HW_WRITE( _reg, TO_WORD(_d32) );      _reg += 2;                                                                                                                \
...
{  long     _d32, _d_idx=data_idx;                                                                                                                                                                \
   ...
   _reg = BSI_Dn_CON( _d_idx );                                                                                                                                                                   \
   _d32 = ctrl11; HW_WRITE( _reg, TO_WORD(_d32) );      _reg += 2;                                                                                                                                \
...
{  long     _d32, _d_idx=data_idx;                                                                                                                                                                                \
   ...
   _reg = BSI_Dn_CON( _d_idx );                                                                                                                                                                                   \
   _d32 = ctrl12; HW_WRITE( _reg, TO_WORD(_d32) );      _reg += 2;                                                                                                                                                \
...
{  long     _d32, _d_idx=data_idx;                                                                                                                                                                                \
   ...
   _reg = BSI_Dn_CON( _d_idx );                                                                                                                                                                                   \
   _d32 = ctrl13; HW_WRITE( _reg, TO_WORD(_d32) );      _reg += 2;                                                                                                                                                \
...
{  long     _d32, _d_idx=data_idx;                                                                                                                                                                                \
   ...
   _d32 = data13; HW_WRITE( (APBADDR32)(_reg), _d32 );  _d_idx++;                                                                                                                                                 \
   _reg = BSI_Dn_CON( _d_idx );                                                                                                                                                                                   \
   _d32 = ctrl14; HW_WRITE( _reg, TO_WORD(_d32) );      _reg += 2;                                                                                                                                                \
...
#if IS_CHIP_MT6256 || IS_CHIP_MT6251 || IS_CHIP_MT6255
...
#define RX_NBFIR_COEF(n)         ((APBADDR)(BFE_base+0x0840+(n)*4))
#define RX_FIR_COEF(n)           ((APBADDR)(BFE_base+0x0870+(n)*4))
      #if IS_CHIP_MT6250 || IS_CHIP_MT6280 || IS_CHIP_MT6583_MD1 || IS_CHIP_MT6583_MD2 || IS_CHIP_MT6572
      #else
...
#define W_IMMDT_REG              RX_W_FRC
      #elif IS_CHIP_MT6256 || IS_CHIP_MT6255 || IS_CHIP_MT6280 || IS_CHIP_MT6583_MD1 || IS_CHIP_MT6583_MD2 || IS_CHIP_MT6572
...
#define DIG_CON61                ((APBADDR)(ABB_MIXEDSYS_base+0x184))        /* DIG Control Register 61                       */
#define DIG_CON62                ((APBADDR)(ABB_MIXEDSYS_base+0x188))        /* DIG Control Register 62                       */
...
#define LTEBBRX_CON20            ((APBADDR)(ABB_MIXEDSYS_base+0xA80))        /* LTEBBRX Control Register 20                   */
#define LTEBBRX_CON21            ((APBADDR)(ABB_MIXEDSYS_base+0xA84))        /* LTEBBRX Control Register 21                   */
...
#define BBRX_CON2                ((APBADDR)(ABB_MIXEDSYS_base+0x0028))  /* BBRX Control Register 2                       */
#define BBRX_CON4                ((APBADDR)(ABB_MIXEDSYS_base+0x0030))  /* BBRX Control Register 4                       */
...
#define BBTX_CON4                ((APBADDR)(ABB_MIXEDSYS_base+0x00B0))  /* BBTX Control Register 4                       */
#define BBTX_CON5                ((APBADDR)(ABB_MIXEDSYS_base+0x00B4))  /* BBTX Control Register 5                       */
#define BBTX_CON6                ((APBADDR)(ABB_MIXEDSYS_base+0x00B8))  /* BBTX Control Register 6                       */
#define BBTX_CON7                ((APBADDR)(ABB_MIXEDSYS_base+0x00BC))  /* BBTX Control Register 7                       */
...
#define DIG_CON7                 ((APBADDR)(ABB_MIXEDSYS_base+0x011C))  /* DIG Control Register 7                        */
...
#define DIG_CON1A                ((APBADDR)(ABB_MIXEDSYS_base+0x0168))  /* DIG Control Register 1A                       */
...
#define AFC_EV(n)                ((APBADDR)(TDMA_base+0x0020+((n)*4)))                           /* AFC control n [13:0] */
   #endif
   #if IS_NEW_TDMA_CHIP
#define BSI_EV(n)                ((APBADDR)(TDMA_base+0x00B0+((n)*4)+(((n)/20)*624)+(((n)/36)*16)-(((n)/40)*624)+(((n)/42)*1064)))
   #else
...
#if IS_CHIP_MT6268T || IS_CHIP_MT6268 || IS_EDGE_SAIC_CHIP_MT6270A_AND_LATTER_VERSION || IS_CHIP_MT6280 || IS_CHIP_MT6583_MD1 || IS_CHIP_MT6583_MD2 || IS_CHIP_MT6572
...
#define GSM2FRC_IMM              ((APBADDR)(TDMA_base+0x030C))          /* MT6276_E1 and MT6573 E1&E2 do NOT have this register */
   #endif
#endif
#if IS_EDGE_SAIC_CHIP_MT6270A_AND_LATTER_VERSION || IS_CHIP_MT6280 || IS_CHIP_MT6583_MD1 || IS_CHIP_MT6583_MD2 || IS_CHIP_MT6572
...
#if IS_SOC_CHIP || IS_CHIP_MT6236 || IS_CHIP_MT6276_S01 || IS_CHIP_MT6250 || IS_CHIP_MT6280 || IS_CHIP_MT6583_MD1 || IS_CHIP_MT6583_MD2 || IS_CHIP_MT6572
...
#if IS_EDGE_SAIC_CHIP_MT6256_AND_LATTER_VERSION || IS_COSIM_ON_L1SIM_SUPPORT
   #if IS_CHIP_MT6280 || IS_CHIP_MT6583_MD1 || IS_CHIP_MT6583_MD2 || IS_CHIP_MT6572 || IS_COSIM_ON_L1SIM_SUPPORT
/* ===================================================================================================================== */
/* for MT6280 & MT6583 & MT6572                                                                                          */
/* --------------------------------------------------------------------------------------------------------------------- */
#define GSM_BSI_CON              ((APBADDR32)(BSI_base+0x0000))         /* BSI control register                          */
#define GSM_BSI_Dn_CON(n)        ((APBADDR)  (BSI_base+0x0004+(8*(n)))) /* data n control                                */
#define GSM_BSI_Dn_DAT(n)        ((APBADDR32)(BSI_base+0x0008+(8*(n)))) /* data [31:0]                                   */
#define UMTS_BSI_CON             ((APBADDR32)(BSI_base+0x0708))
...
/* BSI MIPI Control                                                                                                      */
/* --------------------------------------------------------------------------------------------------------------------- */
#define UMTS_BSI_MIPI_CON        ((APBADDR)  (BSI_base+0x0CF0))         /* Dual BSI MIPI Control                         */
#define GSM_BSI_MIPI_BURST_EN0   ((APBADDR32)(BSI_base+0x0CF4))         /* GSM BSI MIPI burst write enable               */
#define GSM_BSI_MIPI_BURST_EN1   ((APBADDR32)(BSI_base+0x0CF8))         /* GSM BSI MIPI burst write enable               */
/* --------------------------------------------------------------------------------------------------------------------- */
      #endif
...
#define BPI_EN2                  ((APBADDR)   (BPI_base+/*0x0084*/0x00B8))/* BPI event enable register                   */
   #elif IS_CHIP_MT6268T || IS_CHIP_MT6268H || IS_CHIP_MT6268 || IS_EDGE_SAIC_CHIP_MT6270A_AND_LATTER_VERSION || IS_CHIP_MT6280 || IS_CHIP_MT6583_MD1 || IS_CHIP_MT6583_MD2 || IS_CHIP_MT6572
...
#define BPI_MASK                 ((APBADDRBPI)(BPI_base+/*0x0080*/0x00B8))/* Mask for GSM Bus shared output              */
      #if IS_EDGE_SAIC_CHIP_MT6270A_AND_LATTER_VERSION || IS_CHIP_MT6268H || IS_CHIP_MT6280 || IS_CHIP_MT6583_MD1 || IS_CHIP_MT6583_MD2 || IS_CHIP_MT6572
...
#define APC_OFS(n)               ((APBADDR)(APC_base+0x0018+((n)*32)))  /* Rampdown Profile #n                           */
   #if IS_CHIP_SER_AND_LATTER(CHIP_ID_MT6276) || IS_CHIP_MT6280 || IS_CHIP_MT6583_MD1 || IS_CHIP_MT6583_MD2 || IS_CHIP_MT6572
...
/*MT6516*/ #define PDN_CON_BSI              0x0008
   ...
   #if IS_CHIP_MT6276 || IS_CHIP_MT6575 || IS_CHIP_MT6573 || IS_CHIP_MT6250 || IS_CHIP_MT6280 || IS_CHIP_MT6583_MD1 || IS_CHIP_MT6583_MD2 || IS_CHIP_MT6572
...
#elif IS_CHIP_MT6250 || IS_CHIP_MT6280 || IS_CHIP_MT6583_MD1 || IS_CHIP_MT6583_MD2 || IS_CHIP_MT6572
...
#elif IS_CHIP_MT6256 || IS_CHIP_MT6251 || IS_CHIP_MT6255 || IS_CHIP_MT6250 || IS_CHIP_MT6280 || IS_CHIP_MT6583_MD1 || IS_CHIP_MT6583_MD2 || IS_CHIP_MT6572
#define DSPCLK_CON               ((APBADDR)(MD2GCONFG_base+0x040))      /* DSP Clock Control Register                    */
...
#endif
#if IS_CHIP_MT6571
#define GPIO_CFG_base            0xA0014000
#define GPIO_DRV_CFG0            ((APBADDR32)(GPIO_CFG_base+0x00F0))
#elif IS_CHIP_MT6572
/* ===================================================================================================================== */
/* for MT6572                                                                                                            */
/* --------------------------------------------------------------------------------------------------------------------- */
...
#elif IS_CHIP_MT6582
#define Efuse_R8_DL_UL_APC       ((APBADDR32)(0xA0206170))
#define Efuse_R8_DL              Efuse_R8_DL_UL_APC                     /* efuse_R8_DL           */
#define Efuse_R8_UL              Efuse_R8_DL_UL_APC                     /* efuse_R8_UL           */
#define Efuse_APC                Efuse_R8_DL_UL_APC                     /* efuse_APC             */
#elif IS_CHIP_MT6592
#define Efuse_R8_DL_UL_APC       ((APBADDR32)(0xA0206180))
#define Efuse_R8_DL              Efuse_R8_DL_UL_APC                     /* efuse_R8_DL           */
#define Efuse_R8_UL              Efuse_R8_DL_UL_APC                     /* efuse_R8_UL           */
#define Efuse_APC                Efuse_R8_DL_UL_APC                     /* efuse_APC             */
#elif IS_CHIP_MT6571
#define Efuse_R8_DL              ((APBADDR32)(0xA0009000+0x0178))       /* efuse_R8_DL           */
#define Efuse_R8_UL              ((APBADDR32)(0xA0009000+0x0180))       /* efuse_R8_UL           */
#define Efuse_APC                ((APBADDR32)(0xA0009000+0x0180))       /* efuse_APC             */
#endif
