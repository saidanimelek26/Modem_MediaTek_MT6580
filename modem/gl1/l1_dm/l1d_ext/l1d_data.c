 ...
 * .
 *
 * 11 18 2013 vend_cuthbert.kao
 * [MOLY00041060] [MT6571] Feature for Crystal Thermal Change Improvement
 * Removed AFC_TRACKING_PERIOD_AP_ON & unsigned short AFC_TRACKING_PERIOD_AP_OFF.
 *
 ...
 *
 * 03 11 2013 cs.wu
 * [MOLY00011431] [UPA][1st Round ][MT6589_K89V2][CMCC Case][FT][Taizhou_Z][U1.3][K]_3G-2G¦Z_3G-2G¦Z_²Ä8?_11¡G13¡G19_±¼?_A¡]MO¡^B¡]MT¡^
 * .
 *
 * 03 06 2013 cs.wu
 * [MOLY00011431] [UPA][1st Round ][MT6589_K89V2][CMCC Case][FT][Taizhou_Z][U1.3][K]_3G-2G¦Z_3G-2G¦Z_²Ä8?_11¡G13¡G19_±¼?_A¡]MO¡^B¡]MT¡^
...
#error "QB_SR2 should be 11QB larger than QB_RX_FENA_2_FSYNC"
      #endif
   #elif IS_RF_MT6280RF || IS_RF_MT6167
...
#error "please add the timing constraints for QB_PR1 and QB_PR2 in l1d_data.c"
   ...
   #if IS_RF_MT6580RF
      #if TXPC_EPSK_TURN_SLOPE_TEMP_L >= TXPC_EPSK_TURN_SLOPE_TEMP_H
#error "Low Temperture turning point should be less than Low Temperture turning point"
      #endif
   #endif
#endif
...
/*MT6229,L1D_TEST~*/     /*-------------------------------------*/
/*MT6229,L1D_TEST~*/ };
      #elif IS_CHIP_MT6256 || IS_CHIP_MT6255 || IS_CHIP_MT6250 || IS_CHIP_MT6280 || IS_CHIP_MT6583_MD1 || IS_CHIP_MT6583_MD2 || IS_CHIP_MT6572
...
CONST short TQ_TxSampleOffsetEPSK   = QB_TX_SAMPLE_OFFSET_EPSK;
   ...
   #if IS_CHIP_MT6256 || IS_CHIP_MT6280 || IS_CHIP_MT6583_MD1 || IS_CHIP_MT6583_MD2 || IS_CHIP_MT6572 || IS_EDGE_SAIC_CHIP_MT6270A_AND_LATTER_VERSION
...
CONST short txpc_epsk_tp_slope_hb   = TXPC_EPSK_TP_SLOPE_HB;
      ...
      #if IS_TXPC_3_SECTION_COMPENSATION_SUPPORT
CONST short txpc_epsk_tp_3rd_slope_lb = TXPC_EPSK_TP_THIRD_SECTION_SLOPE_LB;
CONST short txpc_epsk_tp_3rd_slope_hb = TXPC_EPSK_TP_THIRD_SECTION_SLOPE_HB;
CONST short txpc_epsk_tp_turn_slope_temp_h = TXPC_EPSK_TURN_SLOPE_TEMP_H;
CONST short txpc_epsk_tp_turn_slope_temp_l = TXPC_EPSK_TURN_SLOPE_TEMP_L;
      #endif
   #endif
#endif
