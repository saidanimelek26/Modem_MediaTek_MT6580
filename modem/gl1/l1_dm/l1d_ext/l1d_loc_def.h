...
#define IS_DCXO_ENABLE                             0
   #endif
#elif IS_SOC_CHIP || IS_MT6162_6163_DCXO_SUPPORT || IS_CHIP_MT6572
#define IS_AFC_EVENT_ENABLE                        0
#define IS_DCXO_ENABLE                             1
#else
#define IS_AFC_EVENT_ENABLE                        1
...
#if IS_DCXO_ENABLE
   #if IS_SOC_CHIP || IS_MT6162_6163_DCXO_SUPPORT || IS_CHIP_MT6571 || IS_CHIP_MT6592 || IS_CHIP_MT6580
#define IS_BSI_AFC_ACTIVE_SWITCH                   1
   #else
      // This is only for build pass and YYL will change MT6166 to make sure
      // this behavior will be included in IS_CHIP_MT6572 & IS_CHIP_MT6582 & IS_CHIP_MT6592
      #if IS_CHIP_MT6572 || IS_CHIP_MT6582
      #else
