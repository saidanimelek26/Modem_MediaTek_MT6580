...
#if IS_MIPI_PA
extern kal_int16  UMTS_TX_START_TQ_TABLE[9];
extern kal_int16  UMTS_TX_END_TQ_TABLE[4];
#else
...
extern kal_bool ul1custom_memory_enable;

extern kal_bool is_MT6580_EvmPeak_workaround;

extern kal_bool is_MT6166_EvmPeak_workaround;
