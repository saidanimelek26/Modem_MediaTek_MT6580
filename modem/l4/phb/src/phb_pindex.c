...
kal_bool phb_pindex_delete(pindex_type *pindex, kal_uint16 index)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    kal_trace(TRACE_INFO, FUNC_PHB_PINDEX_DELETE, index, pindex->used_count);
...
kal_uint16 phb_pindex_get_pos(pindex_type *pindex, kal_uint16 index)
{
    ...
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    kal_uint16 result = (kal_uint16) PHB_INVALID_VALUE;
    ...
    {
        result = pindex->table[index].position;
    }

    PHB_TRACE((MOD_PHB, "phb_pindex_get_pos:%d ", result),
              (TRACE_GROUP_10, FUNC_PHB_PINDEX_GET_POS, result)); 
    return result;
