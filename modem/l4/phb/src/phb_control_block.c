...
void phb_control_block_construct(control_block_type *control_block, kal_uint8 ID)
{
    ...
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    kal_uint8 access_id = control_block->ID;
...
void phb_ctrl_blk_set_state(control_block_type *control_block, kal_uint8 proc_stage)
{
    control_block->proc_stage = proc_stage;

    PHB_TRACE((MOD_PHB, " proc_stage[%d]-> %d", control_block->ID, control_block->proc_stage),
              (TRACE_GROUP_3, PHB_TRC_CB_SET_STATE, control_block->ID, control_block->proc_stage)); 
}

kal_uint8 phb_ctrl_blk_get_state(control_block_type *control_block)
{
    PHB_TRACE((MOD_PHB, " proc_stage[%d] : %d", control_block->ID, control_block->proc_stage),
              (TRACE_GROUP_3, PHB_TRC_CB_GET_STATE, control_block->ID, control_block->proc_stage)); 

    return control_block->proc_stage;
}
