...
#include "phb_config.h"
    ...
    struct _control_block_struct
    {
        ...
        kal_uint16              check_array[PHB_MAX_TYPE2_ENTRIES]; /* for check write USIM entry */
    #endif
        ...
        phb_ln_entry_struct*    temp_ln_entry;
        ...
        kal_uint16              result;   /* The cause value returned to upper layer, if error encountered during IO */
        ...
        msg_type                res_msg_id;    /*used to verify response*/ 
    };
    ...
    extern void phb_control_block_set_IO(
                    ...
                    kal_uint16 index,
                    kal_uint16 total);
    extern void phb_ctrl_blk_set_state(control_block_type *control_block, kal_uint8 proc_stage);

    extern kal_uint8 phb_ctrl_blk_get_state(control_block_type *control_block);
#ifdef __cplusplus
}
#endif 
