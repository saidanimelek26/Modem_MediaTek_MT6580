...
extern void l4cas_lte_cell_info_hdlr(local_para_struct *local_para_ptr, peer_buff_struct *peer_buff_ptr);
...
extern void l4c_audio_l4c_epof_ack_hdlr(local_para_struct * local_para_ptr, peer_buff_struct * peer_buff_ptr);
