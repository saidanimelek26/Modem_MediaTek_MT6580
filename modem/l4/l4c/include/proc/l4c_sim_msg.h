...
#if defined(__SIM_MMDC_CLIENT__)
...
extern void l4csmu_get_sim_lock_status_cnf_hdlr(local_para_struct *local_para_ptr, peer_buff_struct *peer_buff_ptr);
...
extern void l4csmu_gid1_verify_ind_hdlr(local_para_struct *local_para_ptr, peer_buff_struct *peer_buff_ptr);
...
extern void sim_authenticate_cnf_hdlr(local_para_struct *local_para_ptr, peer_buff_struct *peer_buff_ptr);
...
extern void l4c_sim_read_imsi_iccid_cnf_hdlr(local_para_struct *local_para_ptr, peer_buff_struct *peer_buff_ptr);
