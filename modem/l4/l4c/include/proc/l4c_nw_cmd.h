...
extern kal_bool l4c_nw_get_band_req(kal_uint8 src_id, kal_uint8 *gsm_band, kal_uint32 *umts_fdd_band, kal_uint32 *supported_gsm_band, kal_uint32 *supported_umts_fdd_band);
...
extern kal_bool l4c_nw_peer_reject_req(kal_uint8 src_id, kal_uint16 mm_proc, kal_uint16 cause, kal_uint8 *plmn_id);
