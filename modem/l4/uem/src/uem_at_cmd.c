...
void l4cuem_at_ef_port_setting_read_cnf_hdlr(void *data)
{
    ...
    {
        case L4CUEM_EF_PORT_COM_SWITCH:
            new_port.ps_port = uart_port_usb3;
            new_port.tst_port_ps = uart_port_usb5;
            new_port.tst_port_l1 = uart_port_usb5;
            break;
            
        case L4CUEM_EF_PORT_MS:
            new_port.ps_port = uart_port_usb3;
            new_port.tst_port_ps = uart_port1;
            new_port.tst_port_l1 = uart_port1;
            new_port.tst_baudrate_ps = 921600;
            break;
