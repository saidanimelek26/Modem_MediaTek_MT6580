...
static void l4cuem_bmt_set_callstate(kal_bool call_state)  //.HAL
{
    ...
    BMT_CTRL_CALLSTATE_T bmt_cmd_data;
   ...
   bmt_cmd_data.call_state = call_state;
   
   DclBMT_Control(bmt_handler, BMT_CMD_CALLSTATE, (DCL_CTRL_DATA_T *)&bmt_cmd_data);
}
...
kal_bool l4cuem_rtc_get_hw_time_req(kal_uint8 rtc_type, kal_uint8 rtc_alarm_id, rtc_alarm_info_struct *rtctime)
{
    ...
    /*----------------------------------------------------------------*/
    RTC_CTRL_GET_TIME_T l_rtctime;
    RTC_CTRL_GET_ALARM_TIME_T almTime;
    kal_bool result = KAL_FALSE;
