...
#define SMSAL_ASSERT(x)               DEBUG_ASSERT(x)
#define SMSAL_EXT_ASSERT(a,b,c,d)     DEBUG_ASSERT(a)

#define SMSAL_MAX_SIM_NUM MAX_SIM_NUM

#define SMSAL_MAX_MSG_NUM           (smsal_ptr_g->msg_box_num)
...
#define SMSAL_PROFILE_NAME_LEN   (MAX_PS_NAME_SIZE)
#ifdef __MAX_MAILBOX_NAME_UPDATA_TO_30__
#define SMSAL_MAILBOX_NAME_LEN   (30)
#else
...
#define SMSAL_MAX_REPLACE_MSG    (1)
#define SMSAL_MAX_EXT_NUM        (8) // !need multiple at 8

#ifndef __SMS_STORAGE_BY_MMI__
#ifdef __SMS_R6_ENHANCED_VOICE_MAIL__
#define SMSAL_MAX_MW_SOURCE      (4)
#else
#define SMSAL_MAX_MW_SOURCE      (3)
#endif
#endif
 ...
 * Default parameters
 *------------------------------*/
#ifdef __SMS_MAX_VALIDITY_PERIOD__
#define SMSAL_DEFAULT_VP         (255)    /* default validity period: Max */
#else
#define SMSAL_DEFAULT_VP         (71)     /* default validity period: 6 hours */
#endif
...
#define SMSAL_EXT_LEN            (13) /* length of a SIM EFext1/6 record */
//#endif
...
#define SMSAL_ENHANCED_VM_INFO_IEI  (0x23)
...
#define SMSAL_NL_SINGLE_IEI         (0x24)   /* National Language single shift */
#define SMSAL_NL_LOCKING_IEI        (0x25)   /* National Language looking shift */
...
#define SMSAL_DE_PERSONAL_DATA_LEN (88)
