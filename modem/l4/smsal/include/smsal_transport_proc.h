...
extern const kal_uint8 SMSAL_NMI_TABLE1[4][NUM_OF_NMI_MSG_ENUM];
extern const kal_uint8 SMSAL_NMI_TABLE2[4][NUM_OF_NMI_MSG_ENUM];
extern const kal_uint8 SMSAL_NMI_TABLE3[4][NUM_OF_NMI_MSG_ENUM];
...
void smsal_sat_mo_sms_ctrl_rej(kal_uint8         access_id,
                               kal_uint8         sub_act_code,
                               kal_uint16        cause);
...
kal_bool smsal_ppe_check_hdlr(kal_uint8 id) ;
