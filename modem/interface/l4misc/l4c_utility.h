...
extern kal_bool is_eq_cmd_conflict(kal_uint8 src_id, kal_uint8 action);
...
extern kal_bool is_smu_cmd_conflict(kal_uint8 src_id, kal_uint8 action);

extern kal_bool is_tcm_cmd_conflict(kal_uint8 src_id, kal_uint8 action);

extern kal_bool is_tcm_cmd_conflict_basic(kal_uint8 src_id, kal_uint8 action); //maui_01895693, mtk02285

#if 0 //def __CTM_SUPPORT__
/* under construction !*/
#endif 

extern kal_bool l4c_search_all_src(module_type which_sim, kal_uint8 action);

extern kal_bool l4c_search_all_src_ext(module_type which_sim, kal_uint8 action, kal_uint8 *src_id); //MAUI_02554068

extern kal_bool l4c_search_other_src(kal_uint8 src_id, kal_uint8 action); 
...
extern void l4c_ps_dialup_disc_req(l4c_source_id_enum cmd_src_id,kal_uint8 context_id,kal_bool local_deactivate_pdp);
...
extern kal_uint8 l4c_gprs_ipv4v6_get_the_other_cid(l4c_gprs_ipv4v6_act_struct* act_ptr, kal_uint8 cid);
...
extern kal_uint8 l4c_find_pdp_cid2pid(kal_uint8 cid); //__GPRS_BEARER_REPORT_NEGOTIATED_QOS__
...
extern kal_bool l4c_previous_rac_action_rsp(void);
...
extern void l4c_cc_exe_call_dial_lrsp(kal_uint8 src_id, 
                                      kal_uint8 response, 
                                      kal_uint16 cause, 
                                      kal_uint8 call_id, 
...
extern void l4c_send_dual_sim_power_on_ind(kal_uint8 src_id);
...
#ifdef __VSIM__
extern kal_bool l4c_is_sim_vsim_on(void);
#endif
...
extern void l4c_eq_screen_shot_output(void);
#endif
...
extern void l4c_ps_get_diff_data_count(kal_uint32 *ps_count_query_rx, kal_uint32 *ps_count_query_tx);
extern kal_uint8 l4c_ps_get_data_speed();
#if 0 
/* under construction !*/
#endif
