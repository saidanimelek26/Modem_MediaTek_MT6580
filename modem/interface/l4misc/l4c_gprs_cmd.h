...
extern kal_uint16 l4c_ps_exe_act_req(kal_uint8 src_id, kal_uint8 opcode, kal_uint8 cid);
...
extern kal_uint32 l4c_ps_get_enter_data_module(kal_uint8 l2p);

extern kal_bool l4c_ps_exe_enter_data_state_req(kal_uint8 src_id, kal_uint8 l2p, kal_uint8 cid, kal_uint8 chid);
...
extern kal_bool l4c_ps_set_tft_req(kal_uint8 src_id, l4c_tft_struct *tft);

extern kal_bool l4c_ps_get_tft_req(kal_uint8 src_id, l4c_tft_struct *info);
