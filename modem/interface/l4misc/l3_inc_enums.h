 ...
 * ¢x                                                   CS Over HSPA                                                           ¢x
 * ¢u¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢s¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢t
 * ¢x        YES           ¢x                                                 NO                                               ¢x
 * ¢u¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢q¢w¢w¢w¢w¢s¢w¢w¢w¢s¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢t
 * ¢x                      ¢x        ¢x      ¢x                                  TTI                                           ¢x
 * ¢x                      ¢u¢w¢w¢w¢w¢q¢w¢w¢w¢q¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢s¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢s¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢t
 * ¢x                      ¢x        ¢x      ¢x         10 or 20           ¢x              40            ¢x          80        ¢x
 * ¢x        (R8)          ¢u¢w¢w¢w¢w¢q¢w¢w¢w¢q¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢q¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢q¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢t
 * ¢x UMTS_RAB_HSPA_SPEECH ¢x        ¢x<500  ¢x      UMTS_RAB_SPEECH       ¢xUMTS_RAB_CONVERSATIONAL_DATA¢x                    ¢x
 * ¢x                      ¢x        ¢u¢w¢w¢w¢q¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢q¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢t                    ¢x
 * ¢x                      ¢x Max RLC¢x 576  ¢xUMTS_RAB_CONVERSATIONAL_DATA¢x  UMTS_RAB_STREAMING_DATA   ¢x                    ¢x
 * ¢x                      ¢x  size  ¢u¢w¢w¢w¢q¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢q¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢tUMTS_RAB_UNSPECIFIED¢x    
 * ¢x                      ¢x        ¢x 640  ¢xUMTS_RAB_CONVERSATIONAL_DATA¢x    UMTS_RAB_UNSPECIFIED    ¢x                    ¢x
 * ¢x                      ¢x        ¢u¢w¢w¢w¢q¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢q¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢t                    ¢x
 * ¢x                      ¢x        ¢xothers¢x    UMTS_RAB_UNSPECIFIED    ¢xUMTS_RAB_CONVERSATIONAL_DATA¢x                    ¢x
 * ¢|¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢r¢w¢w¢w¢w¢r¢w¢w¢w¢r¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢r¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢r¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢}
 */
...
typedef enum {
    ...
    NO_GPRS_COVERAGE,
    MM_ABNORMAL_LU,
    MM_ABNORMAL_LU_LESS_THEN_MAX_TIMES,
...
typedef enum
{
    MM_PLMN_LIST_AVAILABLE = 1,
    MM_PLMN_LIST_CURRENT = 2,
    MM_PLMN_LIST_FORBIDDEN = 3
}mm_plmn_list_status_enum;

typedef enum
{
    MM_INTERNATIONAL_ROAMING_NOT_ALLOW = 1,
    MM_NATIONAL_ROAMING_NOT_ALLOW = 2,
    MM_FPLMN_NOT_ALLOW = 3
}mm_plmn_not_allow_reason_enum;
...
typedef enum
{
    ...
    LR_ABNORMAL,
    LR_ACCEPT_PS_ONLY,
    LR_NO_NEEDED, /* SGLTE DSDS: PS @SIM2, just perform search but do not 
attach */
} lr_result_enum;
...
typedef enum
{
  ...
  NW_CONTEXT_DEACT_EVENT,
  ME_CONTEXT_DEACT_EVENT,
  NW_DETACH_EVENT,
  ME_DETACH_EVENT,
...
#if defined (__MMDC__) && defined (__MMDC_TYPE1_DUAL_LOAD__)
typedef enum{
    CELL_CHANGE_IND = 0x01,
    HO_CHANGE_IND = 0x02,
    INTER_RAT_IND = 0x04,
    CELL_TYPE_CHANGE_IND = 0x08,
    RR_STATE_CHANGE_IND = 0x10
}ind_type_enum;

typedef enum {
    L4CAS_RR_STATE_IDLE = 0,
    L4CAS_RR_STATE_NOT_IDLE
}rr_state_enum;
#endif 
