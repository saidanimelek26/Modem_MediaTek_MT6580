 ...
 * $Log:$
 *
 * 05 05 2016 aarti.jain
 * [MOLY00178099] [COPY CR][WW FT][Mexico-Mexico][Denali-1][MT6735][Telcel][E-RACH] ][ASSERT] Fatal Error (0x840, 0xf25e3c30)
 * .
 *
 * 11 11 2015 haipeng.sun
 * build error MOLY00148697 
 * [Need Patch] MOLY00148697(ALPS02403716) MP build error for ZTEHZ6572_WET_L_GPRS
 *
 * 11 05 2013 andrew.wu
 * [MOLY00042658] [SHAQ] UAS related header split
 * Split uas related header from SHAQ
 *
 * 04 25 2013 huifeng.jing
 * [MOLY00013224] 视频通话时无对方视频图像显示
 * .
 *
 * 04 09 2013 yungfu.chen
 * [MOLY00013224] ??硄????よ???钩?ボ
 * .
 *
 ...
 * sizeof(pdcp_ps_data_req_struct) - sizeof(PEER_BUFF_HDR) + 4 (reserved for ReTx from RATDM)
 */
#define DRLC_SAFE_HEADER_SPACE_OFFSET   12  
