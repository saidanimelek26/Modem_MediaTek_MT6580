 ...
 * $Log:$
 *
 * 03 18 2013 nicky.chou
 * [MOLY00009893] [RSVA][3G Gemini2.0+] 3G Gemini 2.0+ Check in
 * .
 *
...
/* under construction !*/
#endif
extern void rsvas_alloc_send_ilm(const module_type mod_src, const module_type mod_dest, const msg_type msg, void const * local_para_ptr);
