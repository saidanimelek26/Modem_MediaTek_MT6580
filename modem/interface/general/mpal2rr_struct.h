...
typedef struct {
    kal_uint32 frame_no;
    kal_uint8 rrbp_txed;
    kal_uint8 is_usf_detected;
    kal_uint8 ctrl_blks_free_in_q;
    kal_uint8 no_data_txed;
    kal_uint8 is_alloc_exhausted;
} ready_to_send_ind_struct;
...
typedef struct {
    ...
    /*is_before_starting_time is insteaded by dl_mTBFtid and useless now*/
    #else
    kal_uint16 dsp_vq;
    kal_uint8 is_before_starting_time;
    #endif/*__NEW_TBF_ARCH__*/ 	
  #endif
  ...
  #else
    /*maruco20080415,add for MAC to recognize DL data belongs which TBF*/
    kal_uint8 dl_TBFtid;
  #endif /*__NEW_TBF_ARCH__*/
...
/******************************************************************************/
/*                       UMTS-GSM inter-RAT process                          */
/******************************************************************************/

#ifdef __UMTS_RAT__

/* refer to MPH_UMTS_GSM_MEAS_MAX_CELL_NUM */
#define UMTS_GSM_MEAS_MAX_CELL_NUM (32)

typedef struct {
    LOCAL_PARA_HDR
    kal_uint8 list_ref;
    kal_uint8  list_len;
    kal_int16 arfcn_list[UMTS_GSM_MEAS_MAX_CELL_NUM];
    kal_int16 rla_in_quarter_dbm[UMTS_GSM_MEAS_MAX_CELL_NUM];
    kal_uint16 drx_cycle_len;
    kal_uint8 Tmeas_drx_num;
    kal_uint16 bsic_reconfirm_para;
} mpal_rr_umts_gsm_meas_ind_struct;
...
typedef struct {
    ...
    kal_int16 arfcn_list[UMTS_GSM_MEAS_MAX_CELL_NUM];
    kal_int16 rla_in_quarter_dbm[UMTS_GSM_MEAS_MAX_CELL_NUM];
} mpal_rr_umts_gsm_prio_meas_ind_struct;
...
} mpal_rr_umts_gsm_bsic_ind_struct;
...
#endif /* end of __PS_HO__ */
} mpal_rr_umts_handover_cnf_struct;
