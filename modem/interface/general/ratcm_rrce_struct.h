 ...
 * $Log:$
 *
 * 05 04 2015 vend_mtb_aricent_03
 * [MOLY00110079] [COPY CR][Rainier][MT6580][E2][FDD][DSDS][SZ][FT]MT Fail
 * .
 *
 * 03 26 2013 chiaching.lin
 * [MOLY00012650] RRC connection local release enhancement.
 * Check-in interface.
 * 
 * 10 01 2012 tereasa.huang
 * [MOLY00004236] [interface][service][kal]remove stack_ltlcom.h
 * .
 *
 * 01 11 2012 tereasa.huang
 * removed!
 * .
 *
 * 11 09 2011 ryan.ou
...
typedef struct
{
   ...
   kal_uint8     umts_cipheringKey[UMTS_CIPHERING_KEY_LENGTH];
   kal_uint8          integrityKey[UAS_INTEGRITY_KEY_LENGTH];
...
typedef struct
{
   ...
   end_session_cause_enum cause;   /*ALPS02047957:cause eg., SCRI_REQ_FD/SCRI_REQ_FOP*/
