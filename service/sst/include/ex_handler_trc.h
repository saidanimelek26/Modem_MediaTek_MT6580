 ...
 ****************************************************************************/
    ...
    TRC_MSG(SST_EXC_OUTPUT_DSP_LOG_ENTER, "[EXC][COMMON] Enter output_dmdsp_error_to_log()")
    TRC_MSG(SST_EXC_OUTPUT_DSP_LOG_EXIT, "[EXC][COMMON] Exit output_dmdsp_error_to_log()")	
    ...
    TRC_MSG(SST_EXC_LCD_DISPLAY_ENTER, "[EXC][COMMON] Enter ex_display_lcd()")
    TRC_MSG(SST_EXC_LCD_DISPLAY_EXIT, "[EXC][COMMON] Exit ex_display_lcd()")

    TRC_MSG(SST_EXC_INIT_DEBUG_PRINT_ENTER, "[EXC][COMMON] Enter InitDebugPrint()")
    TRC_MSG(SST_EXC_INIT_DEBUG_PRINT_EXIT, "[EXC][COMMON] Exit InitDebugPrint()")

    TRC_MSG(SST_EXC_DSP_DISPLAY_ENTER, "[EXC][COMMON] Enter output_dmdsp_error_to_display()")
    TRC_MSG(SST_EXC_DSP_DISPLAY_EXIT, "[EXC][COMMON] Exit output_dmdsp_error_to_display()")

    TRC_MSG(SST_EXC_DEBUG_PRINT_ENTER, "[EXC][COMMON] Enter DebugPrint()")
    TRC_MSG(SST_EXC_DEBUG_PRINT_EXIT, "[EXC][COMMON] Exit DebugPrint()")

    TRC_MSG(SST_EXC_LCD_DISPLAY_DSP_LOG_ENTER, "[EXC][COMMON] Enter output_dmdsp_error_to_display()")
    TRC_MSG(SST_EXC_LCD_DISPLAY_DSP_LOG_EXIT, "[EXC][COMMON] Exit output_dmdsp_error_to_display()")
