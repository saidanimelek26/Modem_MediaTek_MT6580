...
void  nvram_init_L1_RF_customInputData(void)
{
...
#if defined(__2G_MIPI_SUPPORT__)
      {
         ...
         ASSERT(error_no == KAL_TRUE);
         kal_mem_cpy(&GGE_MIPI_CTRL_TABLE_GSM850, table , sizeof(l1cal_mipi_ctrl_table_band_T));
      ...
      }
      {
         ...
         ASSERT(error_no == KAL_TRUE);
         kal_mem_cpy(&GGE_MIPI_CTRL_TABLE_GSM900, table , sizeof(l1cal_mipi_ctrl_table_band_T));
         free_ctrl_buffer( table );
  #endif
      }
      {
         ...
         ASSERT(error_no == KAL_TRUE);
         kal_mem_cpy(&GGE_MIPI_CTRL_TABLE_DCS1800, table , sizeof(l1cal_mipi_ctrl_table_band_T) );
         free_ctrl_buffer( table );
  #endif
      }
      {
         ...
         ASSERT(error_no == KAL_TRUE);
         kal_mem_cpy(&GGE_MIPI_CTRL_TABLE_PCS1900, table , sizeof(l1cal_mipi_ctrl_table_band_T) );
         free_ctrl_buffer( table );
  #endif
      }
 #endif
