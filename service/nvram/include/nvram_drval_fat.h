...
#if defined(__MTK_TARGET__) && defined(__NVRAM_IMPORTANT_C_PARTITIONS__)&& defined(__SMART_PHONE_MODEM__)
#define NVRAM_FS_IMPORTNT_CS_DATAITEM_PATH        "Q:\\"
#define NVRAM_FS_IMPORTNT_CB_DATAITEM_PATH        "R:\\"
#endif	
