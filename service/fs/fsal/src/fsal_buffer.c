...
static FSAL_Status FSAL_CacheFill(STFSAL *pstFSAL, kal_uint32 uBlock)
{
    ...
    {
        fsal_trace(TRACE_ERROR, FSAL_TRACE_ERROR_FSAL_BUF_C, ret, __LINE__);
        return ret;
    }
    ...
    if (uFileOffsetOfBlock + pstFSAL->uBufSize > pstFSAL->uFileSize) 
    {
        ...
        pstFSAL->bPartialCached = KAL_TRUE;
    } 
    else 
    {
    ...
    pstFSAL->uCachedFileSize = pstFSAL->uFileSize;
...
static FSAL_Status fsal_read_block(STFSAL *pstFSAL, kal_uint8 *pbBuf, kal_uint32 uBlock, kal_uint32 uOffset, kal_uint32 uLen)
{
    ...
    if ((pstFSAL->uCachedBlock != uBlock) || (pstFSAL->bPartialCached && (pstFSAL->uCachedFileSize != pstFSAL->uFileSize)) ) 
    {
        /* cache miss */
    ...
    if (pstFSAL->uFileOffset+uLen > pstFSAL->uFileSize) 
    {
        ...
        fsal_trace(TRACE_ERROR, FSAL_TRACE_BUF_READ_BLK_ERROR, pstFSAL->uFileOffset, uLen,  pstFSAL->uFileSize, __LINE__);
...
FSAL_Status FSAL_Read(STFSAL *pstFSAL, kal_uint8* pbBuf, kal_uint32 uSize)
{
    ...
    {
        fsal_trace(TRACE_ERROR, FSAL_TRACE_ERROR_FSAL_BUF_C, FSAL_MEMORY_CORRUPTION, __LINE__);
...
FSAL_Status FSAL_Write(STFSAL *pstFSAL, kal_uint8 *pbBuf, kal_uint32 uSize)
{
    ...
    if (KAL_TRUE==pstFSAL->bBuffering) 
    {
        ...
        {
            fsal_trace(TRACE_ERROR, FSAL_TRACE_ERROR_FSAL_BUF_C, FSAL_WRITE_ERROR, __LINE__);
