...
/**********************************************************
Description : Enable watchdog counter.
Input       : None
Output      : None
***********************************************************/
void WacthDogEnable(void)
{
   *(volatile kal_uint32 *)(WDT_MODE) = WDT_ENABLE_CMD;
}
...
Output      : None
***********************************************************/
kal_uint32 WatchDogStatus(void) {
	return *(volatile kal_uint32 *)(WDT_STATUS);
}

/**********************************************************
Description : Did watchdog restart ?
Input       : None
Output      : None
***********************************************************/
kal_bool IsWatchDogRestart() {
	return WatchDogStatus() & WDT_HW_RST_MASK ? KAL_TRUE : KAL_FALSE;
}
