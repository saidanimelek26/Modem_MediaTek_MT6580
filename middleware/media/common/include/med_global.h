...
/* Audio memory use cases:              [Overhead]        + [Working buffer]           */
#define MAX_AUD_MEM_SIZE_CTM            (AUD_MED_OVERHEAD + AUD_MED_CTM_EXT_MEM_SIZE)      /* CTM */
#define MAX_AUD_MEM_SIZE_ECALL          (AUD_MED_OVERHEAD + AUD_MED_ECALL_EXT_MEM_SIZE)    /* eCall */
