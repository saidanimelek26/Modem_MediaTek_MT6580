 ...
 * .
 *
 * 10 11 2011 doug.wang
 * removed!
 * fix daily build error
 *
 * 10 06 2011 doug.wang
 * removed!
 ...
 * .
 *
 * 09 15 2011 sheila.chen
 * removed!
 * 
 * DMNR calibration format changing. (MAUI)
 *
 * 09 13 2011 scott.huang
 * removed!
 * .
 *
 * 08 08 2011 kh.hung
