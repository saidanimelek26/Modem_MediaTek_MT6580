 ...
 * Description:
 * ------------
 *  This file defines dsp share registers of MT6280
 *
 * Author:
 * -------
 * -------
...
#ifndef _DPRAM_6280_H_
#define _DPRAM_6280_H_
...
#define DP2_AMR_TRACE_BASE                        DP_MODEM_CTRL_RESERVED_BASE + 0x017 /* 0x3b67 */
...
#define DP_UL_DL_PCM_REC_ENA                      DP2_SP_8kPCM_CTRL_BASE + 0x005 /* 0x3d97 */
#define DP_PCM_REC_PTR1                           DP2_SP_8kPCM_CTRL_BASE + 0x006 /* 0x3d98 */
#define DP_PCM_REC_PTR2                           DP2_SP_8kPCM_CTRL_BASE + 0x007 /* 0x3d99 */
#define DP_PCM_REC_PTR3                           DP2_SP_8kPCM_CTRL_BASE + 0x008 /* 0x3d9a */
#define DP_PCM_REC_PTR4                           DP2_SP_8kPCM_CTRL_BASE + 0x009 /* 0x3d9b */
#define DP_PCM_REC_PTR5                           DP2_SP_8kPCM_CTRL_BASE + 0x00a /* 0x3d9c */
#define DP_SPH_3G_SYNC_FLAG                       DP2_SP_8kPCM_CTRL_BASE + 0x00e /* 0x3da0 */
#define DP_D2C_SPEECH_UL_INT                      DP2_SP_8kPCM_CTRL_BASE + 0x00f /* 0x3da1 */
#define DP_D2C_SPEECH_DL_INT                      DP2_SP_8kPCM_CTRL_BASE + 0x010 /* 0x3da2 */
#define DP_BGS_ADDR                               DP2_SP_8kPCM_CTRL_BASE + 0x011 /* 0x3da3 */
#define DP_BGS_LEN                                DP2_SP_8kPCM_CTRL_BASE + 0x012 /* 0x3da4 */
#define DP_BGS_CTRL                               DP2_SP_8kPCM_CTRL_BASE + 0x013 /* 0x3da5 */
#define DP_BGS_MIX                                DP2_SP_8kPCM_CTRL_BASE + 0x014 /* 0x3da6 */
...
#define DP_CTM_AMR_REAL_RX_TYPE                   DP2_SP_VM_CTRL_BASE + 0x07c /* 0x3e23 */

#define DP2_SP_CTM_BASE                           DP2_SP_VM_CTRL_BASE + 0x081 /* 0x3e28 */

#define DP_PNW_PTR_UL1                            DP2_SP_CTM_BASE + 0x000 /* 0x3e28 */
#define DP_PNW_PTR_UL2                            DP2_SP_CTM_BASE + 0x001 /* 0x3e29 */
#define DP_PNW_PTR_DL1                            DP2_SP_CTM_BASE + 0x002 /* 0x3e2a */
#define DP_PNW_PTR_DL2                            DP2_SP_CTM_BASE + 0x003 /* 0x3e2b */
#define DP_PNW_CTRL_UL                            DP2_SP_CTM_BASE + 0x004 /* 0x3e2c */
#define DP_PNW_CTRL_DL                            DP2_SP_CTM_BASE + 0x005 /* 0x3e2d */
#define DP_CTM_CTRL                               DP2_SP_CTM_BASE + 0x006 /* 0x3e2e */
#define DP_CTM_BFI_FACCH_REPORT                   DP2_SP_CTM_BASE + 0x007 /* 0x3e2f */
#define DP_PNW_LEN_UL                             DP2_SP_CTM_BASE + 0x008 /* 0x3e30 */
#define DP_PNW_LEN_DL                             DP2_SP_CTM_BASE + 0x009 /* 0x3e31 */
#define DP_CTM_AMR_CODEBOOK_GAIN_LIMIT            DP2_SP_CTM_BASE + 0x00a /* 0x3e32 */
#define DP_CTM_AMR_CODEBOOK_GAIN_UPDATE           DP2_SP_CTM_BASE + 0x00b /* 0x3e33 */
#define DP_CTM_COSIM_CTRL                         DP2_SP_CTM_BASE + 0x00c /* 0x3e34 */
...
#define DP_BGS_UL_GAIN                            DP2_SP_AUDIO_CTRL_BASE + 0x006 /* 0x3e58 */
#define DP_BGS_DL_GAIN                            DP2_SP_AUDIO_CTRL_BASE + 0x007 /* 0x3e59 */
#define DP_3G_SC_Type                             DP2_SP_AUDIO_CTRL_BASE + 0x008 /* 0x3e5a */
#define DP_3G_SD_Type                             DP2_SP_AUDIO_CTRL_BASE + 0x009 /* 0x3e5b */
...
#define DP_3G_mode                                DP2_Reserve_BASE + 0x000 /* 0x3e79 */
...
#define DP2_EPL_BND                               DP2_EPL_BND_BASE + 0x000 /* 0x3e84 */
...
#define DP2_DUALMIC_CTRL                          DP_SPEECH_OTHER_BASE + 0x00d /* 0x3ede */
...
#define DP_DACA_CTRL                              DP_SPEECH_RESERVED_BASE + 0x006 /* 0x3ee5 */
#define DP_DACA_PTR_UL                            DP_SPEECH_RESERVED_BASE + 0x007 /* 0x3ee6 */
#define DP_DACA_PTR_DL                            DP_SPEECH_RESERVED_BASE + 0x008 /* 0x3ee7 */
#define DP_DACA_LEN                               DP_SPEECH_RESERVED_BASE + 0x009 /* 0x3ee8 */

#define DP2_AUDIO_CTRL_FIELD_BASE                 DP_SPEECH_RESERVED_BASE + 0x00a /* 0x3ee9 */

#define DP_AUDIO_ASP_TYPE_ADDR                    DP2_AUDIO_CTRL_FIELD_BASE + 0x000 /* 0x3ee9 */
#define DP_AUDIO_ASP_FS_ADDR                      DP2_AUDIO_CTRL_FIELD_BASE + 0x001 /* 0x3eea */
#define DP_Audio_ASP_DEL_W_ADDR                   DP2_AUDIO_CTRL_FIELD_BASE + 0x002 /* 0x3eeb */
#define DP_MARGIN_PCM_W                           DP2_AUDIO_CTRL_FIELD_BASE + 0x003 /* 0x3eec */
#define DP_Audio_ASP_DEL_MARGIN_W_ADDR            DP2_AUDIO_CTRL_FIELD_BASE + 0x004 /* 0x3eed */
#define DP_VOL_OUT                                DP2_AUDIO_CTRL_FIELD_BASE + 0x005 /* 0x3eee */

#define A2V_BASE                                  DP2_AUDIO_CTRL_FIELD_BASE + 0x006 /* 0x3eef */

#define A2V_INT_ENABLE                            A2V_BASE + 0x000 /* 0x3eef */
#define A2V_INT_CNT                               A2V_BASE + 0x001 /* 0x3ef0 */
#define A2V_INT_STAMP                             A2V_BASE + 0x002 /* 0x3ef1 */
#define A2V_AUDIO_FRMAE_COUNT                     A2V_BASE + 0x003 /* 0x3ef2 */
#define A2V_VIDEO_FRAME_COUNT                     A2V_BASE + 0x004 /* 0x3ef3 */
#define A2V_INT_DSP_COUNT                         A2V_BASE + 0x005 /* 0x3ef4 */
#define A2V_INTERRUPT_PADDING_FLAG                A2V_BASE + 0x006 /* 0x3ef5 */
#define A2V_SPEECH_COUNT                          A2V_BASE + 0x007 /* 0x3ef6 */

#define DP2_WAV_CTRL_FIELD_BASE                   A2V_BASE + 0x008 /* 0x3ef7 */

#define DP2_WAV_CTRL_FIELD                        DP2_WAV_CTRL_FIELD_BASE + 0x000 /* 0x3ef7 */
#define DP_ASP_WAV_BASE_CTRL                      DP2_WAV_CTRL_FIELD_BASE + 0x000 /* 0x3ef7 */
#define DP_ASP_WAV_BASE_DATA                      DP2_WAV_CTRL_FIELD_BASE + 0x001 /* 0x3ef8 */
#define DP2_WAV_R_IDX                             DP2_WAV_CTRL_FIELD_BASE + 0x002 /* 0x3ef9 */
#define DP2_WAV_STEREO_FLAG                       DP2_WAV_CTRL_FIELD_BASE + 0x003 /* 0x3efa */

#define DP2_WT_CTRL_FIELD_BASE                    DP2_WAV_CTRL_FIELD_BASE + 0x004 /* 0x3efb */

#define DP_WT_CONTROL                             DP2_WT_CTRL_FIELD_BASE + 0x000 /* 0x3efb */

#define DP2_MP3_CTRL_FIELD_BASE                   DP2_WT_CTRL_FIELD_BASE + 0x001 /* 0x3efc */

#define MP3_CONTROL_BASE_ADD                      DP2_MP3_CTRL_FIELD_BASE + 0x000 /* 0x3efc */
#define MP3_CONTROL_1                             DP2_MP3_CTRL_FIELD_BASE + 0x001 /* 0x3efd */
#define MP3_CONTROL_2                             DP2_MP3_CTRL_FIELD_BASE + 0x002 /* 0x3efe */
#define MP3_CONTROL_3                             DP2_MP3_CTRL_FIELD_BASE + 0x003 /* 0x3eff */
#define MP3_CONTROL_4                             DP2_MP3_CTRL_FIELD_BASE + 0x004 /* 0x3f00 */
#define MP3_CONTROL_5                             DP2_MP3_CTRL_FIELD_BASE + 0x005 /* 0x3f01 */
#define MP3_CONTROL_6                             DP2_MP3_CTRL_FIELD_BASE + 0x006 /* 0x3f02 */
#define MP3_CONTROL_7                             DP2_MP3_CTRL_FIELD_BASE + 0x007 /* 0x3f03 */
#define MP3_CONTROL_8                             DP2_MP3_CTRL_FIELD_BASE + 0x008 /* 0x3f04 */
#define MP3_CONTROL_9                             DP2_MP3_CTRL_FIELD_BASE + 0x009 /* 0x3f05 */
#define MP3_CONTROL_10                            DP2_MP3_CTRL_FIELD_BASE + 0x00a /* 0x3f06 */
#define MP3_CONTROL_11                            DP2_MP3_CTRL_FIELD_BASE + 0x00b /* 0x3f07 */
#define MP3_CONTROL_12                            DP2_MP3_CTRL_FIELD_BASE + 0x00c /* 0x3f08 */
#define MP3_CONTROL_13                            DP2_MP3_CTRL_FIELD_BASE + 0x00d /* 0x3f09 */
#define MP3_CONTROL_14                            DP2_MP3_CTRL_FIELD_BASE + 0x00e /* 0x3f0a */
#define MP3_CONTROL_15                            DP2_MP3_CTRL_FIELD_BASE + 0x00f /* 0x3f0b */
#define MP3_CONTROL_16                            DP2_MP3_CTRL_FIELD_BASE + 0x010 /* 0x3f0c */
#define MP3_CONTROL_17                            DP2_MP3_CTRL_FIELD_BASE + 0x011 /* 0x3f0d */
#define MP3_CONTROL_18                            DP2_MP3_CTRL_FIELD_BASE + 0x012 /* 0x3f0e */
#define MP3_CONTROL_19                            DP2_MP3_CTRL_FIELD_BASE + 0x013 /* 0x3f0f */
#define MP3_CONTROL_20                            DP2_MP3_CTRL_FIELD_BASE + 0x014 /* 0x3f10 */
#define MP3_CONTROL_21                            DP2_MP3_CTRL_FIELD_BASE + 0x015 /* 0x3f11 */
#define MP3_CONTROL_22                            DP2_MP3_CTRL_FIELD_BASE + 0x016 /* 0x3f12 */
#define MP3_CONTROL_23                            DP2_MP3_CTRL_FIELD_BASE + 0x017 /* 0x3f13 */
#define MP3_CONTROL_24                            DP2_MP3_CTRL_FIELD_BASE + 0x018 /* 0x3f14 */
#define MP3_CONTROL_25                            DP2_MP3_CTRL_FIELD_BASE + 0x019 /* 0x3f15 */
#define MP3_CONTROL_26                            DP2_MP3_CTRL_FIELD_BASE + 0x01a /* 0x3f16 */
#define MP3_CONTROL_27                            DP2_MP3_CTRL_FIELD_BASE + 0x01b /* 0x3f17 */
#define MP3_CONTROL_28                            DP2_MP3_CTRL_FIELD_BASE + 0x01c /* 0x3f18 */

#define DP2_AUDIO_PP_CTRL_BASE                    DP2_MP3_CTRL_FIELD_BASE + 0x01d /* 0x3f19 */

#define DP2_AUDIO_PP_CTRL                         DP2_AUDIO_PP_CTRL_BASE + 0x000 /* 0x3f19 */
#define AUDIO_PP_3D_type                          DP2_AUDIO_PP_CTRL_BASE + 0x001 /* 0x3f1a */
#define AUDIO_PP_TS_SPEED                         DP2_AUDIO_PP_CTRL_BASE + 0x002 /* 0x3f1b */
#define AUDIO_PP_ReserveA1                        DP2_AUDIO_PP_CTRL_BASE + 0x003 /* 0x3f1c */
#define AUDIO_PP_TS_APM_to_DSP_Length             DP2_AUDIO_PP_CTRL_BASE + 0x004 /* 0x3f1d */
#define D2_SBC_control                            DP2_AUDIO_PP_CTRL_BASE + 0x005 /* 0x3f1e */
#define D2_SBC_DSP_W_PTR                          DP2_AUDIO_PP_CTRL_BASE + 0x006 /* 0x3f1f */
#define D2_SBC_MCU_R_PTR                          DP2_AUDIO_PP_CTRL_BASE + 0x007 /* 0x3f20 */
#define D2_SBC_parameter                          DP2_AUDIO_PP_CTRL_BASE + 0x008 /* 0x3f21 */
#define D2_SBC_Base_address                       DP2_AUDIO_PP_CTRL_BASE + 0x009 /* 0x3f22 */
#define D2_SBC_buffer_length                      DP2_AUDIO_PP_CTRL_BASE + 0x00a /* 0x3f23 */
#define D2_Audio_spectrum_output                  DP2_AUDIO_PP_CTRL_BASE + 0x00b /* 0x3f24 */
#define AUDIO_PP_ReserveB1                        DP2_AUDIO_PP_CTRL_BASE + 0x00c /* 0x3f25 */
#define AUDIO_CHECK_ASP_TYPE                      DP2_AUDIO_PP_CTRL_BASE + 0x00d /* 0x3f26 */
#define PCM_Rount_Data_Address                    DP2_AUDIO_PP_CTRL_BASE + 0x00e /* 0x3f27 */
#define PCM_Rount_Data_Length                     DP2_AUDIO_PP_CTRL_BASE + 0x00f /* 0x3f28 */
#define PCM_Rount_Data_Pagenum                    DP2_AUDIO_PP_CTRL_BASE + 0x010 /* 0x3f29 */
#define AUDIO_PP_ReserveC1                        DP2_AUDIO_PP_CTRL_BASE + 0x011 /* 0x3f2a */
#define AUDIO_PP_ReserveC2                        DP2_AUDIO_PP_CTRL_BASE + 0x012 /* 0x3f2b */
#define DYNAMIC_DOWNLOAD_MCU_STATUS               DP2_AUDIO_PP_CTRL_BASE + 0x013 /* 0x3f2c */
#define DYNAMIC_DOWNLOAD_STATUS                   DP2_AUDIO_PP_CTRL_BASE + 0x014 /* 0x3f2d */

#define DP2_EXTRA_APPLICATION_FILED_BASE          DP2_AUDIO_PP_CTRL_BASE + 0x015 /* 0x3f2e */

#define DP_AUDIO_ASP_COMMON_FLAG_1                DP2_EXTRA_APPLICATION_FILED_BASE + 0x000 /* 0x3f2e */
#define DP_AUDIO_RAMPDOWN_ENABLE                  DP2_EXTRA_APPLICATION_FILED_BASE + 0x001 /* 0x3f2f */
#define DP_AUDIO_ASP_EXTRA1_BUFLEN_ADDR           DP2_EXTRA_APPLICATION_FILED_BASE + 0x002 /* 0x3f30 */
#define DP_AUDIO_ASP_EXTRA2_ADDR                  DP2_EXTRA_APPLICATION_FILED_BASE + 0x003 /* 0x3f31 */
#define DP_AUDIO_ASP_EXTRA2_LEN_ADDR              DP2_EXTRA_APPLICATION_FILED_BASE + 0x004 /* 0x3f32 */
#define DP_TASK4_COSIM_HANDSHAKE                  DP2_EXTRA_APPLICATION_FILED_BASE + 0x005 /* 0x3f33 */

#define DP2_Dynamic_Load_field_BASE               DP2_EXTRA_APPLICATION_FILED_BASE + 0x006 /* 0x3f34 */

#define DDL_Task_Flag                             DP2_Dynamic_Load_field_BASE + 0x000 /* 0x3f34 */
#define DP2_Dynamic_Load_field                    DP2_Dynamic_Load_field_BASE + 0x000 /* 0x3f34 */
#define DDL_Check_Position                        DP2_Dynamic_Load_field_BASE + 0x001 /* 0x3f35 */
#define DDL_Task_ID                               DP2_Dynamic_Load_field_BASE + 0x002 /* 0x3f36 */

#define DP2_AUDIO_RESERVED_BASE                   DP2_Dynamic_Load_field_BASE + 0x003 /* 0x3f37 */

#define DP2_AUDIO_RESERVED_BASE1                  DP2_AUDIO_RESERVED_BASE + 0x000 /* 0x3f37 */
#define DP2_AUDIO_RESERVED_BASE2                  DP2_AUDIO_RESERVED_BASE + 0x001 /* 0x3f38 */

#define DP2_UNDEFINEDD_BASE                       DP2_AUDIO_RESERVED_BASE + 0x002 /* 0x3f39 */


#define SHERIF_SIZE                               1337


// The statement checks whether generates SHERIF size exceeds limitation
#define MT6280_SHERIF_SIZE (1536 - 32)
#if (SHERIF_SIZE > MT6280_SHERIF_SIZE)
    ¡§SHERIF SIZE exceeds limitation !! This line makes assembler stop¡¨
#endif

#undef SHERIF_SIZE
#define SHERIF_SIZE (MT6280_SHERIF_SIZE)
