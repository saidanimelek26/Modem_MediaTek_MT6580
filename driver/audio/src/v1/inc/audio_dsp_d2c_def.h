...
#define DPRAM2_base(a)                       ((volatile uint16*)DPRAM2_CPU_base+(a))
    ...
    #define D2C_SOUND_EFFECT_INT_ID_DL  (DP_D2C_INT_MAPPING_BASIC+SAL_DSPINT_PRIO_BGS_DL)  // Background Sound, org DL+UL(MT6589, MT6280), new UL (MT6572, MT6582, MT6592)
    #define D2C_SOUND_EFFECT_INT_ID_UL  (DP_D2C_INT_MAPPING_BASIC+SAL_DSPINT_PRIO_BGS_UL)  // Background Sound, new UL (MT6572, MT6582, MT6592)
