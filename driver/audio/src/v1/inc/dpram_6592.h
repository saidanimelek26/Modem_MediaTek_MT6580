...
#ifndef _DPRAM_6592_H_
#define _DPRAM_6592_H_
...
#define DP2_UNDEFINEDD_BASE                       DP_SPEECH_EXPAND2_BASE + 0x005 /* 0x3f5d */


#define SHERIF_SIZE                               1368


// The statement checks whether generates SHERIF size exceeds limitation
#define MT6592_SHERIF_SIZE (1536 - 32)
#if (SHERIF_SIZE > MT6592_SHERIF_SIZE)
    ¡§SHERIF SIZE exceeds limitation !! This line makes assembler stop¡¨
#endif

#undef SHERIF_SIZE
#define SHERIF_SIZE (MT6592_SHERIF_SIZE)
