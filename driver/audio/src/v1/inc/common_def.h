...
#if 0 // defined(MT6280) || defined(MT6589), merge to only one
/* under construction !*/
/* under construction !*/
/* under construction !*/
#endif
...
#define SPE_LOUDSPK_DMNR (defined(MT6582) || defined(MT6592) || defined(MT6571)|| defined(MT6580))
// TDDNC and DMNR are exclusive
#define DSP_DYNAMDOWNLOAD_TDNC_DMNR_EXOR defined(MT6571)   

#if defined(MT6280) // KH: Not Ready for MT6280
#define TDDNC_SUPPORT 0
#else // MT6589, MT6572, MT6582, MT6592
#define TDDNC_SUPPORT 1
#endif

// Execute AM_DSP in MED task
#define __AM_DSP_IN_TASK__ ( defined(MT6280) || defined(MT6589) || defined(MT6572) || defined(MT6582) || defined(MT6592) || defined(MT6571)|| defined(MT6580))

// For 3G
//#define __SP3G_PLATFORM__ 

// For 65nm
#define __RELOAD_DSP_COEFF__  ( defined(MT6280) || defined(MT6589) || defined(MT6572) || defined(MT6582) || defined(MT6592) || defined(MT6571)|| defined(MT6580))
#define __RELOAD_HW_COEFF__  ( defined(MT6280) || defined(MT6589) || defined(MT6572) || defined(MT6582) || defined(MT6592) || defined(MT6571)|| defined(MT6580))
#define WB_SPE_SUPPORT        ( defined(MT6280) || defined(MT6589) || defined(MT6572) || defined(MT6582) || defined(MT6592) || defined(MT6571)|| defined(MT6580))
...
#if (defined(__L1_LOCK_AFCDAC_AT_STARTUP_SUPPORT__)&&defined(__L1_GPS_CO_CLOCK_SUPPORT__)) || defined(MT6582) || defined(MT6592) || defined(MT6571)
...
// This compile option should be enabled from MT6280,MT6589,MT6572,MT6582,etc.
