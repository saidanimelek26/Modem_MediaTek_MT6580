...
#ifndef _DPRAM_6580_H_
#define _DPRAM_6580_H_
...
#define DP_IRDMA_START_PTR                        DP_IRDMA_BASE + 0x002 /* 0x3acb */
#define DP_IRDMA_SB                               DP_IRDMA_BASE + 0x003 /* 0x3acc */
#define DP_IRDMA_END_PTR                          DP_IRDMA_BASE + 0x003 /* 0x3acc */
...
#define DP_SID_THRES                              DP_MODEM_RESERVED_BASE + 0x00a /* 0x3d2f */
...
#define SPH_DEL_M_DL                              DP2_SP_CODEC_CTRL_BASE + 0x003 /* 0x3d6f */
...
#define SPH_DEV_MODE                              DP2_SP_AUDIO_INTERFACE_CTRL_BASE + 0x002 /* 0x3d77 */
#define SPH_3G_SMR_CTRL                           DP2_SP_AUDIO_INTERFACE_CTRL_BASE + 0x003 /* 0x3d78 */
#define SPH_DEL_M_UL                              DP2_SP_AUDIO_INTERFACE_CTRL_BASE + 0x004 /* 0x3d79 */
...
#define SPH_ENH_DL_GAIN                           DP2_SP_AUDIO_INTERFACE_CTRL_BASE + 0x011 /* 0x3d86 */
...
#define SPH_DM_ADDR_SE2_PTR                       DP2_SP_8kPCM_CTRL_BASE + 0x000 /* 0x3d92 */
#define SPH_DM_ADDR_SE3_BUF                       DP2_SP_8kPCM_CTRL_BASE + 0x001 /* 0x3d93 */
#define SPH_DM_ADDR_SE4_BUF                       DP2_SP_8kPCM_CTRL_BASE + 0x002 /* 0x3d94 */
#define SPH_DM_ADDR_ANC_PTR                       DP2_SP_8kPCM_CTRL_BASE + 0x003 /* 0x3d95 */
#define SPH_PCM_REC_CTRL                          DP2_SP_8kPCM_CTRL_BASE + 0x004 /* 0x3d96 */
#define SPH_DM_ADDR_EPL_UL_PRE_BUF                DP2_SP_8kPCM_CTRL_BASE + 0x005 /* 0x3d97 */
#define SPH_DM_ADDR_EPL_UL_POS_BUF                DP2_SP_8kPCM_CTRL_BASE + 0x006 /* 0x3d98 */
#define SPH_DM_ADDR_EPL_DL_PRE_BUF                DP2_SP_8kPCM_CTRL_BASE + 0x007 /* 0x3d99 */
#define SPH_DM_ADDR_EPL_DL_POS_BUF                DP2_SP_8kPCM_CTRL_BASE + 0x008 /* 0x3d9a */
#define SPH_DM_ADDR_EPL_UL2_BUF                   DP2_SP_8kPCM_CTRL_BASE + 0x009 /* 0x3d9b */
#define SPH_DM_ADDR_EPL_UL3_BUF                   DP2_SP_8kPCM_CTRL_BASE + 0x00a /* 0x3d9c */
#define SPH_DM_ADDR_EPL_UL4_BUF                   DP2_SP_8kPCM_CTRL_BASE + 0x00b /* 0x3d9d */
...
#define SPH_3G_UNSYNC_STATUS                      DP2_SP_8kPCM_CTRL_BASE + 0x00e /* 0x3da0 */
...
#define SPH_DM_ADDR_PNW_UL3_BUF                   DP2_SP_CTM_BASE + 0x002 /* 0x3e2a */
#define SPH_DM_ADDR_PNW_UL4_BUF                   DP2_SP_CTM_BASE + 0x003 /* 0x3e2b */
#define SPH_DM_ADDR_PNW_DL_BUF                    DP2_SP_CTM_BASE + 0x004 /* 0x3e2c */
#define SPH_PNW_CTRL_UL1                          DP2_SP_CTM_BASE + 0x005 /* 0x3e2d */
#define SPH_PNW_CTRL_UL2                          DP2_SP_CTM_BASE + 0x006 /* 0x3e2e */
#define SPH_PNW_CTRL_DL                           DP2_SP_CTM_BASE + 0x007 /* 0x3e2f */
#define SPH_CTM_CTRL                              DP2_SP_CTM_BASE + 0x008 /* 0x3e30 */
#define SPH_CTM_BFI_FACCH_REPORT                  DP2_SP_CTM_BASE + 0x009 /* 0x3e31 */
#define SPH_PNW_LEN_UL1                           DP2_SP_CTM_BASE + 0x00a /* 0x3e32 */
#define SPH_PNW_LEN_UL2                           DP2_SP_CTM_BASE + 0x00b /* 0x3e33 */
#define SPH_PNW_LEN_UL3                           DP2_SP_CTM_BASE + 0x00c /* 0x3e34 */
#define SPH_PNW_LEN_UL4                           DP2_SP_CTM_BASE + 0x00d /* 0x3e35 */
#define SPH_PNW_LEN_DL                            DP2_SP_CTM_BASE + 0x00e /* 0x3e36 */
#define SPH_CTM_AMR_CODEBOOK_GAIN_LIMIT           DP2_SP_CTM_BASE + 0x00f /* 0x3e37 */
#define SPH_CTM_AMR_CODEBOOK_GAIN_UPDATE          DP2_SP_CTM_BASE + 0x010 /* 0x3e38 */
#define SPH_CTM_COSIM_CTRL                        DP2_SP_CTM_BASE + 0x011 /* 0x3e39 */

#define DP2_SP_AEC_CTRL_BASE                      DP2_SP_CTM_BASE + 0x012 /* 0x3e3a */

#define SPH_ENH_UL_CTRL                           DP2_SP_AEC_CTRL_BASE + 0x000 /* 0x3e3a */
#define DP_AEC_CTRL                               DP2_SP_AEC_CTRL_BASE + 0x001 /* 0x3e3b */
#define DP_TDNC_CTRL                              DP2_SP_AEC_CTRL_BASE + 0x001 /* 0x3e3b */
#define DP_EES_CTRL                               DP2_SP_AEC_CTRL_BASE + 0x002 /* 0x3e3c */
#define DP_DMNR_CTRL                              DP2_SP_AEC_CTRL_BASE + 0x003 /* 0x3e3d */
#define DP_AEC_CONTROL_WORD                       DP2_SP_AEC_CTRL_BASE + 0x004 /* 0x3e3e */
#define DP_EC_PAR_ADDR                            DP2_SP_AEC_CTRL_BASE + 0x007 /* 0x3e41 */
#define DP2_ES_Time_Const                         DP2_SP_AEC_CTRL_BASE + 0x007 /* 0x3e41 */
#define DP2_ES_Vol_Const                          DP2_SP_AEC_CTRL_BASE + 0x008 /* 0x3e42 */

#define DP2_SP_VR_CTRL_BASE                       DP2_SP_AEC_CTRL_BASE + 0x00f /* 0x3e49 */

#define DP_VR_CTRL                                DP2_SP_VR_CTRL_BASE + 0x000 /* 0x3e49 */
#define DP_VR_IO_BASE                             DP2_SP_VR_CTRL_BASE + 0x001 /* 0x3e4a */
#define DP2_DATA_AP_DATA_UL                       DP2_SP_VR_CTRL_BASE + 0x004 /* 0x3e4d */
#define DP2_DATA_AP_DATA_DL                       DP2_SP_VR_CTRL_BASE + 0x005 /* 0x3e4e */
#define SPH_PCM_ROUTER_CTRL                       DP2_SP_VR_CTRL_BASE + 0x006 /* 0x3e4f */
#define SPH_THIRDMIC_CTRL                         DP2_SP_VR_CTRL_BASE + 0x007 /* 0x3e50 */
#define SPH_FOURTHMIC_CTRL                        DP2_SP_VR_CTRL_BASE + 0x008 /* 0x3e51 */
#define SPH_ANC_CTRL                              DP2_SP_VR_CTRL_BASE + 0x009 /* 0x3e52 */
#define SPH_3G_D2M_UL_HDR                         DP2_SP_VR_CTRL_BASE + 0x00a /* 0x3e53 */
#define SPH_3G_D2M_UL_HB_ADDR                     DP2_SP_VR_CTRL_BASE + 0x00b /* 0x3e54 */
#define SPH_3G_D2M_UL_USED_MODE                   DP2_SP_VR_CTRL_BASE + 0x00c /* 0x3e55 */
#define SPH_3G_D2M_UL_UNSYNC_STATUS               DP2_SP_VR_CTRL_BASE + 0x00d /* 0x3e56 */

#define DP2_SP_AUDIO_CTRL_BASE                    DP2_SP_VR_CTRL_BASE + 0x00e /* 0x3e57 */

#define DP_TEST_SIM_SBSD_CTRL                     DP2_SP_AUDIO_CTRL_BASE + 0x000 /* 0x3e57 */
#define DP2_TEST_SIM_IND                          DP2_SP_AUDIO_CTRL_BASE + 0x000 /* 0x3e57 */
#define AWB_LB_CHECKSUM_ADDR                      DP2_SP_AUDIO_CTRL_BASE + 0x001 /* 0x3e58 */
#define AFE_BT_LB_CHECKSUM_ADDR                   DP2_SP_AUDIO_CTRL_BASE + 0x001 /* 0x3e58 */
#define SPE_RAM_LB_CHECK_ADDR                     DP2_SP_AUDIO_CTRL_BASE + 0x001 /* 0x3e58 */
#define DP_AUDIO_CTRL2                            DP2_SP_AUDIO_CTRL_BASE + 0x002 /* 0x3e59 */
#define DP_ENHANCED_AUDIO_CTRL                    DP2_SP_AUDIO_CTRL_BASE + 0x003 /* 0x3e5a */
#define SPH_SCH_IMPROVE_CTRL                      DP2_SP_AUDIO_CTRL_BASE + 0x005 /* 0x3e5c */
#define SPH_BGS_UL_GAIN                           DP2_SP_AUDIO_CTRL_BASE + 0x006 /* 0x3e5d */
#define SPH_BGS_DL_GAIN                           DP2_SP_AUDIO_CTRL_BASE + 0x007 /* 0x3e5e */
#define SPH_3G_SE_RATE_UPDATE                     DP2_SP_AUDIO_CTRL_BASE + 0x008 /* 0x3e5f */
#define SPH_3G_SD_RATE_UPDATE                     DP2_SP_AUDIO_CTRL_BASE + 0x009 /* 0x3e60 */
#define DP_AWB_SE_CTRL                            DP2_SP_AUDIO_CTRL_BASE + 0x00a /* 0x3e61 */
#define DP_AWB_SE_STATUS                          DP2_SP_AUDIO_CTRL_BASE + 0x00a /* 0x3e61 */
#define DP_AWB_SD_CTRL                            DP2_SP_AUDIO_CTRL_BASE + 0x00b /* 0x3e62 */
#define DP_AWB_SD_STATUS                          DP2_SP_AUDIO_CTRL_BASE + 0x00b /* 0x3e62 */
#define DP_G723_SE_CTRL                           DP2_SP_AUDIO_CTRL_BASE + 0x00c /* 0x3e63 */
#define DP_G723_SD_CTRL                           DP2_SP_AUDIO_CTRL_BASE + 0x00d /* 0x3e64 */
#define DP_NR_CTRL                                DP2_SP_AUDIO_CTRL_BASE + 0x00e /* 0x3e65 */

#define DP2_SP_AUDIO_ENHANCE_BASE                 DP2_SP_AUDIO_CTRL_BASE + 0x00f /* 0x3e66 */

#define DP_DSP_DEAD_INT                           DP2_SP_AUDIO_ENHANCE_BASE + 0x000 /* 0x3e66 */
#define DP_AMR_Mode_Error_Assert_Type             DP2_SP_AUDIO_ENHANCE_BASE + 0x001 /* 0x3e67 */
#define DP_AMR_Mode_Error_Assert_Flag             DP2_SP_AUDIO_ENHANCE_BASE + 0x002 /* 0x3e68 */
#define DP_Audio_Flexi_Ctrl                       DP2_SP_AUDIO_ENHANCE_BASE + 0x003 /* 0x3e69 */
#define DP_VOICE_CHG_SCH                          DP2_SP_AUDIO_ENHANCE_BASE + 0x004 /* 0x3e6a */
#define DP_VOICE_CHG_TYPE                         DP2_SP_AUDIO_ENHANCE_BASE + 0x005 /* 0x3e6b */
#define SPH_BT_CTRL                               DP2_SP_AUDIO_ENHANCE_BASE + 0x006 /* 0x3e6c */
#define SPH_DM_ADDR_SE_PTR                        DP2_SP_AUDIO_ENHANCE_BASE + 0x007 /* 0x3e6d */
#define SPH_DM_ADDR_SD_PTR                        DP2_SP_AUDIO_ENHANCE_BASE + 0x008 /* 0x3e6e */
#define DP_UP_DOWN_SAMPL_CTRL                     DP2_SP_AUDIO_ENHANCE_BASE + 0x009 /* 0x3e6f */
#define DP_DL_NR_CTRL                             DP2_SP_AUDIO_ENHANCE_BASE + 0x00a /* 0x3e70 */
#define DP_Audio_DAC_CTRL                         DP2_SP_AUDIO_ENHANCE_BASE + 0x00b /* 0x3e71 */
#define DP_VBI_SYNC_BT_Earphone_CTRL              DP2_SP_AUDIO_ENHANCE_BASE + 0x00c /* 0x3e72 */
#define SPH_SAL_CHIPDIFF_DUMMY                    DP2_SP_AUDIO_ENHANCE_BASE + 0x00d /* 0x3e73 */
#define SPH_SFE_CTRL                              DP2_SP_AUDIO_ENHANCE_BASE + 0x00f /* 0x3e75 */
#define DP2_AUDIO_VIA_BT_CTRL                     DP2_SP_AUDIO_ENHANCE_BASE + 0x010 /* 0x3e76 */
#define DP2_AUDIO_VIA_BT_INT                      DP2_SP_AUDIO_ENHANCE_BASE + 0x011 /* 0x3e77 */
#define DP2_AGC_CTRL                              DP2_SP_AUDIO_ENHANCE_BASE + 0x012 /* 0x3e78 */
#define DP2_AGC_GAIN                              DP2_SP_AUDIO_ENHANCE_BASE + 0x013 /* 0x3e79 */
#define DP2_DATA_AP_CTRL                          DP2_SP_AUDIO_ENHANCE_BASE + 0x014 /* 0x3e7a */
#define DP2_20ms_SP_CTRL                          DP2_SP_AUDIO_ENHANCE_BASE + 0x015 /* 0x3e7b */
#define DP2_COMPEN_BLOCK_FILTER                   DP2_SP_AUDIO_ENHANCE_BASE + 0x015 /* 0x3e7b */
#define DP_605_Task_Id                            DP2_SP_AUDIO_ENHANCE_BASE + 0x016 /* 0x3e7c */
#define DP_605_no_8k_Task_Id                      DP2_SP_AUDIO_ENHANCE_BASE + 0x017 /* 0x3e7d */

#define DP2_Reserve_BASE                          DP2_SP_AUDIO_ENHANCE_BASE + 0x018 /* 0x3e7e */

#define SPH_3G_CTRL                               DP2_Reserve_BASE + 0x000 /* 0x3e7e */
#define DP2_DDL_MCU_DSP_HAND_SHAKE                DP2_Reserve_BASE + 0x001 /* 0x3e7f */

#define DP2_AWB_8K_BASE                           DP2_Reserve_BASE + 0x002 /* 0x3e80 */

#define DP2_RINI_INT                              DP2_AWB_8K_BASE + 0x006 /* 0x3e86 */
#define DP2_DL_RIN_sig_energy                     DP2_AWB_8K_BASE + 0x007 /* 0x3e87 */
#define SPH_DYNA_FWLA_MODE_CTRL                   DP2_AWB_8K_BASE + 0x008 /* 0x3e88 */

#define DP2_EPL_BND_BASE                          DP2_AWB_8K_BASE + 0x009 /* 0x3e89 */

#define SPH_EPL_BND                               DP2_EPL_BND_BASE + 0x000 /* 0x3e89 */

#define DP2_AWB_LINK_EXTEND_BASE                  DP2_EPL_BND_BASE + 0x001 /* 0x3e8a */

#define DP_SD1_AWB_VM_0                           DP2_AWB_LINK_EXTEND_BASE + 0x000 /* 0x3e8a */
#define DP_3G_RX_VM_0                             DP2_AWB_LINK_EXTEND_BASE + 0x000 /* 0x3e8a */
#define SPH_3G_SD_DATA_HDR                        DP2_AWB_LINK_EXTEND_BASE + 0x000 /* 0x3e8a */
#define SPH_AP_SD_DATA_HDR                        DP2_AWB_LINK_EXTEND_BASE + 0x000 /* 0x3e8a */
#define DP_Org_SD1_VM_1                           DP2_AWB_LINK_EXTEND_BASE + 0x001 /* 0x3e8b */
#define SPH_3G_SD_DATA_HB                         DP2_AWB_LINK_EXTEND_BASE + 0x001 /* 0x3e8b */
#define SPH_AP_SD_DATA_HB                         DP2_AWB_LINK_EXTEND_BASE + 0x001 /* 0x3e8b */
#define DP_SD2_AWB_VM_0                           DP2_AWB_LINK_EXTEND_BASE + 0x020 /* 0x3eaa */
#define DP_3G_TX_VM_0                             DP2_AWB_LINK_EXTEND_BASE + 0x020 /* 0x3eaa */
#define SPH_3G_SE_DATA_HDR                        DP2_AWB_LINK_EXTEND_BASE + 0x020 /* 0x3eaa */
#define SPH_AP_SE_DATA_HDR                        DP2_AWB_LINK_EXTEND_BASE + 0x020 /* 0x3eaa */
#define DP_Org_SD2_VM_1                           DP2_AWB_LINK_EXTEND_BASE + 0x021 /* 0x3eab */
#define SPH_3G_SE_DATA_HB                         DP2_AWB_LINK_EXTEND_BASE + 0x021 /* 0x3eab */
#define SPH_AP_SE_DATA_HB                         DP2_AWB_LINK_EXTEND_BASE + 0x021 /* 0x3eab */
#define DP_SD2_AWB_VM_18                          DP2_AWB_LINK_EXTEND_BASE + 0x032 /* 0x3ebc */
#define DP_WB_DEBUG_INFO                          DP2_AWB_LINK_EXTEND_BASE + 0x040 /* 0x3eca */

#define DP_SPEECH_OTHER_BASE                      DP2_AWB_LINK_EXTEND_BASE + 0x04c /* 0x3ed6 */

#define DP_UL_COMFORT_NOISE_THRESHOLD             DP_SPEECH_OTHER_BASE + 0x000 /* 0x3ed6 */
#define DP_UL_COMFORT_NOISE_SHIFT                 DP_SPEECH_OTHER_BASE + 0x001 /* 0x3ed7 */
#define DP_DTX_DSPK_FUN_CTRL_ADDR                 DP_SPEECH_OTHER_BASE + 0x002 /* 0x3ed8 */
#define DP_HR_BER_THD_ADDR                        DP_SPEECH_OTHER_BASE + 0x003 /* 0x3ed9 */
#define DP_FR_BER_THD_ADDR                        DP_SPEECH_OTHER_BASE + 0x004 /* 0x3eda */
#define DP_EFR_BER_THD_ADDR                       DP_SPEECH_OTHER_BASE + 0x005 /* 0x3edb */
#define DP2_TIME_STAMP_2G_H                       DP_SPEECH_OTHER_BASE + 0x006 /* 0x3edc */
#define DP2_TIME_STAMP_2G_L                       DP_SPEECH_OTHER_BASE + 0x007 /* 0x3edd */
#define DP2_TIME_STAMP_3G_H                       DP_SPEECH_OTHER_BASE + 0x008 /* 0x3ede */
#define DP2_TIME_STAMP_3G_L                       DP_SPEECH_OTHER_BASE + 0x009 /* 0x3edf */
#define SPH_DBG_MOD                               DP_SPEECH_OTHER_BASE + 0x00a /* 0x3ee0 */
#define DP2_ABF_CTRL_1                            DP_SPEECH_OTHER_BASE + 0x00b /* 0x3ee1 */
#define DP2_ABF_CTRL_2                            DP_SPEECH_OTHER_BASE + 0x00c /* 0x3ee2 */
#define SPH_DUMIC_CTRL                            DP_SPEECH_OTHER_BASE + 0x00d /* 0x3ee3 */

#define DP_SPEECH_RESERVED_BASE                   DP_SPEECH_OTHER_BASE + 0x00e /* 0x3ee4 */

#define DP_SPH_COSIM_RESULT_REPORT                DP_SPEECH_RESERVED_BASE + 0x000 /* 0x3ee4 */
#define DP_SPH_COSIM_FAIL_TYPE                    DP_SPEECH_RESERVED_BASE + 0x001 /* 0x3ee5 */
#define DP_SPH_SPECIAL_LOOPBACK_CTRL              DP_SPEECH_RESERVED_BASE + 0x002 /* 0x3ee6 */
#define DP_TASK5_COSIM_HANDSHAKE                  DP_SPEECH_RESERVED_BASE + 0x003 /* 0x3ee7 */
#define DP_AGC_SW_GAIN1                           DP_SPEECH_RESERVED_BASE + 0x004 /* 0x3ee8 */
#define DP_AGC_SW_GAIN2                           DP_SPEECH_RESERVED_BASE + 0x005 /* 0x3ee9 */
#define SPH_DACA_CTRL                             DP_SPEECH_RESERVED_BASE + 0x006 /* 0x3eea */
#define SPH_DM_ADDR_DACA_UL_BUF                   DP_SPEECH_RESERVED_BASE + 0x007 /* 0x3eeb */
#define SPH_DM_ADDR_DACA_DL_BUF                   DP_SPEECH_RESERVED_BASE + 0x008 /* 0x3eec */
#define SPH_DACA_LEN_UL                           DP_SPEECH_RESERVED_BASE + 0x009 /* 0x3eed */
#define SPH_DACA_LEN_DL                           DP_SPEECH_RESERVED_BASE + 0x00a /* 0x3eee */
#define SPH_SW_TRANSC_SD_CNTR                     DP_SPEECH_RESERVED_BASE + 0x00b /* 0x3eef */
#define SPH_SW_TRANSC_TAF_CNTR                    DP_SPEECH_RESERVED_BASE + 0x00c /* 0x3ef0 */
#define SPH_APP_MODE                              DP_SPEECH_RESERVED_BASE + 0x00d /* 0x3ef1 */
#define SPH_PLC_CTRL                              DP_SPEECH_RESERVED_BASE + 0x00e /* 0x3ef2 */
#define SPH_8K_RESYNC_CTRL                        DP_SPEECH_RESERVED_BASE + 0x00f /* 0x3ef3 */
#define SPH_8K_RESYNC_OFFSET_UL                   DP_SPEECH_RESERVED_BASE + 0x010 /* 0x3ef4 */
#define SPH_8K_RESYNC_OFFSET_DL                   DP_SPEECH_RESERVED_BASE + 0x011 /* 0x3ef5 */
#define SPH_DM_ADDR_BAND_FLAG                     DP_SPEECH_RESERVED_BASE + 0x012 /* 0x3ef6 */
#define SPH_WARN_MSG_UL                           DP_SPEECH_RESERVED_BASE + 0x013 /* 0x3ef7 */
#define SPH_WARN_MSG_DL                           DP_SPEECH_RESERVED_BASE + 0x014 /* 0x3ef8 */
#define SPH_ENH_DYNAMIC_SWITCH                    DP_SPEECH_RESERVED_BASE + 0x015 /* 0x3ef9 */
#define SPH_ENH_DEBUG_ADDR                        DP_SPEECH_RESERVED_BASE + 0x016 /* 0x3efa */
#define SPH_EXTCOD_PEX_CTRL                       DP_SPEECH_RESERVED_BASE + 0x017 /* 0x3efb */
#define SPH_EXTCOD_PEX_LEN                        DP_SPEECH_RESERVED_BASE + 0x018 /* 0x3efc */

#define DP2_AUDIO_CTRL_FIELD_BASE                 DP_SPEECH_RESERVED_BASE + 0x019 /* 0x3efd */

#define DP_AUDIO_ASP_TYPE_ADDR                    DP2_AUDIO_CTRL_FIELD_BASE + 0x000 /* 0x3efd */
#define DP_AUDIO_ASP_FS_ADDR                      DP2_AUDIO_CTRL_FIELD_BASE + 0x001 /* 0x3efe */
#define DP_Audio_ASP_DEL_W_ADDR                   DP2_AUDIO_CTRL_FIELD_BASE + 0x002 /* 0x3eff */
#define DP_AUDIO_DEC_FRAME_LENGTH                 DP2_AUDIO_CTRL_FIELD_BASE + 0x003 /* 0x3f00 */
#define DP_Audio_ASP_DEL_MARGIN_W_ADDR            DP2_AUDIO_CTRL_FIELD_BASE + 0x004 /* 0x3f01 */
#define DP_VOL_OUT                                DP2_AUDIO_CTRL_FIELD_BASE + 0x005 /* 0x3f02 */

#define A2V_BASE                                  DP2_AUDIO_CTRL_FIELD_BASE + 0x006 /* 0x3f03 */

#define A2V_INT_ENABLE                            A2V_BASE + 0x000 /* 0x3f03 */
#define A2V_INT_CNT                               A2V_BASE + 0x001 /* 0x3f04 */
#define A2V_INT_STAMP                             A2V_BASE + 0x002 /* 0x3f05 */
#define A2V_AUDIO_FRMAE_COUNT                     A2V_BASE + 0x003 /* 0x3f06 */
#define A2V_VIDEO_FRAME_COUNT                     A2V_BASE + 0x004 /* 0x3f07 */
#define A2V_INT_DSP_COUNT                         A2V_BASE + 0x005 /* 0x3f08 */
#define A2V_INTERRUPT_PADDING_FLAG                A2V_BASE + 0x006 /* 0x3f09 */
#define A2V_SPEECH_COUNT                          A2V_BASE + 0x007 /* 0x3f0a */

#define DP2_WAV_CTRL_FIELD_BASE                   A2V_BASE + 0x008 /* 0x3f0b */

#define DP_ASP_WAV_BASE_CTRL                      DP2_WAV_CTRL_FIELD_BASE + 0x000 /* 0x3f0b */
#define DP_ASP_WAV_W_IO_ADDR                      DP2_WAV_CTRL_FIELD_BASE + 0x001 /* 0x3f0c */
#define DP_ASP_WAV_R_IO_ADDR                      DP2_WAV_CTRL_FIELD_BASE + 0x002 /* 0x3f0d */
#define DP2_WAV_STEREO_FLAG                       DP2_WAV_CTRL_FIELD_BASE + 0x003 /* 0x3f0e */

#define DP2_WT_CTRL_FIELD_BASE                    DP2_WAV_CTRL_FIELD_BASE + 0x004 /* 0x3f0f */

#define DP_WT_CONTROL                             DP2_WT_CTRL_FIELD_BASE + 0x000 /* 0x3f0f */

#define DP2_MP3_CTRL_FIELD_BASE                   DP2_WT_CTRL_FIELD_BASE + 0x001 /* 0x3f10 */

#define MP3_CONTROL_BASE_ADD                      DP2_MP3_CTRL_FIELD_BASE + 0x000 /* 0x3f10 */
#define MP3_CONTROL_1                             DP2_MP3_CTRL_FIELD_BASE + 0x001 /* 0x3f11 */
#define MP3_CONTROL_2                             DP2_MP3_CTRL_FIELD_BASE + 0x002 /* 0x3f12 */
#define MP3_CONTROL_3                             DP2_MP3_CTRL_FIELD_BASE + 0x003 /* 0x3f13 */
#define MP3_CONTROL_4                             DP2_MP3_CTRL_FIELD_BASE + 0x004 /* 0x3f14 */
#define MP3_CONTROL_5                             DP2_MP3_CTRL_FIELD_BASE + 0x005 /* 0x3f15 */
#define MP3_CONTROL_6                             DP2_MP3_CTRL_FIELD_BASE + 0x006 /* 0x3f16 */
#define MP3_CONTROL_7                             DP2_MP3_CTRL_FIELD_BASE + 0x007 /* 0x3f17 */
#define MP3_CONTROL_8                             DP2_MP3_CTRL_FIELD_BASE + 0x008 /* 0x3f18 */
#define MP3_CONTROL_9                             DP2_MP3_CTRL_FIELD_BASE + 0x009 /* 0x3f19 */
#define MP3_CONTROL_10                            DP2_MP3_CTRL_FIELD_BASE + 0x00a /* 0x3f1a */
#define MP3_CONTROL_11                            DP2_MP3_CTRL_FIELD_BASE + 0x00b /* 0x3f1b */
#define MP3_CONTROL_12                            DP2_MP3_CTRL_FIELD_BASE + 0x00c /* 0x3f1c */
#define MP3_CONTROL_13                            DP2_MP3_CTRL_FIELD_BASE + 0x00d /* 0x3f1d */
#define MP3_CONTROL_14                            DP2_MP3_CTRL_FIELD_BASE + 0x00e /* 0x3f1e */
#define MP3_CONTROL_15                            DP2_MP3_CTRL_FIELD_BASE + 0x00f /* 0x3f1f */
#define MP3_CONTROL_16                            DP2_MP3_CTRL_FIELD_BASE + 0x010 /* 0x3f20 */
#define MP3_CONTROL_17                            DP2_MP3_CTRL_FIELD_BASE + 0x011 /* 0x3f21 */
#define MP3_CONTROL_18                            DP2_MP3_CTRL_FIELD_BASE + 0x012 /* 0x3f22 */
#define MP3_CONTROL_19                            DP2_MP3_CTRL_FIELD_BASE + 0x013 /* 0x3f23 */
#define MP3_CONTROL_20                            DP2_MP3_CTRL_FIELD_BASE + 0x014 /* 0x3f24 */
#define MP3_CONTROL_21                            DP2_MP3_CTRL_FIELD_BASE + 0x015 /* 0x3f25 */
#define MP3_CONTROL_22                            DP2_MP3_CTRL_FIELD_BASE + 0x016 /* 0x3f26 */
#define MP3_CONTROL_23                            DP2_MP3_CTRL_FIELD_BASE + 0x017 /* 0x3f27 */
#define MP3_CONTROL_24                            DP2_MP3_CTRL_FIELD_BASE + 0x018 /* 0x3f28 */
#define MP3_CONTROL_25                            DP2_MP3_CTRL_FIELD_BASE + 0x019 /* 0x3f29 */
#define MP3_CONTROL_26                            DP2_MP3_CTRL_FIELD_BASE + 0x01a /* 0x3f2a */
#define MP3_CONTROL_27                            DP2_MP3_CTRL_FIELD_BASE + 0x01b /* 0x3f2b */
#define MP3_CONTROL_28                            DP2_MP3_CTRL_FIELD_BASE + 0x01c /* 0x3f2c */

#define DP2_AUDIO_PP_CTRL_BASE                    DP2_MP3_CTRL_FIELD_BASE + 0x01d /* 0x3f2d */

#define DP2_AUDIO_PP_CTRL                         DP2_AUDIO_PP_CTRL_BASE + 0x000 /* 0x3f2d */
#define DP_AUDIO_GAIN_STEP                        DP2_AUDIO_PP_CTRL_BASE + 0x001 /* 0x3f2e */
#define AUDIO_PP_TS_SPEED                         DP2_AUDIO_PP_CTRL_BASE + 0x002 /* 0x3f2f */
#define AUDIO_PP_ReserveA1                        DP2_AUDIO_PP_CTRL_BASE + 0x003 /* 0x3f30 */
#define Audio_debug_sherif1                       DP2_AUDIO_PP_CTRL_BASE + 0x003 /* 0x3f30 */
#define AUDIO_PP_TS_APM_to_DSP_Length             DP2_AUDIO_PP_CTRL_BASE + 0x004 /* 0x3f31 */
#define AUDIO_PP_ReserveA2                        DP2_AUDIO_PP_CTRL_BASE + 0x005 /* 0x3f32 */
#define AUDIO_PP_ReserveA3                        DP2_AUDIO_PP_CTRL_BASE + 0x006 /* 0x3f33 */
#define AUDIO_PP_ReserveA4                        DP2_AUDIO_PP_CTRL_BASE + 0x007 /* 0x3f34 */
#define AUDIO_PP_ReserveA5                        DP2_AUDIO_PP_CTRL_BASE + 0x008 /* 0x3f35 */
#define AUDIO_PP_ReserveA6                        DP2_AUDIO_PP_CTRL_BASE + 0x009 /* 0x3f36 */
#define AUDIO_PP_ReserveA7                        DP2_AUDIO_PP_CTRL_BASE + 0x00a /* 0x3f37 */
#define DP_AUDIO_DEC_CNTR_THRESHOLD               DP2_AUDIO_PP_CTRL_BASE + 0x00b /* 0x3f38 */
#define DP_AUDIO_CUR_GAIN                         DP2_AUDIO_PP_CTRL_BASE + 0x00c /* 0x3f39 */
#define AUDIO_CHECK_ASP_TYPE                      DP2_AUDIO_PP_CTRL_BASE + 0x00d /* 0x3f3a */
#define PCM_Rount_Data_Address                    DP2_AUDIO_PP_CTRL_BASE + 0x00e /* 0x3f3b */
#define PCM_Rount_Data_Length                     DP2_AUDIO_PP_CTRL_BASE + 0x00f /* 0x3f3c */
#define PCM_Rount_Data_Pagenum                    DP2_AUDIO_PP_CTRL_BASE + 0x010 /* 0x3f3d */
#define AUDIO_PP_ReserveC1                        DP2_AUDIO_PP_CTRL_BASE + 0x011 /* 0x3f3e */
#define AUDIO_PP_ReserveC2                        DP2_AUDIO_PP_CTRL_BASE + 0x012 /* 0x3f3f */
#define DYNAMIC_DOWNLOAD_MCU_STATUS               DP2_AUDIO_PP_CTRL_BASE + 0x013 /* 0x3f40 */
#define DYNAMIC_DOWNLOAD_STATUS                   DP2_AUDIO_PP_CTRL_BASE + 0x014 /* 0x3f41 */

#define DP2_EXTRA_APPLICATION_FILED_BASE          DP2_AUDIO_PP_CTRL_BASE + 0x015 /* 0x3f42 */

#define DP_AUDIO_ASP_COMMON_FLAG_1                DP2_EXTRA_APPLICATION_FILED_BASE + 0x000 /* 0x3f42 */
#define DP_AUDIO_RAMPDOWN_ENABLE                  DP2_EXTRA_APPLICATION_FILED_BASE + 0x001 /* 0x3f43 */
#define Audio_SD_ISR_Cycle                        DP2_EXTRA_APPLICATION_FILED_BASE + 0x002 /* 0x3f44 */
#define DP_AUDIO_ASP_COMMON_FLAG_2                DP2_EXTRA_APPLICATION_FILED_BASE + 0x003 /* 0x3f45 */
#define DP_AUDIO_ASP_EXTRA2_LEN_ADDR              DP2_EXTRA_APPLICATION_FILED_BASE + 0x004 /* 0x3f46 */
#define DP_TASK4_COSIM_HANDSHAKE                  DP2_EXTRA_APPLICATION_FILED_BASE + 0x005 /* 0x3f47 */

#define DP2_Dynamic_Load_field_BASE               DP2_EXTRA_APPLICATION_FILED_BASE + 0x006 /* 0x3f48 */

#define DDL_Task_Flag                             DP2_Dynamic_Load_field_BASE + 0x000 /* 0x3f48 */
#define DP2_Dynamic_Load_field                    DP2_Dynamic_Load_field_BASE + 0x000 /* 0x3f48 */
#define DDL_Check_Position                        DP2_Dynamic_Load_field_BASE + 0x001 /* 0x3f49 */
#define DDL_Task_ID                               DP2_Dynamic_Load_field_BASE + 0x002 /* 0x3f4a */

#define DP2_AUDIO_RESERVED_BASE                   DP2_Dynamic_Load_field_BASE + 0x003 /* 0x3f4b */

#define DP2_AUDIO_RESERVED_BASE1                  DP2_AUDIO_RESERVED_BASE + 0x000 /* 0x3f4b */
#define DP2_AUDIO_RESERVED_BASE2                  DP2_AUDIO_RESERVED_BASE + 0x001 /* 0x3f4c */

#define SPH_ENH_INTERNAL_PAR_BASE                 DP2_AUDIO_RESERVED_BASE + 0x002 /* 0x3f4d */

#define SPH_ENH_INTERNAL_PAR_ADDR                 SPH_ENH_INTERNAL_PAR_BASE + 0x000 /* 0x3f4d */

#define DP_SPEECH_EXPAND_BASE                     SPH_ENH_INTERNAL_PAR_BASE + 0x010 /* 0x3f5d */

#define DP2_AGC2_CTRL                             DP_SPEECH_EXPAND_BASE + 0x000 /* 0x3f5d */
#define DP2_AGC3_CTRL                             DP_SPEECH_EXPAND_BASE + 0x001 /* 0x3f5e */
#define DP2_AGC4_CTRL                             DP_SPEECH_EXPAND_BASE + 0x002 /* 0x3f5f */
#define SPH_SRC_DACA_PMOVL_BAK_P                  DP_SPEECH_EXPAND_BASE + 0x003 /* 0x3f60 */
#define SPH_SRC_DACA_MSTAT_BAK_P                  DP_SPEECH_EXPAND_BASE + 0x004 /* 0x3f61 */
#define Sph_DL_Cur_Vol                            DP_SPEECH_EXPAND_BASE + 0x005 /* 0x3f62 */
#define SPH_ATTACK_GAIN_DL_NB                     DP_SPEECH_EXPAND_BASE + 0x006 /* 0x3f63 */
#define SPH_RELEASE_GAIN_DL_NB                    DP_SPEECH_EXPAND_BASE + 0x007 /* 0x3f64 */
#define SPH_ATTACK_GAIN_DL_WB                     DP_SPEECH_EXPAND_BASE + 0x008 /* 0x3f65 */
#define SPH_RELEASE_GAIN_DL_WB                    DP_SPEECH_EXPAND_BASE + 0x009 /* 0x3f66 */

#define DP2_UNDEFINEDD_BASE                       DP_SPEECH_EXPAND_BASE + 0x00a /* 0x3f67 */


#define SHERIF_SIZE                               1383


// The statement checks whether generates SHERIF size exceeds limitation
#define MT6735_MD2_SHERIF_SIZE (1536 - 32)
#if (SHERIF_SIZE > MT6735_MD2_SHERIF_SIZE)
    ¡§SHERIF SIZE exceeds limitation !! This line makes assembler stop¡¨
#endif

#undef SHERIF_SIZE
#define SHERIF_SIZE (MT6735_MD2_SHERIF_SIZE)
