...
#ifndef _DPRAM_6582_H_
#define _DPRAM_6582_H_
...
#define SPH_8K_RESYNC_CTRL                        DP_SPEECH_RESERVED_BASE + 0x00f /* 0x3eee */
#define SPH_8K_RESYNC_OFFSET_UL                   DP_SPEECH_RESERVED_BASE + 0x010 /* 0x3eef */
#define SPH_8K_RESYNC_OFFSET_DL                   DP_SPEECH_RESERVED_BASE + 0x011 /* 0x3ef0 */
#define SPH_ENH_DYNAMIC_SWITCH                    DP_SPEECH_RESERVED_BASE + 0x012 /* 0x3ef1 */
#define SPH_ENH_DEBUG_ADDR                        DP_SPEECH_RESERVED_BASE + 0x013 /* 0x3ef2 */

#define DP2_AUDIO_CTRL_FIELD_BASE                 DP_SPEECH_RESERVED_BASE + 0x014 /* 0x3ef3 */

#define DP_AUDIO_ASP_TYPE_ADDR                    DP2_AUDIO_CTRL_FIELD_BASE + 0x000 /* 0x3ef3 */
#define DP_AUDIO_ASP_FS_ADDR                      DP2_AUDIO_CTRL_FIELD_BASE + 0x001 /* 0x3ef4 */
#define DP_Audio_ASP_DEL_W_ADDR                   DP2_AUDIO_CTRL_FIELD_BASE + 0x002 /* 0x3ef5 */
#define DP_AUDIO_DEC_FRAME_LENGTH                 DP2_AUDIO_CTRL_FIELD_BASE + 0x003 /* 0x3ef6 */
#define DP_Audio_ASP_DEL_MARGIN_W_ADDR            DP2_AUDIO_CTRL_FIELD_BASE + 0x004 /* 0x3ef7 */
#define DP_VOL_OUT                                DP2_AUDIO_CTRL_FIELD_BASE + 0x005 /* 0x3ef8 */

#define A2V_BASE                                  DP2_AUDIO_CTRL_FIELD_BASE + 0x006 /* 0x3ef9 */

#define A2V_INT_ENABLE                            A2V_BASE + 0x000 /* 0x3ef9 */
#define A2V_INT_CNT                               A2V_BASE + 0x001 /* 0x3efa */
#define A2V_INT_STAMP                             A2V_BASE + 0x002 /* 0x3efb */
#define A2V_AUDIO_FRMAE_COUNT                     A2V_BASE + 0x003 /* 0x3efc */
#define A2V_VIDEO_FRAME_COUNT                     A2V_BASE + 0x004 /* 0x3efd */
#define A2V_INT_DSP_COUNT                         A2V_BASE + 0x005 /* 0x3efe */
#define A2V_INTERRUPT_PADDING_FLAG                A2V_BASE + 0x006 /* 0x3eff */
#define A2V_SPEECH_COUNT                          A2V_BASE + 0x007 /* 0x3f00 */

#define DP2_WAV_CTRL_FIELD_BASE                   A2V_BASE + 0x008 /* 0x3f01 */

#define DP_ASP_WAV_BASE_CTRL                      DP2_WAV_CTRL_FIELD_BASE + 0x000 /* 0x3f01 */
#define DP_ASP_WAV_W_IO_ADDR                      DP2_WAV_CTRL_FIELD_BASE + 0x001 /* 0x3f02 */
#define DP_ASP_WAV_R_IO_ADDR                      DP2_WAV_CTRL_FIELD_BASE + 0x002 /* 0x3f03 */
#define DP2_WAV_STEREO_FLAG                       DP2_WAV_CTRL_FIELD_BASE + 0x003 /* 0x3f04 */

#define DP2_WT_CTRL_FIELD_BASE                    DP2_WAV_CTRL_FIELD_BASE + 0x004 /* 0x3f05 */

#define DP_WT_CONTROL                             DP2_WT_CTRL_FIELD_BASE + 0x000 /* 0x3f05 */

#define DP2_MP3_CTRL_FIELD_BASE                   DP2_WT_CTRL_FIELD_BASE + 0x001 /* 0x3f06 */

#define MP3_CONTROL_BASE_ADD                      DP2_MP3_CTRL_FIELD_BASE + 0x000 /* 0x3f06 */
#define MP3_CONTROL_1                             DP2_MP3_CTRL_FIELD_BASE + 0x001 /* 0x3f07 */
#define MP3_CONTROL_2                             DP2_MP3_CTRL_FIELD_BASE + 0x002 /* 0x3f08 */
#define MP3_CONTROL_3                             DP2_MP3_CTRL_FIELD_BASE + 0x003 /* 0x3f09 */
#define MP3_CONTROL_4                             DP2_MP3_CTRL_FIELD_BASE + 0x004 /* 0x3f0a */
#define MP3_CONTROL_5                             DP2_MP3_CTRL_FIELD_BASE + 0x005 /* 0x3f0b */
#define MP3_CONTROL_6                             DP2_MP3_CTRL_FIELD_BASE + 0x006 /* 0x3f0c */
#define MP3_CONTROL_7                             DP2_MP3_CTRL_FIELD_BASE + 0x007 /* 0x3f0d */
#define MP3_CONTROL_8                             DP2_MP3_CTRL_FIELD_BASE + 0x008 /* 0x3f0e */
#define MP3_CONTROL_9                             DP2_MP3_CTRL_FIELD_BASE + 0x009 /* 0x3f0f */
#define MP3_CONTROL_10                            DP2_MP3_CTRL_FIELD_BASE + 0x00a /* 0x3f10 */
#define MP3_CONTROL_11                            DP2_MP3_CTRL_FIELD_BASE + 0x00b /* 0x3f11 */
#define MP3_CONTROL_12                            DP2_MP3_CTRL_FIELD_BASE + 0x00c /* 0x3f12 */
#define MP3_CONTROL_13                            DP2_MP3_CTRL_FIELD_BASE + 0x00d /* 0x3f13 */
#define MP3_CONTROL_14                            DP2_MP3_CTRL_FIELD_BASE + 0x00e /* 0x3f14 */
#define MP3_CONTROL_15                            DP2_MP3_CTRL_FIELD_BASE + 0x00f /* 0x3f15 */
#define MP3_CONTROL_16                            DP2_MP3_CTRL_FIELD_BASE + 0x010 /* 0x3f16 */
#define MP3_CONTROL_17                            DP2_MP3_CTRL_FIELD_BASE + 0x011 /* 0x3f17 */
#define MP3_CONTROL_18                            DP2_MP3_CTRL_FIELD_BASE + 0x012 /* 0x3f18 */
#define MP3_CONTROL_19                            DP2_MP3_CTRL_FIELD_BASE + 0x013 /* 0x3f19 */
#define MP3_CONTROL_20                            DP2_MP3_CTRL_FIELD_BASE + 0x014 /* 0x3f1a */
#define MP3_CONTROL_21                            DP2_MP3_CTRL_FIELD_BASE + 0x015 /* 0x3f1b */
#define MP3_CONTROL_22                            DP2_MP3_CTRL_FIELD_BASE + 0x016 /* 0x3f1c */
#define MP3_CONTROL_23                            DP2_MP3_CTRL_FIELD_BASE + 0x017 /* 0x3f1d */
#define MP3_CONTROL_24                            DP2_MP3_CTRL_FIELD_BASE + 0x018 /* 0x3f1e */
#define MP3_CONTROL_25                            DP2_MP3_CTRL_FIELD_BASE + 0x019 /* 0x3f1f */
#define MP3_CONTROL_26                            DP2_MP3_CTRL_FIELD_BASE + 0x01a /* 0x3f20 */
#define MP3_CONTROL_27                            DP2_MP3_CTRL_FIELD_BASE + 0x01b /* 0x3f21 */
#define MP3_CONTROL_28                            DP2_MP3_CTRL_FIELD_BASE + 0x01c /* 0x3f22 */

#define DP2_AUDIO_PP_CTRL_BASE                    DP2_MP3_CTRL_FIELD_BASE + 0x01d /* 0x3f23 */

#define DP2_AUDIO_PP_CTRL                         DP2_AUDIO_PP_CTRL_BASE + 0x000 /* 0x3f23 */
#define DP_AUDIO_GAIN_STEP                        DP2_AUDIO_PP_CTRL_BASE + 0x001 /* 0x3f24 */
#define AUDIO_PP_TS_SPEED                         DP2_AUDIO_PP_CTRL_BASE + 0x002 /* 0x3f25 */
#define AUDIO_PP_ReserveA1                        DP2_AUDIO_PP_CTRL_BASE + 0x003 /* 0x3f26 */
#define Audio_debug_sherif1                       DP2_AUDIO_PP_CTRL_BASE + 0x003 /* 0x3f26 */
#define AUDIO_PP_TS_APM_to_DSP_Length             DP2_AUDIO_PP_CTRL_BASE + 0x004 /* 0x3f27 */
#define AUDIO_PP_ReserveA2                        DP2_AUDIO_PP_CTRL_BASE + 0x005 /* 0x3f28 */
#define AUDIO_PP_ReserveA3                        DP2_AUDIO_PP_CTRL_BASE + 0x006 /* 0x3f29 */
#define AUDIO_PP_ReserveA4                        DP2_AUDIO_PP_CTRL_BASE + 0x007 /* 0x3f2a */
#define AUDIO_PP_ReserveA5                        DP2_AUDIO_PP_CTRL_BASE + 0x008 /* 0x3f2b */
#define AUDIO_PP_ReserveA6                        DP2_AUDIO_PP_CTRL_BASE + 0x009 /* 0x3f2c */
#define AUDIO_PP_ReserveA7                        DP2_AUDIO_PP_CTRL_BASE + 0x00a /* 0x3f2d */
#define DP_AUDIO_DEC_CNTR_THRESHOLD               DP2_AUDIO_PP_CTRL_BASE + 0x00b /* 0x3f2e */
#define DP_AUDIO_CUR_GAIN                         DP2_AUDIO_PP_CTRL_BASE + 0x00c /* 0x3f2f */
#define AUDIO_CHECK_ASP_TYPE                      DP2_AUDIO_PP_CTRL_BASE + 0x00d /* 0x3f30 */
#define PCM_Rount_Data_Address                    DP2_AUDIO_PP_CTRL_BASE + 0x00e /* 0x3f31 */
#define PCM_Rount_Data_Length                     DP2_AUDIO_PP_CTRL_BASE + 0x00f /* 0x3f32 */
#define PCM_Rount_Data_Pagenum                    DP2_AUDIO_PP_CTRL_BASE + 0x010 /* 0x3f33 */
#define AUDIO_PP_ReserveC1                        DP2_AUDIO_PP_CTRL_BASE + 0x011 /* 0x3f34 */
#define AUDIO_PP_ReserveC2                        DP2_AUDIO_PP_CTRL_BASE + 0x012 /* 0x3f35 */
#define DYNAMIC_DOWNLOAD_MCU_STATUS               DP2_AUDIO_PP_CTRL_BASE + 0x013 /* 0x3f36 */
#define DYNAMIC_DOWNLOAD_STATUS                   DP2_AUDIO_PP_CTRL_BASE + 0x014 /* 0x3f37 */

#define DP2_EXTRA_APPLICATION_FILED_BASE          DP2_AUDIO_PP_CTRL_BASE + 0x015 /* 0x3f38 */

#define DP_AUDIO_ASP_COMMON_FLAG_1                DP2_EXTRA_APPLICATION_FILED_BASE + 0x000 /* 0x3f38 */
#define DP_AUDIO_RAMPDOWN_ENABLE                  DP2_EXTRA_APPLICATION_FILED_BASE + 0x001 /* 0x3f39 */
#define Audio_SD_ISR_Cycle                        DP2_EXTRA_APPLICATION_FILED_BASE + 0x002 /* 0x3f3a */
#define DP_AUDIO_ASP_COMMON_FLAG_2                DP2_EXTRA_APPLICATION_FILED_BASE + 0x003 /* 0x3f3b */
#define DP_AUDIO_ASP_EXTRA2_LEN_ADDR              DP2_EXTRA_APPLICATION_FILED_BASE + 0x004 /* 0x3f3c */
#define DP_TASK4_COSIM_HANDSHAKE                  DP2_EXTRA_APPLICATION_FILED_BASE + 0x005 /* 0x3f3d */

#define DP2_Dynamic_Load_field_BASE               DP2_EXTRA_APPLICATION_FILED_BASE + 0x006 /* 0x3f3e */

#define DDL_Task_Flag                             DP2_Dynamic_Load_field_BASE + 0x000 /* 0x3f3e */
#define DP2_Dynamic_Load_field                    DP2_Dynamic_Load_field_BASE + 0x000 /* 0x3f3e */
#define DDL_Check_Position                        DP2_Dynamic_Load_field_BASE + 0x001 /* 0x3f3f */
#define DDL_Task_ID                               DP2_Dynamic_Load_field_BASE + 0x002 /* 0x3f40 */

#define DP2_AUDIO_RESERVED_BASE                   DP2_Dynamic_Load_field_BASE + 0x003 /* 0x3f41 */

#define DP2_AUDIO_RESERVED_BASE1                  DP2_AUDIO_RESERVED_BASE + 0x000 /* 0x3f41 */
#define DP2_AUDIO_RESERVED_BASE2                  DP2_AUDIO_RESERVED_BASE + 0x001 /* 0x3f42 */

#define DP_SPEECH_EXPAND_BASE                     DP2_AUDIO_RESERVED_BASE + 0x002 /* 0x3f43 */

#define SPH_WARN_MSG                              DP_SPEECH_EXPAND_BASE + 0x000 /* 0x3f43 */

#define SPH_ENH_INTERNAL_PAR_BASE                 DP_SPEECH_EXPAND_BASE + 0x005 /* 0x3f48 */

#define SPH_ENH_INTERNAL_PAR_ADDR                 SPH_ENH_INTERNAL_PAR_BASE + 0x000 /* 0x3f48 */

#define DP_SPEECH_EXPAND2_BASE                    SPH_ENH_INTERNAL_PAR_BASE + 0x010 /* 0x3f58 */

#define DP2_AGC2_CTRL                             DP_SPEECH_EXPAND2_BASE + 0x000 /* 0x3f58 */
#define Sph_DL_Cur_Vol                            DP_SPEECH_EXPAND2_BASE + 0x001 /* 0x3f59 */
#define SPH_ATTACK_GAIN_DL_NB                     DP_SPEECH_EXPAND2_BASE + 0x002 /* 0x3f5a */
#define SPH_RELEASE_GAIN_DL_NB                    DP_SPEECH_EXPAND2_BASE + 0x003 /* 0x3f5b */
#define SPH_ATTACK_GAIN_DL_WB                     DP_SPEECH_EXPAND2_BASE + 0x004 /* 0x3f5c */
#define SPH_RELEASE_GAIN_DL_WB                    DP_SPEECH_EXPAND2_BASE + 0x005 /* 0x3f5d */

#define DP2_UNDEFINEDD_BASE                       DP_SPEECH_EXPAND2_BASE + 0x00a /* 0x3f62 */


#define SHERIF_SIZE                               1378


// The statement checks whether generates SHERIF size exceeds limitation
#define MT6582_SHERIF_SIZE (1536 - 32)
#if (SHERIF_SIZE > MT6582_SHERIF_SIZE)
    ¡§SHERIF SIZE exceeds limitation !! This line makes assembler stop¡¨
#endif

#undef SHERIF_SIZE
#define SHERIF_SIZE (MT6582_SHERIF_SIZE)
