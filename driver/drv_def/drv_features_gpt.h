...
/**************** GPT Feature Option******************/
   ...
   #define DRV_GPT_GPT4
   #define DRV_GPT_DIRECT_SLEEP_MODE_HANDLE
#elif defined(DRV_GPT_6572_SERIES)
   #define DRV_GPT_GPT3
   #define DRV_GPT_GPT4
   #define DRV_GPT_DIRECT_SLEEP_MODE_HANDLE
#elif defined(DRV_GPT_6582_SERIES)
   #define DRV_GPT_GPT3
   #define DRV_GPT_GPT4
   #define DRV_GPT_DIRECT_SLEEP_MODE_HANDLE   
#elif defined(DRV_GPT_6592_SERIES)
   #define DRV_GPT_GPT3
   #define DRV_GPT_GPT4
   #define DRV_GPT_DIRECT_SLEEP_MODE_HANDLE   
#elif defined(DRV_GPT_6571_SERIES)
   #define DRV_GPT_GPT3
   #define DRV_GPT_GPT4
   #define DRV_GPT_DIRECT_SLEEP_MODE_HANDLE 
#elif defined(DRV_GPT_6580_SERIES)
   #define DRV_GPT_GPT3
   #define DRV_GPT_GPT4
   #define DRV_GPT_DIRECT_SLEEP_MODE_HANDLE 
