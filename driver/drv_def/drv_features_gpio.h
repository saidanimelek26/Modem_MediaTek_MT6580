...
/**************** GPIO Feature Option******************/
   ...
   #define DRV_MD_GPIO_CONFIG0
#elif defined(DRV_GPIO_6572_SERIES)
    #define DRV_GPIO_OFF  
    #define DRV_GPIO_SMARTPHONE
    #define DRV_GPIO_SP_ON	//GPIO driver for SP modem
    #define DRV_GPIO_SP_REG
    #define DRV_GPIO_SPEC_NAME
    #define DRV_MD_GPIO_CONFIG2
	#define DRV_GPIO_REG_AS_6572
#elif defined(DRV_GPIO_6582_SERIES)
    #define DRV_GPIO_OFF  
    #define DRV_GPIO_SMARTPHONE
    #define DRV_GPIO_SP_ON	//GPIO driver for SP modem
    #define DRV_GPIO_SP_REG
	#define DRV_GPIO_REG_AS_6582
    #define DRV_MD_GPIO_CONFIG0
#elif defined(DRV_GPIO_6592_SERIES)
    #define DRV_GPIO_OFF  
    #define DRV_GPIO_SMARTPHONE
    #define DRV_GPIO_SP_ON	//GPIO driver for SP modem
    #define DRV_GPIO_SP_REG
	#define DRV_GPIO_REG_AS_6592
    #define DRV_MD_GPIO_CONFIG0
#elif defined(DRV_GPIO_6571_SERIES)
    #define DRV_GPIO_OFF  
    #define DRV_GPIO_SMARTPHONE
    #define DRV_GPIO_SP_ON	//GPIO driver for SP modem
    #define DRV_GPIO_SP_REG
    #define DRV_GPIO_REG_AS_6571
    #define DRV_MD_GPIO_CONFIG2
#elif defined(DRV_GPIO_6580_SERIES)
    #define DRV_GPIO_OFF  
    #define DRV_GPIO_SMARTPHONE
    #define DRV_GPIO_SP_ON	//GPIO driver for SP modem
    #define DRV_GPIO_SP_REG
    #define DRV_GPIO_REG_AS_6580
    #define DRV_MD_GPIO_CONFIG3	
