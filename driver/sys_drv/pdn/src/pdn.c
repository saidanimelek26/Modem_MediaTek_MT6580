 ...
 * Define global data
 *******************************************************************************/
#if !defined(__LPWR_SLIM_SUPPORT__) /* removed, LPWR should be phased out @W1249 */
...
#endif //#if !defined(__LPWR_SLIM_SUPPORT__) /* removed, LPWR should be phased out @W1249 */
