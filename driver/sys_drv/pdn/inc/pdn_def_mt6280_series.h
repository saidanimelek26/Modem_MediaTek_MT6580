 ...
 * Description:
 * ------------
 *   This file defines PDN X-MACRO for MT6280 series chips.
 *
 * Author:
 * -------
 * -------
...
X_PDN_CONST(UART1, DRVPDN_MD_NONPWR_GLOBAL_CON0, DRVPDN_MD_NONPWR_GLOBAL_SET0, DRVPDN_MD_NONPWR_GLOBAL_CLR0, MD_NONPWR_GLOBAL_CON0_UART, PDN_OPT_32BIT_REG | PDN_OPT_NEVER_OFF)
//X_PDN_USER(UART2, DRVPDN_CON1, DRVPDN_CON1_SET, DRVPDN_CON1_CLR, DRVPDN_CON1_UART2, PDN_OPT_16BIT_REG | PDN_OPT_NEVER_OFF)
//X_PDN_USER(UART3, DRVPDN_CON1, DRVPDN_CON1_SET, DRVPDN_CON1_CLR, DRVPDN_CON1_UART3, PDN_OPT_16BIT_REG | PDN_OPT_NEVER_OFF)
/* use AP UART as UART2 and UART3 for DVT purpose */
X_PDN_CONST(UART2, DRVPDN_AP_CG_CON0, DRVPDN_AP_CG_SET0, DRVPDN_AP_CG_CLR0, AP_CG_CON0_AP_UART1, PDN_OPT_32BIT_REG)
X_PDN_CONST(UART3, DRVPDN_AP_CG_CON0, DRVPDN_AP_CG_SET0, DRVPDN_AP_CG_CLR0, AP_CG_CON0_AP_UART2, PDN_OPT_32BIT_REG)
...
X_PDN_CONST(DMA, DRVPDN_MD_NONPWR_GLOBAL_CON0, DRVPDN_MD_NONPWR_GLOBAL_SET0, DRVPDN_MD_NONPWR_GLOBAL_CLR0, MD_NONPWR_GLOBAL_CON0_DMA, PDN_OPT_32BIT_REG)
X_PDN_CONST(SIM, DRVPDN_MD_NONPWR_GLOBAL_CON0, DRVPDN_MD_NONPWR_GLOBAL_SET0, DRVPDN_MD_NONPWR_GLOBAL_CLR0, MD_NONPWR_GLOBAL_CON0_SIM1, PDN_OPT_32BIT_REG)
X_PDN_CONST(SIM2, DRVPDN_MD_NONPWR_GLOBAL_CON0, DRVPDN_MD_NONPWR_GLOBAL_SET0, DRVPDN_MD_NONPWR_GLOBAL_CLR0, MD_NONPWR_GLOBAL_CON0_SIM2, PDN_OPT_32BIT_REG)
...
X_PDN_CONST(PWM, DRVPDN_AP_CG_CON0, DRVPDN_AP_CG_SET0, DRVPDN_AP_CG_CLR0, AP_CG_CON0_PWM, PDN_OPT_32BIT_REG)
//X_PDN_USER(PWM2, 0, 0, 0, 0, 0)
X_PDN_CONST(USB, DRVPDN_AP_CG_CON0, DRVPDN_AP_CG_SET0, DRVPDN_AP_CG_CLR0, AP_CG_CON0_AP_USB, PDN_OPT_32BIT_REG)
X_PDN_CONST(MSDC, DRVPDN_AP_CG_CON0, DRVPDN_AP_CG_SET0, DRVPDN_AP_CG_CLR0, AP_CG_CON0_MSDC, PDN_OPT_32BIT_REG)
//X_PDN_USER(MSDC2, DRVPDN_CON0, DRVPDN_CON0_SET, DRVPDN_CON0_CLR, DRVPDN_CON0_MSDC2, PDN_OPT_16BIT_REG)
X_PDN_CONST(NFI, DRVPDN_AP_CG_CON0, DRVPDN_AP_CG_SET0, DRVPDN_AP_CG_CLR0, AP_CG_CON0_NFI, PDN_OPT_32BIT_REG)
...
X_PDN_CONST(OSTIMERARM, DRVPDN_MD_NONPWR_GLOBAL_CON0, DRVPDN_MD_NONPWR_GLOBAL_SET0, DRVPDN_MD_NONPWR_GLOBAL_CLR0, MD_NONPWR_GLOBAL_CON0_OSTIMER, PDN_OPT_32BIT_REG)
...
//X_PDN_CONST(GCCTRX, MD2GSYS_CG_CON1, MD2GSYS_CG_SET1, MD2GSYS_CG_CLR1, MD2GSYS_CG_CON1_GCCTRX, PDN_OPT_16BIT_REG)
...
X_PDN_CONST(HIF, DRVPDN_AP_CG_CON0, DRVPDN_AP_CG_SET0, DRVPDN_AP_CG_CLR0, AP_CG_CON0_HIF, PDN_OPT_32BIT_REG)
//X_PDN_CONST(GMCI, MMSYS_CG_CON1, MMSYS_CG_SET1, MMSYS_CG_CLR1, MMSYS_CG_CON1_GMCI, PDN_OPT_32BIT_REG)
...
X_PDN_CONST(EFUSE, DRVPDN_AP_CG_CON0, DRVPDN_AP_CG_SET0, DRVPDN_AP_CG_CLR0, AP_CG_CON0_EFUSE, PDN_OPT_32BIT_REG)
X_PDN_CONST(EFUSE_NACRO, DRVPDN_AP_CG_CON0, DRVPDN_AP_CG_SET0, DRVPDN_AP_CG_CLR0, AP_CG_CON0_EFUSE_MACRO, PDN_OPT_32BIT_REG)
/* temporaily commented for UART DVY */
//X_PDN_CONST(AP_UART1, DRVPDN_AP_CG_CON0, DRVPDN_AP_CG_SET0, DRVPDN_AP_CG_CLR0, AP_CG_CON0_AP_UART1, PDN_OPT_32BIT_REG)
//X_PDN_CONST(AP_UART2, DRVPDN_AP_CG_CON0, DRVPDN_AP_CG_SET0, DRVPDN_AP_CG_CLR0, AP_CG_CON0_AP_UART2, PDN_OPT_32BIT_REG)
X_PDN_CONST(AP_DMA, DRVPDN_AP_CG_CON0, DRVPDN_AP_CG_SET0, DRVPDN_AP_CG_CLR0, AP_CG_CON0_AP_DMA, PDN_OPT_32BIT_REG)
X_PDN_CONST(AP_DBG, DRVPDN_AP_CG_CON0, DRVPDN_AP_CG_SET0, DRVPDN_AP_CG_CLR0, AP_CG_CON0_AP_DBG, PDN_OPT_32BIT_REG)
...
X_PDN_CONST(DBG, DRVPDN_MD_NONPWR_GLOBAL_CON0, DRVPDN_MD_NONPWR_GLOBAL_SET0, DRVPDN_MD_NONPWR_GLOBAL_CLR0, MD_NONPWR_GLOBAL_CON0_DBG, PDN_OPT_32BIT_REG)
