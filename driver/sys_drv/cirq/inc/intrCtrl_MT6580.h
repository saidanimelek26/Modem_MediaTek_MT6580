...
#ifndef __INTRCTRL_MT6580_H__
#define __INTRCTRL_MT6580_H__
...
#define IRQ_FIRPRIOP           ((volatile UINT32P)(CIRQ_base+0x04E0)) //FIQ Primary Setting register.
...
#define IRQ_L2DPA_CODE            (20)  /* dpa_acc_irq_b */
#define IRQ_L2UPA_CODE            (21)  /* upa_acc_irq_b */
#define IRQ_TXUPC_DSP_CODE        (22)
#define IRQ_BITCP_CODE            (23)
#define IRQ_IRDEBUG_CODE          (24)
#define IRQ_DSP2CPU_CODE          (25)  /* share_d12mint_b */
#define IRQ_PFC_DECODE_CODE	      (26)  /* 1'b1 */
#define IRQ_PFC_ENCODE_CODE	      (27)  /* 1'b1 */
...
#define IRQ_CTIRQ3_CODE           (32)  /*edge*/
#define IRQ_CTIRQ2_CODE           (33)  /*edge*/
#define IRQ_CTIRQ1_CODE           (34)  /*edge*/
...
#define IRQ_SW_LISR3_CODE         (41)
#define IRQ_UART1_CODE            (42)  /* md_uart_irq_b */
#define IRQ_TDD_WAKEUP_CODE       (43)  /* new */
#define IRQ_EIT_CODE              (44)
#define IRQ_SW_LISR4_CODE         (45)
#define IRQ_MDMCU_PMU_CODE        (46)
#define IRQ_MALMO_ADOE_CODE       (47)
#define IRQ_SW_LISR5_CODE         (48)
#define IRQ_SW_LISR6_CODE         (49)
#define IRQ_SW_LISR7_CODE         (50)
#define IRQ_SW_LISR8_CODE         (51)
#define IRQ_SW_LISR9_CODE         (52)
...
#define IRQ_SW_LISR10_CODE        (63)
#define IRQ_PMIC_WRAP_ERR_CODE    (64)  
#define IRQ_USB_CODE              (65)  /* usb_mcu_int_b_0p */
#define IRQ_IC_USB1_CODE          (66)  /* usb_mcu_int_b_1p */
#define IRQ_AP_DMA_HIF_CODE       (67)  /* 1'b1 */
#define IRQ_AP_DMA_I2C1_CODE      (68)  /* 1'b1 */
#define IRQ_SW_LISR11_CODE        (69)  /* 1'b1 */
#define IRQ_NFI_CODE              (70)
#define IRQ_NFIECC_CODE           (71)
#define IRQ_HIF_1_CODE            (72)
#define IRQ_MSDC0_CODE            (73)  
#define IRQ_MSDC1_CODE            (74)  
#define IRQ_MSDC2_CODE            (75)  
#define IRQ_SW_LISR12_CODE        (76)  
#define IRQ_SW_LISR13_CODE        (77)  
#define IRQ_CCIF_CODE             (78)
#define IRQ_CCIF_EVENT_CODE       (79)  /*edge*/
...
#define IRQF_CODE           IRQ_TDD_WAKEUP_CODE 
...
#define IRQ18_CODE          IRQ_TDD_CODE        
...
#define IRQ1D_CODE          IRQ_SW_LISR4_CODE
...
#define IRQ1B_CODE          IRQ_SW_LISR4_CODE
#define IRQ1C_CODE          IRQ_RTR_FRAME_CODE
...
#define IRQ21_CODE          IRQ_TDD_CODE
...
#define IRQ2C_CODE          IRQ_SW_LISR5_CODE
#define IRQ2D_CODE          IRQ_SW_LISR6_CODE
...
#define IRQ36_CODE          IRQ_SW_LISR7_CODE
#define IRQ37_CODE          IRQ_SW_LISR8_CODE
#define IRQ38_CODE          IRQ_MDMCU_PMU_CODE
#define IRQ39_CODE          IRQ_MALMO_ADOE_CODE
#define IRQ3A_CODE          IRQ_SW_LISR9_CODE
#define IRQ3B_CODE          IRQ_SW_LISR10_CODE
#define IRQ3C_CODE          IRQ_CTI_CODE
#define IRQ3D_CODE          IRQ_LOG3G_CODE
#define IRQ3E_CODE          IRQ_SW_LISR11_CODE
#define IRQ3F_CODE          IRQ_SW_LISR12_CODE
#define IRQ40_CODE          IRQ_PMIC_WRAP_ERR_CODE
#define IRQ41_CODE          IRQ_USB_CODE
#define IRQ42_CODE          IRQ_IC_USB1_CODE
#define IRQ43_CODE          IRQ_SW_LISR13_CODE
#define IRQ44_CODE          IRQ_BT_CVSD_CODE 
#define IRQ45_CODE          IRQ_MSDC0_CODE
#define IRQ46_CODE          IRQ_MSDC1_CODE
#define IRQ47_CODE          IRQ_MSDC2_CODE
#define IRQ48_CODE          IRQ_AP_DMA_HIF_CODE 
#define IRQ49_CODE          IRQ_COMMRX_CODE 
#define IRQ4A_CODE          IRQ_NFIECC_CODE
#define IRQ4B_CODE          IRQ_NFI_CODE
#define IRQ4C_CODE          IRQ_PFC_DECODE_CODE 
#define IRQ4D_CODE          IRQ_PFC_ENCODE_CODE 
#define IRQ4E_CODE          IRQ_AP_DMA_I2C1_CODE 
#define IRQ4F_CODE          IRQ_HIF_1_CODE 
...
enum Irq_Code_Def_Enum
{
    ...
    Enum_IRQ_TDD_WAKEUP_CODE  =0xF,
    Enum_IRQ_CINT_0_CODE  =0x10,
    Enum_IRQ_CINT_1_CODE  =0x11,
    Enum_IRQ_CINT_2_CODE  =0x12,
    Enum_IRQ_CINT_3_CODE  =0x13,
    Enum_IRQ_CINT_4_CODE  =0x14,
    Enum_IRQ_CINT_5_CODE  =0x15,
    Enum_IRQ_CINT_6_CODE  =0x16,
    Enum_IRQ_CINT_7_CODE  =0x17,
	#if defined(__AST_TL1_TDD__)
	Enum_IRQ_TDD_DATAIN_CODE  =0x18,
    Enum_IRQ_TL1_SW_CODE   =0x19,
    Enum_IRQ_HIF_SW_CODE   =0x1A,
    Enum_IRQ_SISR3_CODE   =0x1B,
	#else
	Enum_IRQ_SISR2_CODE   =0x18,
    Enum_IRQ_SISR1_CODE   =0x19,
    Enum_IRQ_SISR3_CODE   =0x1A,
	#endif
    Enum_IRQ_Code_End
};


#endif /* __INTRCTRL_MT6580_H__ */
