...
#ifndef __INTRCTRL_MT6582_H__
#define __INTRCTRL_MT6582_H__
...
#define IRQ_SW_LISR2_CODE         (2)  
#define IRQ_WDT_CODE              (3)
#define IRQ_SW_LISR3_CODE		  (4)
...
#define IRQ_SW_LISR4_CODE         (41)
#define IRQ_UART1_CODE            (42)
#define IRQ_TDD_WAKEUP_CODE       (43)  /* new */
#define IRQ_EIT_CODE              (44)
#define IRQ_SW_LISR5_CODE         (45)
#define IRQ_MDMCU_PMU_CODE        (46)
#define IRQ_MALMO_ADOE_CODE       (47)
#define IRQ_SW_LISR6_CODE         (48)
#define IRQ_SW_LISR7_CODE         (49)
#define IRQ_SW_LISR8_CODE         (50)
#define IRQ_SW_LISR9_CODE        (51)
#define IRQ_SW_LISR10_CODE        (52)
...
#define IRQ_AP_DMA_I2C0_CODE      (69)  /* 1'b1 */
...
#define IRQ_MSDC3_CODE            (76)  
#define IRQ_MSDC4_CODE            (77)  
#define IRQ_CCIF_CODE             (78)
#define IRQ_CCIF_EVENT_CODE       (79)  
...
#define IRQ1E_CODE          IRQ_SW_LISR4_CODE
...
#define IRQ4C_CODE          IRQ_PFC_DECODE_CODE //1'b1
#define IRQ4D_CODE          IRQ_PFC_ENCODE_CODE //1'b1
#define IRQ4E_CODE          IRQ_AP_DMA_I2C1_CODE //1'b1
