...
#ifndef __INTRCTRL_MT6583_H__
#define __INTRCTRL_MT6583_H__
...
#define EINT_STATUS            ((volatile UINT32P)(CIRQ_base+0x0300))
#define EINT_INTACK            ((volatile UINT32P)(CIRQ_base+0x0308))
#define EINT_EEVT              ((volatile UINT32P)(CIRQ_base+0x0310))

#define EINT_MASK              ((volatile UINT32P)(CIRQ_base+0x0318))
#define EINT_MASK_SET          ((volatile UINT32P)(CIRQ_base+0x0320))
#define EINT_MASK_CLR          ((volatile UINT32P)(CIRQ_base+0x0328))

#define EINT_SENS              ((volatile UINT32P)(CIRQ_base+0x0330))
#define EINT_SENS_SET          ((volatile UINT32P)(CIRQ_base+0x0338))
#define EINT_SENS_CLR          ((volatile UINT32P)(CIRQ_base+0x0340))

#define EINT_SOFT              ((volatile UINT32P)(CIRQ_base+0x0348))
#define EINT_SOFT_SET          ((volatile UINT32P)(CIRQ_base+0x0350))
#define EINT_SOFT_CLR          ((volatile UINT32P)(CIRQ_base+0x0358))

#define EINT_D0EN              ((volatile UINT32P)(CIRQ_base+0x0360)) 

#define EINT0_CON              ((volatile UINT32P)(CIRQ_base+0x0380))
#define EINT1_CON              ((volatile UINT32P)(CIRQ_base+0x0384))
#define EINT2_CON              ((volatile UINT32P)(CIRQ_base+0x0388))
#define EINT3_CON              ((volatile UINT32P)(CIRQ_base+0x038C))
#define EINT4_CON              ((volatile UINT32P)(CIRQ_base+0x0390))
#define EINT5_CON              ((volatile UINT32P)(CIRQ_base+0x0394))         
#define EINT6_CON              ((volatile UINT32P)(CIRQ_base+0x0398))         
#define EINT7_CON              ((volatile UINT32P)(CIRQ_base+0x039C))         
...
#define IRQ_SW_LISR2_CODE         (1) 
#define IRQ_SW_LISR3_CODE         (2) 
#define IRQ_WDT_CODE              (3)
#define IRQ_RXADC_OVLD_ANT1_CODE  (4)  /* new */
#define IRQ_RXADC_OVLD_ANT0_CODE  (5)  /* new */
#define IRQ_OSTIMER_ARM_CODE      (6) 
#define IRQ_GPT_CODE              (7) 
#define IRQ_TOPSM_CODE            (8) 
#define IRQ_RXBRP_HS_CODE         (9)  /* new */
...
#define IRQ_F8F9_CODE             (18)  /* uea_uia_irq */
#define IRQ_HSDPA_BC_CODE         (19)
#define IRQ_L2DPA_CODE            (20)
#define IRQ_L2UPA_CODE            (21)
#define IRQ_TXUPC_DSP_CODE        (22)
#define IRQ_BITCP_CODE            (23)
#define IRQ_IRDEBUG_CODE          (24)
#define IRQ_DSP2CPU_CODE          (25)  /* share_d12mint_b */
#define IRQ_SW_LISR4_CODE         (26)
#define IRQ_SW_LISR5_CODE         (27)
...
#define IRQ_SIM2_CODE             (37)  /* sim1_irq_b */
#define IRQ_SIM_CODE              (38)  /* sim0_irq_b */
#define IRQ_DMA_FIQ_CODE          (39)
#define IRQ_DMA_CODE              (40)
#define IRQ_SW_LISR6_CODE         (41)
#define IRQ_UART1_CODE            (42)
#define IRQ_SW_LISR7_CODE         (43)
#define IRQ_EIT_CODE              (44)
#define IRQ_SW_LISR8_CODE         (45)
#define IRQ_MDMCU_PMU_CODE        (46)
#define IRQ_MALMO_ADOE_CODE       (47)
#define IRQ_SW_LISR9_CODE         (48)
#define IRQ_SW_LISR10_CODE        (49)
#define IRQ_SW_LISR11_CODE        (50)
#define IRQ_SW_LISR12_CODE        (51)  /* new */
#define IRQ_SW_LISR13_CODE        (52)  /* new */
#define IRQ_CTI_CODE              (53)   /* CTITRIGOUT_2_IRQ_B */
#define IRQ_LOG3G_CODE            (54)   /* log3g_buf_irq_b */
#define IRQ_CINT_0_CODE           (55)
#define IRQ_CINT_1_CODE           (56)
#define IRQ_CINT_2_CODE           (57)  /* new */
#define IRQ_CINT_3_CODE           (58)  /* new */
#define IRQ_CINT_4_CODE           (59)  /* new */
#define IRQ_CINT_5_CODE           (60)  /* new */
#define IRQ_CINT_6_CODE           (61)  /* new */
#define IRQ_CINT_7_CODE           (62)  /* new */
#define IRQ_SW_LISR14_CODE        (63)  /* new */
#define IRQ_PMIC_WRAP_ERR_CODE    (64)  /* new */
#define IRQ_USB_CODE              (65)  /* new */
#define IRQ_IC_USB1_CODE          (66)  /* new */
#define IRQ_AP_DMA_HIF1_CODE      (67)  /* new */
#define IRQ_AP_DMA_HIF0_CODE      (68)  /* new */
#define IRQ_SW_LISR15_CODE        (69)  /* new */
#define IRQ_NFI_CODE              (70)
#define IRQ_NFIECC_CODE           (71)
#define IRQ_HIF_1_CODE            (72)
#define IRQ_MSDC0_CODE            (73)  /* new */
#define IRQ_MSDC1_CODE            (74)  /* new */
#define IRQ_MSDC2_CODE            (75)  /* new */
#define IRQ_MSDC3_CODE            (76)  /* new */
#define IRQ_MSDC4_CODE            (77)  /* new */
#define IRQ_CCIF_CODE             (78)
#define IRQ_CCIF_EVENT_CODE       (79)  /* new */
...
#define IRQ10_CODE          IRQ_CINT_0_CODE
#define IRQ11_CODE          IRQ_CINT_1_CODE
#define IRQ12_CODE          IRQ_CINT_2_CODE
#define IRQ13_CODE          IRQ_CINT_3_CODE
#define IRQ14_CODE          IRQ_CINT_4_CODE
#define IRQ15_CODE          IRQ_CINT_5_CODE
#define IRQ16_CODE          IRQ_CINT_6_CODE
#define IRQ17_CODE          IRQ_CINT_7_CODE
#define IRQ18_CODE          IRQ_SW_LISR2_CODE
#define IRQ19_CODE          IRQ_SW_LISR1_CODE
#define IRQ1A_CODE          IRQ_SW_LISR3_CODE
#define IRQ1B_CODE          IRQ_TPC_CODE
#define IRQ1C_CODE          IRQ_RTR_FRAME_CODE
#define IRQ1D_CODE          IRQ_TOPSM_CODE
#define IRQ1E_CODE          IRQ_OSTIMER_ARM_CODE
#define IRQ1F_CODE          IRQ_CCIF_CODE
#define IRQ20_CODE          IRQ_CTIRQ3_CODE
#define IRQ21_CODE          IRQ_HIF_1_CODE
#define IRQ22_CODE          IRQ_WDT_CODE
#define IRQ23_CODE          IRQ_GPT_CODE
#define IRQ24_CODE          IRQ_F8F9_CODE
#define IRQ25_CODE          IRQ_HSDPA_BC_CODE
#define IRQ26_CODE          IRQ_L2DPA_CODE
#define IRQ27_CODE          IRQ_L2UPA_CODE
#define IRQ28_CODE          IRQ_TXUPC_DSP_CODE
#define IRQ29_CODE          IRQ_BITCP_CODE
#define IRQ2A_CODE          IRQ_IRDEBUG_CODE
#define IRQ2B_CODE          IRQ_DSP2CPU_CODE
#define IRQ2C_CODE          IRQ_SW_LISR4_CODE
#define IRQ2D_CODE          IRQ_SW_LISR5_CODE
#define IRQ2E_CODE          IRQ_MD_SLEEP_CODE
#define IRQ2F_CODE          IRQ_SIM2_CODE
#define IRQ30_CODE          IRQ_SIM_CODE
#define IRQ31_CODE          IRQ_DMA_FIQ_CODE
#define IRQ32_CODE          IRQ_DMA_CODE
#define IRQ33_CODE          IRQ_UART1_CODE
#define IRQ34_CODE          IRQ_CCIF_EVENT_CODE
#define IRQ35_CODE          IRQ_EIT_CODE
#define IRQ36_CODE          IRQ_SW_LISR6_CODE
#define IRQ37_CODE          IRQ_SW_LISR7_CODE
#define IRQ38_CODE          IRQ_MDMCU_PMU_CODE
#define IRQ39_CODE          IRQ_MALMO_ADOE_CODE
#define IRQ3A_CODE          IRQ_SW_LISR8_CODE
#define IRQ3B_CODE          IRQ_SW_LISR9_CODE
#define IRQ3C_CODE          IRQ_CTI_CODE
#define IRQ3D_CODE          IRQ_LOG3G_CODE
#define IRQ3E_CODE          IRQ_SW_LISR10_CODE
#define IRQ3F_CODE          IRQ_SW_LISR11_CODE
#define IRQ40_CODE          IRQ_PMIC_WRAP_ERR_CODE
#define IRQ41_CODE          IRQ_USB_CODE
#define IRQ42_CODE          IRQ_IC_USB1_CODE
#define IRQ43_CODE          IRQ_SW_LISR12_CODE
#define IRQ44_CODE          IRQ_SW_LISR13_CODE
#define IRQ45_CODE          IRQ_MSDC0_CODE
#define IRQ46_CODE          IRQ_MSDC1_CODE
#define IRQ47_CODE          IRQ_MSDC2_CODE
#define IRQ48_CODE          IRQ_MSDC3_CODE
#define IRQ49_CODE          IRQ_MSDC4_CODE
#define IRQ4A_CODE          IRQ_NFIECC_CODE
#define IRQ4B_CODE          IRQ_NFI_CODE
#define IRQ4C_CODE          IRQ_AP_DMA_HIF1_CODE
#define IRQ4D_CODE          IRQ_AP_DMA_HIF0_CODE
#define IRQ4E_CODE          IRQ_SW_LISR14_CODE
#define IRQ4F_CODE          IRQ_SW_LISR15_CODE
...
#define IRQ_SW_LISR3_CODE         (2) 
#define IRQ_WDT_CODE              (3)
#define IRQ_SW_LISR4_CODE         (4)
#define IRQ_SW_LISR5_CODE         (5)
#define IRQ_OSTIMER_ARM_CODE      (6) 
#define IRQ_GPT_CODE              (7) 
#define IRQ_TOPSM_CODE            (8) 
#define IRQ_SW_LISR6_CODE         (9)
#define IRQ_SW_LISR7_CODE         (10)
#define IRQ_SW_LISR8_CODE         (11)
#define IRQ_SW_LISR9_CODE         (12)
#define IRQ_SW_LISR10_CODE        (13)
#define IRQ_SW_LISR11_CODE        (14)
#define IRQ_SW_LISR12_CODE        (15)
#define IRQ_SW_LISR13_CODE        (16)
#define IRQ_SW_LISR14_CODE        (17)
#define IRQ_SW_LISR15_CODE        (18)
#define IRQ_SW_LISR16_CODE        (19)
#define IRQ_SW_LISR17_CODE        (20)
#define IRQ_SW_LISR18_CODE        (21)
#define IRQ_SW_LISR19_CODE        (22)
#define IRQ_SW_LISR20_CODE        (23)
#define IRQ_IRDEBUG_CODE          (24)
#define IRQ_DSP2CPU_CODE          (25)  /* share_d12mint_b */
#define IRQ_SW_LISR21_CODE        (26)
#define IRQ_SW_LISR22_CODE        (27)
#define IRQ_SW_LISR23_CODE        (28)
#define IRQ_SW_LISR24_CODE        (29)
#define IRQ_SW_LISR25_CODE        (30)
#define IRQ_MD_SLEEP_CODE         (31)  /* slp_ctrl_irq_b */
#define IRQ_CTIRQ3_CODE           (32)
#define IRQ_CTIRQ2_CODE           (33)
#define IRQ_CTIRQ1_CODE           (34)
#define IRQ_SW_LISR26_CODE        (35)
#define IRQ_TDMA_CODE             (36)
#define IRQ_SIM2_CODE             (37)  /* sim1_irq_b */
#define IRQ_SIM_CODE              (38)  /* sim0_irq_b */
#define IRQ_DMA_FIQ_CODE          (39)
#define IRQ_DMA_CODE              (40)
#define IRQ_SW_LISR27_CODE        (41)
#define IRQ_UART1_CODE            (42)
#define IRQ_SW_LISR28_CODE        (43)
#define IRQ_EIT_CODE              (44)
#define IRQ_SW_LISR29_CODE        (45)
#define IRQ_SW_LISR30_CODE        (46)
#define IRQ_SW_LISR31_CODE        (47)
#define IRQ_SW_LISR32_CODE        (48)
#define IRQ_SW_LISR33_CODE        (49)
#define IRQ_SW_LISR34_CODE        (50)
#define IRQ_SW_LISR35_CODE        (51)
#define IRQ_SW_LISR36_CODE        (52)
#define IRQ_CTI_CODE              (53)   /* CTITRIGOUT_2_IRQ_B */
#define IRQ_SW_LISR37_CODE        (54)
#define IRQ_CINT_0_CODE           (55)
#define IRQ_CINT_1_CODE           (56)
#define IRQ_CINT_2_CODE           (57)
#define IRQ_CINT_3_CODE           (58)
#define IRQ_CINT_4_CODE           (59)
#define IRQ_CINT_5_CODE           (60)
#define IRQ_CINT_6_CODE           (61)
#define IRQ_CINT_7_CODE           (62)
#define IRQ_SW_LISR38_CODE        (63)
#define IRQ_PMIC_WRAP_ERR_CODE    (64)  /* new */
#define IRQ_USB_CODE              (65)  /* new */
#define IRQ_IC_USB1_CODE          (66)  /* new */
#define IRQ_AP_DMA_HIF1_CODE      (67)  /* new */
#define IRQ_AP_DMA_HIF0_CODE      (68)  /* new */
#define IRQ_SW_LISR39_CODE        (69)
#define IRQ_NFI_CODE              (70)
#define IRQ_NFIECC_CODE           (71)
#define IRQ_HIF_1_CODE            (72)
#define IRQ_MSDC0_CODE            (73)  /* new */
 ...
 * IRQ Selection Register mapping
 */   
#define IRQ0_CODE           IRQ_SW_LISR16_CODE
#define IRQ1_CODE           IRQ_SW_LISR17_CODE
#define IRQ2_CODE           IRQ_SW_LISR18_CODE
#define IRQ3_CODE           IRQ_SW_LISR19_CODE
#define IRQ4_CODE           IRQ_SW_LISR20_CODE
#define IRQ5_CODE           IRQ_SW_LISR21_CODE
#define IRQ6_CODE           IRQ_SW_LISR22_CODE
#define IRQ7_CODE           IRQ_SW_LISR23_CODE
#define IRQ8_CODE           IRQ_SW_LISR24_CODE
#define IRQ9_CODE           IRQ_SW_LISR25_CODE
#define IRQA_CODE           IRQ_TDMA_CODE
#define IRQB_CODE           IRQ_CTIRQ1_CODE
#define IRQC_CODE           IRQ_CTIRQ2_CODE
#define IRQD_CODE           IRQ_SW_LISR26_CODE
#define IRQE_CODE           IRQ_SW_LISR27_CODE
#define IRQF_CODE           IRQ_SW_LISR28_CODE
#define IRQ10_CODE          IRQ_CINT_0_CODE
#define IRQ11_CODE          IRQ_CINT_1_CODE
#define IRQ12_CODE          IRQ_CINT_2_CODE
#define IRQ13_CODE          IRQ_CINT_3_CODE
...
#define IRQ18_CODE          IRQ_HIF_1_CODE
#define IRQ19_CODE          IRQ_SW_LISR1_CODE
#define IRQ1A_CODE          IRQ_SW_LISR2_CODE
#define IRQ1B_CODE          IRQ_SW_LISR3_CODE
#define IRQ1C_CODE          IRQ_SW_LISR29_CODE
#define IRQ1D_CODE          IRQ_SW_LISR30_CODE
...
#define IRQ19_CODE          IRQ_SW_LISR1_CODE
#define IRQ1A_CODE          IRQ_SW_LISR3_CODE
#define IRQ1B_CODE          IRQ_SW_LISR29_CODE
#define IRQ1C_CODE          IRQ_SW_LISR30_CODE
#define IRQ1D_CODE          IRQ_TOPSM_CODE
#define IRQ1E_CODE          IRQ_OSTIMER_ARM_CODE
#define IRQ1F_CODE          IRQ_CCIF_CODE
#define IRQ20_CODE          IRQ_CTIRQ3_CODE
...
#define IRQ22_CODE          IRQ_WDT_CODE
#define IRQ23_CODE          IRQ_GPT_CODE
#define IRQ24_CODE          IRQ_SW_LISR31_CODE
#define IRQ25_CODE          IRQ_SW_LISR32_CODE
#define IRQ26_CODE          IRQ_SW_LISR33_CODE
#define IRQ27_CODE          IRQ_SW_LISR34_CODE
#define IRQ28_CODE          IRQ_SW_LISR35_CODE
#define IRQ29_CODE          IRQ_SW_LISR36_CODE
#define IRQ2A_CODE          IRQ_IRDEBUG_CODE
#define IRQ2B_CODE          IRQ_DSP2CPU_CODE
#define IRQ2C_CODE          IRQ_SW_LISR4_CODE
#define IRQ2D_CODE          IRQ_SW_LISR5_CODE
...
#define IRQ36_CODE          IRQ_SW_LISR6_CODE
#define IRQ37_CODE          IRQ_SW_LISR7_CODE
#define IRQ38_CODE          IRQ_SW_LISR37_CODE
#define IRQ39_CODE          IRQ_SW_LISR38_CODE
#define IRQ3A_CODE          IRQ_SW_LISR8_CODE
#define IRQ3B_CODE          IRQ_SW_LISR9_CODE
#define IRQ3C_CODE          IRQ_CTI_CODE
#define IRQ3D_CODE          IRQ_SW_LISR39_CODE
#define IRQ3E_CODE          IRQ_SW_LISR10_CODE
#define IRQ3F_CODE          IRQ_SW_LISR11_CODE
#define IRQ40_CODE          IRQ_PMIC_WRAP_ERR_CODE
#define IRQ41_CODE          IRQ_USB_CODE
...
#define  EINT_HARDWARE_DEBOUNCE      0x000000ff
...
#define __EINT_MD_DOMAIN_0__

#define __CEINT_IRQ_NEW__
#define CEINT_NUMBER  8
extern const kal_uint8 CEINT2CIRQCode[];
#define CEINT_2_CIRQCODE(ceint_no)  (CEINT2CIRQCode[(ceint_no)])
#define CEINT_CODE_TABLE \
...
enum Irq_Code_Def_Enum
{
    ...
    Enum_IRQ_RXBRPHS_CODE=0xA,
    Enum_IRQ_TDMA_CODE   =0xB,
    Enum_IRQ_CTIRQ1_CODE =0xC,
    Enum_IRQ_CTIRQ2_CODE =0xD,
#if defined(__AST_TL1_TDD__)
    Enum_IRQ_CINT_0_CODE =0xE,
    Enum_IRQ_CINT_1_CODE =0xF,
    Enum_IRQ_CINT_2_CODE =0x10,
    Enum_IRQ_AST_DA_CODE =0x11,    /* CINT_3 */
    Enum_IRQ_CINT_4_CODE =0x12,
    Enum_IRQ_CINT_5_CODE =0x13,
    Enum_IRQ_CINT_6_CODE =0x14,
    Enum_IRQ_CINT_7_CODE =0x15,
    ...
    Enum_IRQ_CINT_1_CODE =0xF,
    Enum_IRQ_CINT_2_CODE =0x10,
    Enum_IRQ_CINT_3_CODE =0x11,
    Enum_IRQ_CINT_4_CODE =0x12,
    Enum_IRQ_CINT_5_CODE =0x13,
    Enum_IRQ_CINT_6_CODE =0x14,
    Enum_IRQ_CINT_7_CODE =0x15,
    Enum_IRQ_SISR2_CODE  =0x16,
    Enum_IRQ_SISR1_CODE  =0x17,
    Enum_IRQ_SISR3_CODE  =0x18,
#endif  /* defined(__AST_TL1_TDD__) */
    Enum_IRQ_Code_End
};
