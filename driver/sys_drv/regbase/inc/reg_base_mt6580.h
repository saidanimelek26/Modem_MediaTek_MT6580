...
#ifndef __REG_base_MT6580_H__
#define __REG_base_MT6580_H__

/********************************************
 * MT6580 MD Strongly Ordered Peripheral Base
 ********************************************/
 //MD PSYS APB
...
/********************************************
 * MT6571 MD Device Type Peripheral Base
 ********************************************/
 //MD PSYS APB
...
/********************************************
 * MT6580 AP Peripheral Register Base
 ********************************************/
 
/// AP Infrastructure, Mixmode & MCU System

/// AP Infrastructure MCU System
#define AP_EMI_base               (0xA0205000)  //EMI Bus Interface
#define EMI_base                  (AP_EMI_base) //EMI Bus Interface
#define AP_TOP_CLOCK_CTRL_BASE    (0xA0000000)  //Top-level Clock Generator //Request by Anderson Tasi
#define AP_TOPRGU_BASE            (0xA0007000)  //Top-level Reset Generator //Request by Anderson Tasi
#define AP_GPIO_base              (0xA0005000)  //GPIO Controller //Request by Dongming Li
#define AP_PMIC_WRAP_BASE         (0xA000F000)  //PMIC_WRAP Control Register //Request by Anderson Tasi
#define EFUSEC_BASE               (0xA0009000)  //Request by RaymondWT Chen
#define EFUSE_base                (EFUSEC_BASE) //Request by RaymondWT Chen


/// AP Peripheral system
#define AP_AUDSYS_base            (0xA1140000)  //Audio AHB slave //Request by Sheila Chen
#define USB_base                  (0xA1100000)  //USB2.0 --> requested by Arvin wang
#define AP_USBSIF_base            (0xA1110000)  //USBSIF
#define USBSIF_base               (AP_USBSIF_base)//USBSIF --> requested by Arvin Wang

#define BTSRAM_base               (0xA8080000)  //BT SCO SW codec interface // Requested by Scholar Chang
#define BTPKT_base                (0xA8000000)  //BT SCO SW codec interface // Requested by Scholar Chang

///Infrastructure MCU System

#endif  /* __REG_base_MT6580_H__ */
