...
#ifndef _DMA_CONFIG_MT6592_H
#define _DMA_CONFIG_MT6592_H
...
/*VFIFO channel info*/
#if defined (__BTMODULE_MT6572__) || defined (__BTMODULE_MT6592__)
...
/******************************AP side***************************************************/ 
#if defined(__DMA2_SUPPORT__) //MT6592 doesn't using AP DMA, the same as MT6582.
/*GDMA & PDMA channel info*/
//doesn't use AP DMA
