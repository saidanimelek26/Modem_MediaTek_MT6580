...
#ifndef _DMA_CONFIG_MT6280_H
#define _DMA_CONFIG_MT6280_H

#define __DMA_API_V2__ 					//DMA SW version
#define __DMA_V3__ 						//DMA HW version
#define __MULTI_CORE_SHARED_DMA__  		//smartphone(MT6575+MT6280), hosted Dongle
...
#define DMA_MAX_CHANNEL          2  	//used DMA channel number
#define DMA_MAX_FULL_CHANNEL     2  	//GDMA channel number
#define DMA_FULL_CH_NUM     	 2		//for MD-side GDMA1 and GDMA2
#define DMA_HALF_CH_NUM     	 2		//we don't have peripheral DMA
#define DMA_VFF_CH_NUM      	 2		//for MD-side UART1 TX, UART1 RX, UART2 TX, UART2 RX

/*VFIFO channel info*/
#if defined (__BTMODULE_MT6280__)
...
/*GDMA & PDMA channel info*/
#define DMA2_ALL_CHANNEL         6
#define DMA2_MAX_CHANNEL         4
#define DMA2_MAX_FULL_CHANNEL    0
...
/*for DMA interrupt mode*/
#define DMA2_IRQ_CODE           	IRQ_AP_DMA_CODE  ///only uncommented this line when DMA2 also needs LISR handler; otherwise DMA2 irq is handled by HISR.

/*for DMA CG control*/
#define DMA2_POWER_ON()         	do { *(volatile kal_uint32*)(AP_CONFIG_base + 0x00000008) = (1<<8); } while(0)
#define DMA2_SLEEP_ENABLE()     	do { *(volatile kal_uint32*)(AP_CONFIG_base + 0x00000004) = (1<<8); } while(0)
#define DMA2_SLEEP_DISABLE()    	do { *(volatile kal_uint32*)(AP_CONFIG_base + 0x00000008) = (1<<8); } while(0)
