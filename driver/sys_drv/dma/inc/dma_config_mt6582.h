...
#ifndef _DMA_CONFIG_MT6582_H
#define _DMA_CONFIG_MT6582_H
...
/*VFIFO channel info*/
#if defined (__BTMODULE_MT6572__)
...
/******************************AP side***************************************************/ 
#if defined(__DMA2_SUPPORT__) //MT6582 doesn't using AP DMA
/*GDMA & PDMA channel info*/
//doesn't use AP DMA
