...
#ifndef _DMA_CONFIG_MT6580_H
#define _DMA_CONFIG_MT6580_H
...
//#define __DMA2_SUPPORT__      			/* not use AP side DMA */

#define __DMA_LOW_POWER__
#define __DMA_DEBUG_TRACE__
...
/*VFIFO channel info*/
#if defined (__BTMODULE_MT6572__) || defined (__BTMODULE_MT6571__) || defined (__BTMODULE_MT6580__)
...
#define DMA_SUPPORT_TX_FLUSH_HW_GUARANTEE     //MT6571&MT6580 add VFF flush hw guarantee.
...
/******************************AP side***************************************************/ 
#if defined(__DMA2_SUPPORT__) //MT6571&MT6580 doesn't using AP DMA
/*GDMA & PDMA channel info*/
//doesn't use AP DMA
