...
#ifndef _DMA_CONFIG_MT6571_H
#define _DMA_CONFIG_MT6571_H
...
/*VFIFO channel info*/
#if defined (__BTMODULE_MT6572__) || defined (__BTMODULE_MT6571__)
...
#define DMA_SUPPORT_TX_FLUSH_HW_GUARANTEE     //MT6571 add VFF flush hw guarantee.
...
/******************************AP side***************************************************/ 
#if defined(__DMA2_SUPPORT__) //MT6571 doesn't using AP DMA
/*GDMA & PDMA channel info*/
//doesn't use AP DMA
