...
#define   MAUI_FC_AP_BOOTUP_BY_MDBL   0x1000
...
#define AP_BOOTUP_BY_MDBL_SWITCH      MAUI_FC_AP_BOOTUP_BY_MDBL
#else
#define AP_BOOTUP_BY_MDBL_SWITCH      0
#endif


#define FEATURE_COMBINATION           (SECURE_SWITCH | FOTA_SWITCH | NOR_FLASH_BOOTING_SWITCH | USBDL_SWITCH | SW_ROOT_KEY_IN_BL_SWITCH | MBA_SWITCH | SYSDRV_ON_NAND_SWITCH | SECURE_RO_ENABLE_SWITCH | USBDL_IN_BOOTROM_SWITCH | EXT_BL_UPDATE_SWITCH | SPLIT_BIN_SUPPORT_SWITCH | FAST_LOGO_SWITCH | AP_BOOTUP_BY_MDBL_SWITCH)
