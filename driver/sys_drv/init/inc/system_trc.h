...
BEGIN_TRACE_MAP(MOD_SYSTEM)
    ...
    /* HWDInitialization */
    TRC_MSG(SST_INIT_HWDINIT_ENTER, "Starting HW driver init")
        TRC_MSG(SST_INIT_CHIPREG_ENTER, "Enter Chip Register init setting")
        TRC_MSG(SST_INIT_CHIPREG_EXIT, "Exit Chip Register init setting ... [ duration: %d ms ]")
        TRC_MSG(SST_INIT_BUS_ENTER, "Enter Bus driver init")
        TRC_MSG(SST_INIT_BUS_EXIT, "Exit Bus driver init ... [ duration: %d ms ]")
        TRC_MSG(SST_INIT_USC_ENTER, "Enter ARM us counter init")
        TRC_MSG(SST_INIT_UL1DSRAMREPAIR_ENTER, "Enter HSPA sram repair")
        TRC_MSG(SST_INIT_UL1DSRAMREPAIR_EXIT, "Exit HSPA sram repair ... [ duration: %d ms ]")
        TRC_MSG(SST_INIT_TL1SRAMREPAIR_ENTER, "Enter TDD sram repair")
        TRC_MSG(SST_INIT_TL1SRAMREPAIR_EXIT, "Exit TDD sram repair ... [ duration: %d ms ]")
        TRC_MSG(SST_INIT_USC_EXIT, "Exit ARM us counter init ... [ duration: %d ms ]")
        TRC_MSG(SST_INIT_RM_ENTER, "Enter Resource Manager init")
        TRC_MSG(SST_INIT_RM_EXIT, "Exit Resource Manager init ... [ duration: %d ms ]")
    ...
    TRC_MSG(SST_INIT_HWDINIT_EXIT, "HW driver init ... [ OK ]")

    /* Driver Init Phase 1 */
    TRC_MSG(SST_INIT_DRV1_ENTER, "Starting driver init phase1")
    ...
    TRC_MSG(SST_INIT_DRV1_EXIT, "Driver init phase1 ... [ OK ]")
    ...
    /* Driver Init Phase 2 */
    TRC_MSG(SST_INIT_DRV2_ENTER, "Starting driver init phase2")
    ...
    TRC_MSG(SST_INIT_DRV2_EXIT, "Driver init phase2 ... [ OK ]")
    ...
    TRC_MSG(SST_INIT_GETRANDOMSEED_AP_ENTER, "Get random seed from AP-side through CCCI")
    TRC_MSG(SST_INIT_GETRANDOMSEED_INTRAM_ENTER, "Get random seed from internal RAM")
...
#if defined (MT6589) || defined (MT6572) || defined (MT6582) || defined (MT6571) || defined (MT6592)
    TRC_MSG(DCM_TOP_LPM_CON, "[DCM] TOP LPM_CON:%x")
    TRC_MSG(DCM_TOP_LPM_STATUS, "[DCM] TOP LPM_TTL_TIME/L2H/HIDUR:%x, %x, %x")
    TRC_MSG(DCM_INFRA_LPM_CON, "[DCM] INFRA LPM_CON:%x")
    TRC_MSG(DCM_INFRA_LPM_STATUS, "[DCM] INFRA LPM_TTL_TIME/L2H/HIDUR:%x, %x, %x")
#endif
