...
void INT_Version_Check(void)
{
    ...
    BuildCode = 0x6582;
#elif defined(MT6589)
    BuildCode = 0x6583;      // MT6589 has HW_CODE 0x6583
#elif defined(MT6571)
    BuildCode = 0x6571;
#elif defined(MT6580)
#if defined(MT6570)
...
#elif defined(MT6582)
    return    MT6582_latest_chip;

#elif defined(MT6589)
    return    MT6589_latest_chip;

#elif defined(MT6571)
    return    MT6571_latest_chip;

#elif defined(MT6580)
    return    MT6580_latest_chip;

#elif defined(MT6592)
    return    MT6592_latest_chip;
...
#if defined(MT6589) || defined(MT6280_S01) || defined(MT6572)
