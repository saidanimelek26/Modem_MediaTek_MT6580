 ...
 * Description:
 * ------------
 *   Custom MPU region setting for MT6582
 * -------
 *   Dot Li (mtk02439)
 *
 *============================================================================
...
X_MPU_INIT_REGION(    APSYS_APB_SO,    0xA0000000,     0x10000000,  MPU_SOM|MPU_PRW_URW,                 1                 )


/* [MT6582] Access to this address will cause bus hang. This is the last channel of MPU, for test, you can use this one. */
X_MPU_INIT_REGION(    APSYS_PROT,      0xA0130000,     0x00010000,  MPU_PN_UN,                           1                 )
