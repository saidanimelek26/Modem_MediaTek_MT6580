...
#if !defined(DRV_GPIO_OFF) || defined(DRV_GPIO_SP_ON)
...
#else //#if defined(DRV_GPIO_OFF) && defined(DRV_GPIO_SP_ON)
...
extern char GPIO_MD_ReadIO(kal_uint16 port);
extern void GPIO_MD_InitIO(kal_uint16 direction, kal_uint16 port);
...
extern void GPIO_MD_WriteIO(kal_uint16 data, kal_uint16 port);
extern void GPIO_MD_PullenSetup(kal_uint16 pin, kal_bool enable);
extern void GPIO_MD_PullSelSetup(kal_uint16 pin, kal_bool pull_up);
extern void GPIO_MD_DinvSetup(kal_uint16 pin, kal_bool enable);
