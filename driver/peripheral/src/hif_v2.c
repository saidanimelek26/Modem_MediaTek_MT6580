...
HIF_RESULT hif_power_ctrl(HIF_HANDLE handle, kal_bool bPowerOn)
{
    ...
    if (bPowerOn)
    {
        ...
        #endif
        {
            ...
            #if defined(MT6589) //MD HIF re-init MD HIF module, NLI module when power on
...
{
    kal_uint32 index = 0;
    #if !defined(__MD_HIF_AST8BIT_OPT__)  //Optiomize for MT6589+AST3001
...
*/
    ...
    #if (defined(MT6589) && !defined(__ANDROID_MODEM__))
