...
void motion_sensor_complete_cali(void)
{
   acc_execute_cali=KAL_FALSE;
   /*offset*/
   motion_sensor_data.cali.x_offset=(acc_x_plus_g_adc+ acc_x_minus_g_adc)/2;
   motion_sensor_data.cali.y_offset=(acc_y_plus_g_adc+acc_y_minus_g_adc)/2;
   motion_sensor_data.cali.z_offset=(acc_z_plus_g_adc+ acc_z_minus_g_adc)/2;
   /*gain*/
   motion_sensor_data.cali.x_gain=(acc_x_plus_g_adc-acc_x_minus_g_adc)/2;
   motion_sensor_data.cali.y_gain=(acc_y_plus_g_adc-acc_y_minus_g_adc)/2;
   motion_sensor_data.cali.z_gain=(acc_z_plus_g_adc-acc_z_minus_g_adc)/2;
