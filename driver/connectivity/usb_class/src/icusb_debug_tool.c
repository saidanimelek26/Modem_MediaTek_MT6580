 ...
 * Description:
 * ------------
 *  This file intends for usb common driver debug buffer
 *
 * Author:
 * -------
 * -------
...
/* debug trace */
void ICUSB_Dbg_Trace(ICUSB_DBG_INFO tag, kal_uint32 time, kal_uint32 data1, kal_uint32 data2)
{
//#ifdef ENABLE_USB_DEBUG_TOOL
#ifdef  __MTK_INTERNAL__
/* under construction !*/
