...
typedef struct 
{
	...
	kal_uint8    ENFbFunctionLength;    /* Ethernet Networking Functional Descriptor */
	kal_uint8	 ENFbDescriptorType;
	kal_uint8 	 ENFbDescriptorSubtype;
	kal_uint8    iMACAddress;
	kal_uint8   bmEthernetStatistics1;
	kal_uint8   bmEthernetStatistics2;	
	kal_uint8   bmEthernetStatistics3;
	kal_uint8   bmEthernetStatistics4;	
	kal_uint8   wMaxSegmentSize1;
	kal_uint8   wMaxSegmentSize2;	
	kal_uint8   wNumberMCFilters1;
	kal_uint8   wNumberMCFilters2;	
...
typedef struct
{
	...
	kal_uint16			power_filter_number;
	kal_uint16			power_filter_length;
	kal_uint16			*mac_addr_ptr;
#endif
...
extern void USB_DMAQ_Setup(kal_uint32 ep_num, USB_EP_DIRECTION direction, kal_bool first, kal_uint32 addr, usb_dmaq_CB callback, usb_dmaq_CB empty_callback,void *privdata);
extern void USB_DMAQ_Insert(kal_uint32 ep_num, USB_EP_DIRECTION direction, kal_uint32 header, kal_uint32 addr);
...
extern void USB2UART_PPPRX_DMAQ_Callback(void *pridata);
extern void USB2UART_PPPTX_DMAQ_Callback(void *pridata);
#endif


#if defined(__MBIM_SUPPORT__)||defined(__ECM_SUPPORT__)
extern void USB2UART_RX_DMAQ_Callback(void *pridata);
extern void USB2UART_TX_DMAQ_Callback(void *pridata);
extern void USB2UART_RX_DMAQ_Empty_Callback(void *pridata);
extern void USB2UART_TX_DMAQ_Empty_Callback(void *pridata);
#endif
...
#ifdef __ECM_SUPPORT__
extern void USB_ECM_CommIf_Create(void *ifname);
extern void USB_ECM_CommIf_Reset(void);
extern void USB_ECM_CommIf_Enable(void);
extern void USB_ECM_CommIf_Speed_Reset(kal_bool b_other_speed);
extern void USB_ECM_DataIf_Create(void *ifname);
extern void USB_ECM_DataIf_Reset(void);
extern void USB_ECM_DataIf_Enable(void);
extern void USB_ECM_DataIf_Speed_Reset(kal_bool b_other_speed);
extern void USB_ECM_Stop_Transfer(void);
#endif
