...
#ifdef	__USB_HS_SLEW_RATE_CAL__
#endif
#define	USB_USBPHYACR0	(USBSIF_base+0x800)	
#define	USB_USBPHYACR1	(USBSIF_base+0x804)	
#define	USB_USBPHYACR2	(USBSIF_base+0x808)	
#define	USB_USBPHYACR4	(USBSIF_base+0x810)	
#define	USB_USBPHYACR5	(USBSIF_base+0x814)	
#define	USB_USBPHYACR6	(USBSIF_base+0x818)	
#define	USB_U2PHYACR3	(USBSIF_base+0x81C)	
#define	USB_U2PHYACR4	(USBSIF_base+0x820)	
#define	USB_U2PHYAMON0	(USBSIF_base+0x824)	
#define	USB_U2PHYDCR0	(USBSIF_base+0x860)	
#define	USB_U2PHYDCR1	(USBSIF_base+0x864)	
#define	USB_U2PHYDTM0	(USBSIF_base+0x868)	
#define	USB_U2PHYDTM1	(USBSIF_base+0x86C)	
#define	USB_U2PHYDMON0	(USBSIF_base+0x870)	
#define	USB_U2PHYDMON1	(USBSIF_base+0x874)	
#define	USB_U2PHYDMON2	(USBSIF_base+0x878)	
#define	USB_U2PHYDMON3	(USBSIF_base+0x87C)	
#define	USB_REGFCOM		(USBSIF_base+0x8FC)	
#define	USB_FMCR0		(USBSIF_base+0xF00)	
#define	USB_FMCR1		(USBSIF_base+0xF04)	
#define	USB_FMCR2		(USBSIF_base+0xF08)	
#define	USB_FMMONR0		(USBSIF_base+0xF0C)	
#define	USB_FMMONR1		(USBSIF_base+0xF10)	
...
#define USB_U2PHYDTM0_RG_SUSPENDM					(1<<3)
#define USB_U2PHYDTM1_RG_UART_EN					(1<<16)
#define USB_USBPHYACR0_RG_USB20_USBPLL_FBDIV_6_0_CLR	(0x7F<<8)	//[6:0]
#define USB_USBPHYACR0_RG_USB20_USBPLL_FBDIV_6_0		(9<<8)	//[6:0]
#define USB_USBPHYACR6_RG_USB20_OTG_VBUSCMP_EN		(1<<20)
#define USB_USBPHYACR6_RG_USB20_BC11_SW_EN			(1<<23)
//#define USB_U2PHYACR4_RG_USB20_DP_100K_EN			(1<<16)
//#define USB_U2PHYACR4_RG_USB20_DM_100K_EN			(1<<17)
#define USB_U2PHYDTM0_RG_DPPULLDOWN					(1<<6)
#define USB_U2PHYDTM0_RG_DMPULLDOWN					(1<<7)
