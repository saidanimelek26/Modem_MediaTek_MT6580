...
typedef struct
{
	...
	usb_dmaq_CB			dmaq_callback[2][MAX_DMA_NUM];			/* take PP buffer */	
	usb_dmaq_CB			dmaq_empty_callback[2][MAX_DMA_NUM];			/* take PP buffer */
	void*					privdata[2][MAX_DMA_NUM];			/* take PP buffer */	
#else
