...
#endif
extern void DRV_ICC_PMU_setVolt(kal_uint32 hwInterfaceNo, usim_power_enum volt);
extern void DRV_ICC_PMU_switch(kal_uint32 hwInterfaceNo, kal_bool enable);
...
extern void SIM_RegHotPlugCb(SIM_ICC_APPLICATION application, 
...
extern void SIM_SetRXRetry(sim_HW_cb *hw_cb, kal_uint16 RXRetry);
extern void SIM_SetTXRetry(sim_HW_cb *hw_cb, kal_uint16 TXRetry);
extern void DRV_ICC_PMU_SetGPIO(kal_uint32 hwInterfaceNo, kal_uint32 addr, kal_uint16 data);
extern kal_uint16 DRV_ICC_PMU_GetGPIO(kal_uint32 hwInterfaceNo, kal_uint32 addr);
#if defined(__SIM_DRV_ENABLE_SWRST__)
extern void DRV_ICC_PMU_SetSIMRST(kal_uint32 hwInterfaceNo, kal_bool enable);
extern void DRV_ICC_PMU_setSTBMode(kal_uint32 hwInterfaceNo, kal_bool swEnable);
#endif
