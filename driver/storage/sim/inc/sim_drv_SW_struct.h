...
typedef struct{
   kal_uint32 gpio_dir_base;
   kal_uint32 gpio_dir_base_bit_offset;
   kal_uint32 gpio_mode_base;
   kal_uint32 gpio_mode_base_bit_offset;
   kal_uint32 gpio_dout_base;
   kal_uint32 gpio_dout_base_bit_offset;
   kal_uint32 gpio_ap_mode_base;
   kal_uint32 gpio_ap_mode_base_bit_offset;
}sim_PMIC_HW_cb;
...
#endif
/*
        if we wish to dump simreg/dmareg periodically, we can set this flag
*/
