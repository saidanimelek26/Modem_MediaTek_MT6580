...
// macros
#define SIM_WARM_RST()		(SIM_SetBits(SIM_CTRL, SIM_CTRL_WRST))
...
#define USIM_POW_ON() SIM_SetBits(SIM_CTRL, SIM_CTRL_SIMON)
#define USIM_WRST()	(SIM_WriteReg(SIM_CTRL, (SIM_CTRL_WRST|SIM_CTRL_SIMON)))
#define USIM_ENABLE_T0()	SIM_SetBits(SIM_CONF, SIM_CONF_T0EN)
#define USIM_ENABLE_T1()	SIM_SetBits(SIM_CONF, SIM_CONF_T1EN)
#define USIM_DISABLE_T1()	(SIM_ClearBits(SIM_CONF, SIM_CONF_T1EN))
#define USIM_ENABLE_TXRX_HANSHAKE()	SIM_SetBits(SIM_CONF, (SIM_CONF_TXHSK|SIM_CONF_RXHSK))
#define USIM_DISABLE_TXRX_HANSHAKE()	SIM_ClearBits(SIM_CONF, (SIM_CONF_TXHSK|SIM_CONF_RXHSK))
#define USIM_TX_START_T1()	(SIM_WriteReg(SIM_INS, 1))
...
#define USIM_CLR_FIFO()	SIM_WriteReg(SIM_COUNT, 1)
#define USIM_RESET_T1()	USIM_DISABLE_T1();USIM_ENABLE_T1();
#define USIM_ENABLE_TOUT()	(SIM_SetBits(SIM_CONF, SIM_CONF_TOUTEN))
#define USIM_DISABLE_TOUT()	SIM_ClearBits(SIM_CONF, SIM_CONF_TOUTEN)
//#define USIM_CLR_TX_TIDE()		DRV_Reg(SIM_TIDE)&=(~SIM_TIDE_TXMASK)
#define USIM_DMA_RX_TIDE()			SIM_WriteReg(SIM_TIDE, 0);
