...
#elif defined(CPU_CLOCK_MHZ) //ex: MCU_491M, CPU_CLOCK_MHZ = 491
#define COUNTER_50US (CPU_CLOCK_MHZ*50)
#define COUNTER_20US (CPU_CLOCK_MHZ*20)
#define COUNTER_15US (CPU_CLOCK_MHZ*15)
#define COUNTER_10US (CPU_CLOCK_MHZ*10)
#define COUNTER_05US (CPU_CLOCK_MHZ*5)
#define COUNTER_350NS (CPU_CLOCK_MHZ/2) //Approximate value
