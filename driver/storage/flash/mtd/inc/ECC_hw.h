...
#define ECC_ENCCON      ((volatile UINT16P)(NFIECC_base+0x0000))
#define ECC_ENCCNFG     ((volatile UINT32P)(NFIECC_base+0x0004))
#define ECC_ENCDIADDR   ((volatile UINT32P)(NFIECC_base+0x0008))
#define ECC_ENCIDLE     ((volatile UINT32P)(NFIECC_base+0x000C))
#define ECC_ENCPAR0     ((volatile UINT32P)(NFIECC_base+0x0010))
#define ECC_ENCPAR1     ((volatile UINT32P)(NFIECC_base+0x0014))
#define ECC_ENCPAR2     ((volatile UINT32P)(NFIECC_base+0x0018))
#define ECC_ENCPAR3     ((volatile UINT32P)(NFIECC_base+0x001C))
#define ECC_ENCPAR4     ((volatile UINT32P)(NFIECC_base+0x0020))
#define ECC_ENCSTA      ((volatile UINT32P)(NFIECC_base+0x0024))
#define ECC_ENCIRQEN    ((volatile UINT16P)(NFIECC_base+0x0028))
#define ECC_ENCIRQSTA   ((volatile UINT16P)(NFIECC_base+0x002C))

#define ECC_DECCON      ((volatile UINT16P)(NFIECC_base+0x0100))
#define ECC_DECCNFG     ((volatile UINT32P)(NFIECC_base+0x0104))
#define ECC_DECDIADDR   ((volatile UINT32P)(NFIECC_base+0x0108))
#define ECC_DECIDLE     ((volatile UINT16P)(NFIECC_base+0x010C))
#define ECC_DECFER      ((volatile UINT16P)(NFIECC_base+0x0110))
#define ECC_DECENUM     ((volatile UINT32P)(NFIECC_base+0x0114))
#define ECC_DECDONE     ((volatile UINT16P)(NFIECC_base+0x0118))
#define ECC_DECEL0      ((volatile UINT32P)(NFIECC_base+0x011C))
#define ECC_DECEL1      ((volatile UINT32P)(NFIECC_base+0x0120))
#define ECC_DECEL2      ((volatile UINT32P)(NFIECC_base+0x0124))
#define ECC_DECEL3      ((volatile UINT32P)(NFIECC_base+0x0128))
#define ECC_DECEL4      ((volatile UINT32P)(NFIECC_base+0x012C))
#define ECC_DECEL5      ((volatile UINT32P)(NFIECC_base+0x0130))
#define ECC_DECIRQEN    ((volatile UINT16P)(NFIECC_base+0x0134))
#define ECC_DECIRQSTA   ((volatile UINT16P)(NFIECC_base+0x0138))
#define ECC_FDMADDR     ((volatile UINT32P)(NFIECC_base+0x013C))
