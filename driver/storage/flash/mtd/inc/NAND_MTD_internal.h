...
#define NFI_STA         ((volatile UINT32P)(NFI_base+0x0060))
#define NFI_FIFOSTA     ((volatile UINT16P)(NFI_base+0x0064))
#define NFI_LOCKSTA     ((volatile UINT16P)(NFI_base+0x0068))
...
#define NFI_LOCK        ((volatile UINT16P)(NFI_base+0x0100))
#define NFI_LOCKCON     ((volatile UINT32P)(NFI_base+0x0104))
#define NFI_LOCKANOB    ((volatile UINT16P)(NFI_base+0x0108))
#define NFI_LOCK00ADD   ((volatile UINT32P)(NFI_base+0x0110))
#define NFI_LOCK00FMT   ((volatile UINT32P)(NFI_base+0x0114))
#define NFI_LOCK01ADD   ((volatile UINT32P)(NFI_base+0x0118))
#define NFI_LOCK01FMT   ((volatile UINT32P)(NFI_base+0x011C))
#define NFI_LOCK02ADD   ((volatile UINT32P)(NFI_base+0x0120))
#define NFI_LOCK02FMT   ((volatile UINT32P)(NFI_base+0x0124))
#define NFI_LOCK03ADD   ((volatile UINT32P)(NFI_base+0x0128))
#define NFI_LOCK03FMT   ((volatile UINT32P)(NFI_base+0x012C))
#define NFI_LOCK04ADD   ((volatile UINT32P)(NFI_base+0x0130))
#define NFI_LOCK04FMT   ((volatile UINT32P)(NFI_base+0x0134))
#define NFI_LOCK05ADD   ((volatile UINT32P)(NFI_base+0x0138))
#define NFI_LOCK05FMT   ((volatile UINT32P)(NFI_base+0x013C))
#define NFI_LOCK06ADD   ((volatile UINT32P)(NFI_base+0x0140))
#define NFI_LOCK06FMT   ((volatile UINT32P)(NFI_base+0x0144))
#define NFI_LOCK07ADD   ((volatile UINT32P)(NFI_base+0x0148))
#define NFI_LOCK07FMT   ((volatile UINT32P)(NFI_base+0x014C))
#define NFI_LOCK08ADD   ((volatile UINT32P)(NFI_base+0x0150))
#define NFI_LOCK08FMT   ((volatile UINT32P)(NFI_base+0x0154))
#define NFI_LOCK09ADD   ((volatile UINT32P)(NFI_base+0x0158))
#define NFI_LOCK09FMT   ((volatile UINT32P)(NFI_base+0x015C))
#define NFI_LOCK10ADD   ((volatile UINT32P)(NFI_base+0x0160))
#define NFI_LOCK10FMT   ((volatile UINT32P)(NFI_base+0x0164))
#define NFI_LOCK11ADD   ((volatile UINT32P)(NFI_base+0x0168))
#define NFI_LOCK11FMT   ((volatile UINT32P)(NFI_base+0x016C))
#define NFI_LOCK12ADD   ((volatile UINT32P)(NFI_base+0x0170))
#define NFI_LOCK12FMT   ((volatile UINT32P)(NFI_base+0x0174))
#define NFI_LOCK13ADD   ((volatile UINT32P)(NFI_base+0x0178))
#define NFI_LOCK13FMT   ((volatile UINT32P)(NFI_base+0x017C))
#define NFI_LOCK14ADD   ((volatile UINT32P)(NFI_base+0x0180))
#define NFI_LOCK14FMT   ((volatile UINT32P)(NFI_base+0x0184))
#define NFI_LOCK15ADD   ((volatile UINT32P)(NFI_base+0x0188))
#define NFI_LOCK15FMT   ((volatile UINT32P)(NFI_base+0x018C))
...
#define COUNTER_200nS   (CPU_CLOCK_MHZ/5)
#define NFI_COUNTER_2MS (2000*CPU_CLOCK_MHZ)
#define NFI_COUNTER_5MS (5000*CPU_CLOCK_MHZ)
#define NOT_WAIT_NFI_RETURN(a)  \
{\
   kal_uint32 dida = 0;\
   while(a)\
      if(dida++ > NFI_COUNTER_2MS) return KAL_FALSE;\
}
