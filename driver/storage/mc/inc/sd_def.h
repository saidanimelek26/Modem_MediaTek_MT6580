...
#define SD_CMD_MAX_BLOCK_NUM	0xFFFF
#endif
...
#if defined(DRV_MSDC_SDC_V2)
#define SDC_CFG_MDLEN8	0x00040000	// support MMC4.0 8-bit bus width
...
//#endif
#endif//#if defined(DRV_MSDC_SDC_V2)
...
#endif//#if defined(DRV_MSDC_SDC_V2)
#if defined(DRV_MSDC_SDC_V3)
#define SDC_CMD_CTOC	0xff000000
#endif//#if defined(DRV_MSDC_SDC_V3)
...
#if defined(DRV_MSDC_DATSTA_V3)
#define SDC_DATSTA_DATCRCERR	0x03fc
#elif defined(DRV_MSDC_DATSTA_V2)
#define SDC_DATSTA_DATCRCERR	0x003c
#else
#define SDC_DATSTA_DATCRCERR	0x0004
#endif//#if defined(DRV_MSDC_DATSTA_V3)
...
// useful macros
#define SD_IS_BLKDONE		(MSDC_Reg(SDC_DATSTA) & SDC_DATSTA_BLKDONE)
#define SD_IS_DATA_CRCERR	(MSDC_Reg(SDC_DATSTA) & SDC_DATSTA_DATCRCERR)
#define SD_IS_DATA_TIMEOUT  (MSDC_Reg(SDC_DATSTA) & SDC_DATSTA_DATTO)
#define SD_IS_RSP_CRCERR	(MSDC_Reg(SDC_CMDSTA) & SDC_CMDSTA_CMDCRCERR)
#define SD_IS_CMD_TIMEOUT	(MSDC_Reg(SDC_CMDSTA) & SDC_CMDSTA_CMDTO)
#define SD_IS_CMD_READY	(MSDC_Reg(SDC_CMDSTA) & SDC_CMDSTA_CMDRDY)
#define SD_IS_MMC_IRQ		(MSDC_Reg(SDC_CMDSTA) & SDC_CMDSTA_MMCIRQ)
#ifdef MSDC_DEFECT_WRITE_CRCERR	// WHQA_0006199 workaround for MT6236E2 write crc not reported (solution 2)
#define SD_IS_CMD_BUSY   	(MSDC_Reg(SDC_STA) & SDC_STA_FECMDBUSY)
#else
#define SD_IS_CMD_BUSY   	(MSDC_Reg(SDC_STA) & SDC_STA_CMDBUSY)
#endif
#ifdef MSDC_DEFECT_WRITE_CRCERR	// WHQA_0006199 workaround for MT6236E2 write crc not reported (solution 2)
#define SD_IS_DAT_BUSY   	(MSDC_Reg(SDC_STA) & SDC_STA_FEDATBUSY)
#else
#define SD_IS_DAT_BUSY   	(MSDC_Reg(SDC_STA) & SDC_STA_DATBUSY)
#endif
#ifdef MSDC_DEFECT_WRITE_CRCERR	// WHQA_0006199 workaround for MT6236E2 write crc not reported (solution 2)
#define SD_IS_SDC_BUSY   	(MSDC_Reg(SDC_STA) & (SDC_STA_FECMDBUSY|SDC_STA_FEDATBUSY))
#else
#define SD_IS_SDC_BUSY   	(MSDC_Reg(SDC_STA) & SDC_STA_SDCBUSY)
#endif
#ifndef DRV_LSD
#define SD_IS_R1B_BUSY   	(MSDC_Reg(SDC_STA) & SDC_STA_R1BSY)
#else
#define SD_IS_R1B_BUSY		LSD_HostDetectBusy()
#endif

#if defined(__MSDC2_SD_MMC__)||defined(__MSDC2_SD_SDIO__)
#define SD_IS_BLKDONE_2		(MSDC_Reg(SDC_DATSTA2) & SDC_DATSTA_BLKDONE)
#define SD_IS_DATA_CRCERR_2	(MSDC_Reg(SDC_DATSTA2) & SDC_DATSTA_DATCRCERR)
#define SD_IS_DATA_TIMEOUT_2	(MSDC_Reg(SDC_DATSTA2) & SDC_DATSTA_DATTO)
#define SD_IS_RSP_CRCERR_2		(MSDC_Reg(SDC_CMDSTA2) & SDC_CMDSTA_CMDCRCERR)
#define SD_IS_CMD_TIMEOUT_2	(MSDC_Reg(SDC_CMDSTA2) & SDC_CMDSTA_CMDTO)
#define SD_IS_CMD_READY_2		(MSDC_Reg(SDC_CMDSTA2) & SDC_CMDSTA_CMDRDY)
#define SD_IS_MMC_IRQ_2		(MSDC_Reg(SDC_CMDSTA2) & SDC_CMDSTA_MMCIRQ)
#define SD_IS_CMD_BUSY_2		(MSDC_Reg(SDC_STA2) & SDC_STA_CMDBUSY)
#define SD_IS_DAT_BUSY_2		(MSDC_Reg(SDC_STA2) & SDC_STA_DATBUSY)
#define SD_IS_SDC_BUSY_2		(MSDC_Reg(SDC_STA2) & SDC_STA_SDCBUSY)
#define SD_IS_R1B_BUSY_2		(MSDC_Reg(SDC_STA2) & SDC_STA_R1BSY)
#endif
