...
typedef struct {
    ...
    kal_uint8 pdp_addr_type; /* pdp_addr_type_enum */
    ...
    kal_uint16 pdp_act_cause_2 ; // just relay the PDP accept cause_2 value, 
...
typedef struct {
    ...
    kal_uint16 pdp_act_cause ; // the previous PDP accept cause_2 value, ex: PDP_TYPE_IPV4_ONLY_ALLOWED, 
