...
typedef enum
{
     URF_TEST_CMD_TXACCESS = 0                 //type1
    ,URF_TEST_CMD_STOP                         //type1
    ,URF_TEST_CMD_TX_DPCH                      //type1
    ,URF_TEST_CMD_RX_DPCH                      // useless API: do nothing!
    ,URF_TEST_CMD_RSSI                         //type2
    ,URF_TEST_CMD_RSCP                         //type2
    ,URF_TEST_CMD_AFC                          //type2
    ,URF_TEST_CMD_TX_PAAPC                     //type3
    ,URF_TEST_CMD_GET_RFID                     //type3
    ,URF_TEST_CMD_CONFIG_HWTPC                 //type3
    ,URF_TEST_CMD_GET_PWR_DT_STEP              //type3
    ,URF_TEST_CMD_GET_PWR_DT_DAC               //type3
    ,URF_TEST_CMD_GET_PWR_DT_DEFAULT_THR       //type3
    ,URF_TEST_CMD_SET_IMMEDIATE_BSI            //type3
    ,URF_TEST_CMD_GET_IMMEDIATE_BSI            //type3
    ,URF_TEST_CMD_CONTINUOUS_RX                //type2
    ,URF_TEST_CMD_START_FHC //URF_TEST_CMD_MQC //type2
    ,URF_TEST_CMD_SET_TXDAC_DATA               //type3
    ,URF_TEST_CMD_GET_PWR_DET_MEASURE_RES      //type3
    ,URF_TEST_CMD_SET_PWR_CTRL_MODE            //type3
    ,URF_TEST_CMD_REPLACE_GAIN_TABLE_FOR_CAL   //type3
    ,URF_TEST_CMD_START_FHC_NO_WAIT            //type1
    ,URF_TEST_CMD_GET_FHC_RESULT               //type4
    ,URF_TEST_CMD_QUERY_TARGET_CAPABILITY      //type3
    ,URF_TEST_CMD_START_NSFT                   //type1
    ,URF_TEST_CMD_GET_BIT_COUNT_FOR_SINGLE_ENDED_BER // type3
    ,URF_TEST_CMD_NSFT_SET_ILPC_STEP           //type3
    ,URF_TEST_CMD_START_NSFT_EX                //type2
    ,URF_TEST_CMD_SET_PA_OCT_LEVEL_DATA        //type3
    ,URF_TEST_CMD_START_HSDPA_NSFT             //type2
    ,URF_TEST_CMD_START_HSUPA_NSFT             //type2
    ,URF_TEST_CMD_START_FHC_EX                 //type1
    ,URF_TEST_CMD_GET_FHC_EX_RESULT            //type4
    ,URF_TEST_CMD_GET_CURRENT_LNA_MODE         //type3
    ,URF_TEST_CMD_SET_CAPID                    //type3
    ,URF_TEST_CMD_GET_MAX_CAPID                //type3
    ,URF_TEST_CMD_AFC_EX                       //type2
    /* R8 RF tool */
	,URF_TEST_CMD_RSSI_RXD                     //type2: R8 get both rx path RSSI
    ,URF_TEST_CMD_GET_CURRENT_RXD_LNA_MODE     //type3: get rx diversity path LNA mode
    ,URF_TEST_CMD_SET_RX_BANDWIDTH             //type3
    ,URF_TEST_CMD_SET_RX_ANTENNA               //type3
    ,URF_TEST_CMD_SET_TX_PA_DRIFT_COMPENSATION    
    ,URF_TEST_CMD_SET_ICS_CELL_POWER    
    ,URF_TEST_CMD_END
} URfTestCmdType;
