 ...
 * .
 * 1.TDD enter flight add trace
 * 2. add 6290 efuse register check 
 * 3. UPA DATA non cachable bufffer change to cachable buffer
 *
 * 04 02 2013 ast00029
 ...
 * 
 * for cr :MOLY5252,don't initial sync when UPCC or LBM2
 * 
...
typedef enum _rat_type_E
{
   ...
   TL1_RAT_UMTS,                                    /* UMTS active */
   TL1_RAT_GSM                                      /* GSM active */
} rat_type_E;
