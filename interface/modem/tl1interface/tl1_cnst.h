 ...
 * $Log$
 *
 * 12 27 2012 jingjing.ma
 * [MOLY00007713] add num of meas freqs from 9 to 13
 * add 13 freq.
 * 
 * 09 19 2012 xiaoyun.mao
 * [MOLY00002766] warning remove about CFN_IMMEDIATE 0xFFFF changed to -1
 * 
 * 09 17 2012 xiaoyun.mao
 * [MOLY00002766] warning removal
 * Rollback //MOLY/TRUNK/WR8/mcu/interface/modem/tl1interface/tl1_cnst.h to revision 1
 *
...
#ifdef __ADD_MEAS_FREQ_NUM__
#define  MAX_UMTS_FREQ			 (13)
#else
#define  MAX_UMTS_FREQ           (9)                 /* Maximum number of DPCH radio links in TDD128 */
#endif
