...
#endif
{
   ...
   em_info_enum	em_info;
    ...
    /* 091124 shuang SHUANG_EM_UT
    Add this union to the local paramter for the modis UT debugging 
    */
    
#ifndef __MTK_TARGET__
   em_rr_structs_union em_union_type;
#endif
    /*SHUANG_EM_UT end of the union*/

} l4cps_em_info_req_struct;

typedef l4cps_em_info_req_struct l4cps_em_status_ind_struct;

/* Poying: To check SM EM mode by UT */
/* For MSG_ID_L4CPS_CHECK_SM_EM_STATUS_CONTENT */
typedef struct
{
   LOCAL_PARA_HDR
   sm_em_info_struct sm_em_info;
} l4cps_check_sm_em_status_content_struct;
