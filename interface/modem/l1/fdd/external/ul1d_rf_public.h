...
#if IS_3G_MIPI_INIT_CW_BY_BAND
#define M_UMTS_MIPI_INITIAL_CW(x)  UMTS_MIPI_INITIAL_CW_##x
#define M_UMTS_INITIAL_CW(x)       M_UMTS_MIPI_INITIAL_CW(x)
#endif
...
#define MIPI_MAX_INITIAL_IMM_BSI_CW_NUM   140 //30

#if IS_3G_MIPI_INIT_CW_BY_BAND
#define MIPI_MAX_INITIAL_IMM_BSI_CW_NUM_BY_BAND   20 //30
#endif
