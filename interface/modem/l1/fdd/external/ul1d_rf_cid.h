 ...
 *
 * 02 13 2017 mh.kuo
 * [MOLY00229292] [UL1D][RF] FHC RXAGC HW mode support
 * .
 *
 * 08 17 2016 mh.kuo
 * [MOLY00193732] [MT6570] 3G FDD RF Driver Porting
 * .
 *
 * 04 15 2016 mh.kuo
 * [MOLY00174332] [UL1D][RF] Combine WCDMA Band 5 and Band 6.
 *
 * 08 10 2015 mh.kuo
 * [MOLY00128208] [Rainier][MT6580] MIPI Driver Porting. Update MIPI PA E2 CW.
 *
 * 07 17 2015 mh.kuo
...
#define IS_URF_MT6166                        (( UL1D_RF_ID==UL1D_RF_ID_MT6166      )||( UL1D_RF_ID==UL1D_RF_ID_MT6580)||( UL1D_RF_ID==UL1D_RF_ID_MT6570))
#define IS_URF_MT6580                        (( UL1D_RF_ID==UL1D_RF_ID_MT6580      )||( UL1D_RF_ID==UL1D_RF_ID_MT6570))
#define IS_URF_MT6570                        ( UL1D_RF_ID==UL1D_RF_ID_MT6570       )
...
#define UL1D_RF_ID                           UL1D_RF_ID_MT6580
   #elif defined(MT6570RF_UMTS_FDD_RF)
#define UL1D_RF_ID                           UL1D_RF_ID_MT6570
   #else
...
#elif IS_URF_MT6166 && (!IS_URF_MT6580)
#define IS_RF_DUAL_CELL_SUPPORT              1
...
//#error "Test build check"
#define IS_3G_MIPI_NVRAM_FULL_SUPPORT        1 //defined(__3G_MIPI_NVRAM_FULL_SUPPORT__)
#define ENABLE_3G_TPC_SUB_BAND               0 /* subband support for MIPI 8 stage PA bias*/
#define IS_3G_MIPI_EXTENDED_READ_ENABLE      1
#define IS_3G_MIPI_TODO                      0
#define IS_3G_MIPI_SET_GPIO_BY_MODEM         0 /*Set GPIO to MIPI and BPI by modem*/
#define IS_3G_MIPI_DEBUG                     0 /*mipi CW debug message, dump 1 CW in each TX frame*/
#define IS_3G_MIPI_INIT_CW_BY_BAND           1 /*set by band init CW by IMM*/
#define IS_3G_MIPI_INIT_CW_BY_SUBBAND        0 /*set by sub-band init CW by IMM*/
#define IS_3G_MIPI_CW_DUMP                   0 /*Use Catcher inject string to dump CW in HISR*/
#define IS_3G_MIPI_PA_PEAK_DETECTOR_ENABLE   0 /*Enable peak detector*/
#if IS_3G_MIPI_PA_PEAK_DETECTOR_ENABLE
#define IS_3G_MIPI_RESET_PD                  1
#endif
#endif
...
#define IS_3G_B5B6_COMBINED                  defined (__3G_BAND5_BAND6_COMBINED__)

#define IS_3G_FHC_RXAGC_HW_MODE              defined (__3G_FHC_RX_HW_MODE__)
