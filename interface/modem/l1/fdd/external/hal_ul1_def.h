...
#elif defined(MT6582_S00) //MT6572E1
...
#elif defined(MT6592_S00) //MT6592E1
...
#elif defined(MT6580_S00) //MT6580E1
...
#else
#error "please add new chip for MTCMOS control"
#endif
