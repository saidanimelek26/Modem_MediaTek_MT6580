...
#define    MPR_BACK_OFF_HSUPA_BAND18 MPRSetting2
   ...
   #define IS_3G_DRDI_SUPPORT  1
#else
   #undef IS_3G_DRDI_SUPPORT  
   #define IS_3G_DRDI_SUPPORT  1
#endif

#ifndef IS_3G_DRDI_REMAP_SUPPORT
   #define IS_3G_DRDI_REMAP_SUPPORT  0 
#endif

#ifndef UL1CUSTOM_DRDI_PA_DRIFT_COMP_ENABLE
   #define UL1CUSTOM_DRDI_PA_DRIFT_COMP_ENABLE  0 
#endif
