...
//stupid-prevant
     ...
     **********************************************/
        ...
        NVRAM_EF_L1_END =  NVRAM_EF_L1_GAINRF_LID,
...
//        NVRAM_EF_ADC_LID = 66,
        ...
        NVRAM_EF_AST_TL1_END = NVRAM_EF_AST_TL1_RF_PARAM_LID,
     ...
     **********************************************/
        ...
        NVRAM_EF_GPS_CO_CLOCK_DATA_LID,
...
#define NVRAM_EF_PORT_SETTING_TOTAL  2
#else
...
#define NVRAM_EF_MM_EQPLMN_LOCIGPRS_SIZE (sizeof(nvram_ef_mm_eqplmn_locigprs_struct))
#ifdef __REL6__
...
#ifdef __UMTS_R8__
#define NVRAM_EF_UMTS_USIME_RRC_DYNAMIC_CAP_SIZE      (42+3+3+2+2+3)
#elif defined(__UMTS_R7__)
#define NVRAM_EF_UMTS_USIME_RRC_DYNAMIC_CAP_SIZE      (42+3+3+2+2)
#elif defined(__UMTS_R6__)
#define NVRAM_EF_UMTS_USIME_RRC_DYNAMIC_CAP_SIZE      (42+3+3+2)
#elif defined(__UMTS_R5__)
#define NVRAM_EF_UMTS_USIME_RRC_DYNAMIC_CAP_SIZE      (42+3+3)
...
#ifdef __UMTS_R7__
#define NVRAM_EF_UMTS_USIME_RRC_DYNAMIC_CAP_SIZE      (36+3+2+2)
#elif defined(__UMTS_R6__)
#define NVRAM_EF_UMTS_USIME_RRC_DYNAMIC_CAP_SIZE      (36+3+2)
#elif defined(__UMTS_R5__)
#define NVRAM_EF_UMTS_USIME_RRC_DYNAMIC_CAP_SIZE      (36+3)
#else
#define NVRAM_EF_UMTS_USIME_RRC_DYNAMIC_CAP_SIZE      36
#endif
#define NVRAM_EF_UMTS_USIME_RRC_DYNAMIC_CAP_TOTAL     1
#endif
...
typedef struct
{
    ...
    kal_uint8 modem_sbp_config[10]; //the size depends on SBP_MAX_MD_FEATURE
...
#define NVRAM_EF_RAC_PREFERENCE_SIZE         10 /* 4+4 (3g band) +1 (gprs_transfer_preference/hspa_preference) */
...
typedef struct
{
    ...
    kal_uint32 initU;
    kal_uint32 lastU;
} nvram_ef_gps_co_clock_data_struct_t;
#define NVRAM_EF_GPS_CO_CLOCK_DATA_SIZE     sizeof(nvram_ef_gps_co_clock_data_struct_t)
#define NVRAM_EF_GPS_CO_CLOCK_DATA_TOTAL    1
#endif // #if defined(__GPS_CO_CLOCK_DATA_IN_MD__)
