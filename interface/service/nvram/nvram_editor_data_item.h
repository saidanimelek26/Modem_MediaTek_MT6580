...
#ifdef __REL6__
#define  NVRAM_EF_MM_EQPLMN_LOCIGPRS_LID_VERNO               "001"
#else
...
#define NVRAM_EF_NET_PAR_LID_VERNO                           "008"
...
#define NVRAM_EF_UMTS_USIME_RRC_DYNAMIC_CAP_LID_VERNO        "007"
...
#define NVRAM_EF_TCM_PDP_PROFILE_LID_VERNO                  "001"
...
#define NVRAM_EF_RAC_PREFERENCE_LID_VERNO               "008"
...
#endif
#define NVRAM_EF_TST_CONFIG_LID_VERNO                     "002"
...
#define NVRAM_EF_SBP_MODEM_CONFIG_LID_VERNO "011"
#define NVRAM_EF_SBP_MODEM_DATA_CONFIG_LID_VERNO "001"
#if defined(__GPS_CO_CLOCK_DATA_IN_MD__)
#define NVRAM_EF_GPS_CO_CLOCK_DATA_LID_VERNO "000"
#endif // #if defined(__GPS_CO_CLOCK_DATA_IN_MD__)
...
typedef struct
{
    nvram_ef_plmn_id_struct plmn_id; 
...
typedef struct
{   
	nvram_ef_rat_enum rplmn_rat;	
	kal_uint8 num_of_eq_plmn;
	nvram_ef_plmn_id_struct eq_plmn[EF_MAX_NUM_EQ_PLMN];
...
#ifdef __UMTS_R5__
    kal_uint8       r5_cap1;
    kal_uint8       fdd_hsdpa_category;
    kal_uint8       tdd128_hsdpa_category;
...
// R8 CAP #3
#ifdef __UMTS_R8__
    kal_uint8       fdd_hsdpa_category_ext;
    kal_uint8       r8_cap1;
    kal_uint8       r8_cap2;
#endif
...
typedef struct
{
    ...
    kal_uint8 dns_val[MAX_PDP_ADDR_LEN];
    kal_uint8 is_chap;
...
typedef struct
{
    ...
    kal_uint8    padding ;		/* To make struct could be even bytes, since nvram computes checksum by two bytes.*/
...
LID_BIT VER_LID(NVRAM_EF_TCM_PDP_PROFILE_LID)
     nvram_ef_tcm_PDP_profile_record_struct *NVRAM_EF_TCM_PDP_PROFILE_TOTAL
     {
       ...
       req_qos.unused4:"Unused Byte"
         {
         };
       req_qos.signalling_indication:"Signalling Indication"
         {
         };
       req_qos.source_statistics_descriptor:"Source Statistics Descriptor"
         {
         };
       req_qos.ext_max_bitrate_down_lnk:"Extended Maximum Bit Rate for downlink"
         {
         };
       req_qos.ext_guarntd_bit_rate_down_lnk:"Extended Guaranteed Bit Rate for downlink"
         {
         };
       req_qos.ext_max_bitrate_up_lnk:"Extended Maximum Bit Rate for uplink"
         {
         };
       req_qos.ext_guarntd_bit_rate_up_lnk:"Extended Guaranteed Bit Rate for uplink"
         {
         };
       ...
       min_qos.unused4:"Unused Byte"
         {
         };
       min_qos.signalling_indication:"Signalling Indication"
         {
         };
       min_qos.source_statistics_descriptor:"Source Statistics Descriptor"
         {
         };
       min_qos.ext_max_bitrate_down_lnk:"Extended Maximum Bit Rate for downlink"
         {
         };
       min_qos.ext_guarntd_bit_rate_down_lnk:"Extended Guaranteed Bit Rate for downlink"
         {
         };
       min_qos.ext_max_bitrate_up_lnk:"Extended Maximum Bit Rate for uplink"
         {
         };
       min_qos.ext_guarntd_bit_rate_up_lnk:"Extended Guaranteed Bit Rate for uplink"
         {
         };
...
/***********************************************************************
  ...
  ***
  ***********************************************************************/
#if defined(__NVRAM_SML_IN_DB__)
     ...
     nvram_ef_classmark_racap_struct *NVRAM_EF_CLASSMARK_RACAP_TOTAL
     {
       ...
       byte12:"GPRS related parameters used in Mobile network capability IE"
         ...
         byte15:"R4~R6 IEs"
         {
           ...
           spare:2 "Downlink Advanced Receiver Performance"
             {
             };
         };
         byte16:"R4~R6 IEs"
...
#if defined(__MA_L1__) || defined(__UMTS_RAT__)
/** [20130509 LY] For MT6572, when reading this LID from NVRAM, failed message happens because the TST buffer size is only 8k (size of this LID is larger than 8k)
 This LID is not be used for MT6572, so we hide it @ NVRAM editor to avoid access and failed message */
...
LID_BIT VER_LID(NVRAM_EF_RAC_PREFERENCE_LID)
	 ...
	 roaming_setting: "ROAMING REALTED SETTING"
		  {
...
LID_BIT VER_LID(NVRAM_EF_SBP_MODEM_CONFIG_LID)
    nvram_ef_sbp_modem_config_struct *NVRAM_EF_SBP_MODEM_CONFIG_TOTAL
    {
       ...
       modem_sbp_config[2]
        {
            HPPLMN_REGARDLESS_ANY_MCC: 1 "__HPPLMN_REGARDLESS_ANY_MCC__"
            {
                0x0: "Not Supported";
                0x1: "Supported";
            };

            DISABLE_RPLMN_FROM_GLOCI: 1 "__DISABLE_RPLMN_FROM_GLOCI__"
            {
                0x0: "Not Supported";
                0x1: "Supported";
            };
            ...
            ENS_RAT_BALANCING: 1 "__ENS_RAT_BALANCING__"
            {
                0x0: "Not Supported";
                0x1: "Supported";
            };
            
            MM_INTERNATIONAL_HPPLMN_SEARCH: 1 "__MM_INTERNATIONAL_HPPLMN_SEARCH__"
            {
                0x0: "Not Supported";
                0x1: "Supported";
            };

            ATNT_HPPLMN_SEARCH: 1 "__ATNT_HPPLMN_SEARCH__"
            {
                0x0: "Not Supported";
                0x1: "Supported";
            };

            DISABLE_PLMNSEL_OPLMN_COEXIST: 1 "__DISABLE_PLMNSEL_OPLMN_COEXIST__"
            {
                0x0: "Not Supported";
                0x1: "Supported";
            };

            DISABLE_DISPLAY_ROAMING_HPLMN_IN_EPLMN: 1 "__DISABLE_DISPLAY_ROAMING_HPLMN_IN_EPLMN__"
            {
                0x0: "Not Supported";
                0x1: "Supported";
            };
        ...
        modem_sbp_config[3]
        {
            ...
            RPLMN_HPLMN_COMBINED_SEARCH: 1 "__RPLMN_HPLMN_COMBINED_SEARCH__"
            {
                0x0: "Not Supported";
                0x1: "Supported";
            };
            
            MM_SEARCH_HPLMN_BEFORE_RPLMN: 1 "__MM_SEARCH_HPLMN_BEFORE_RPLMN__"
            {
                0x0: "Not Supported";
                0x1: "Supported";
            };
            
            DISABLE_PLMN_SEL_WHEN_ACCESS_BARRED: 1 "__DISABLE_PLMN_SEL_WHEN_ACCESS_BARRED__"
            {
                0x0: "Not Supported";
                0x1: "Supported";
            };

            TMO_PLMN_MATCHING: 1 "__TMO_PLMN_MATCHING__"
            {
                0x0: "Not Supported";
                0x1: "Supported";
            };

            MM_MM_NOT_TRY_ANOTHER_RAT_FOR_LU_ABNORMAL: 1 "__MM_NOT_TRY_ANOTHER_RAT_FOR_LU_ABNORMAL__"
            {
                0x0: "Not Supported";
                0x1: "Supported";
            };

            MM_PERFORM_PLMN_SEARCH_AFTER_LU_ABNORMAL: 1 "__MM_PERFORM_PLMN_SEARCH_AFTER_LU_ABNORMAL__"
            {
                0x0: "Not Supported";
                0x1: "Supported";
            };
        ...
        modem_sbp_config[4]
        {
            ...
            MM_ILL_MS_ME_CAUSE_PS_INVALID_SIM: 1 "__MM_ILL_MS_ME_CAUSE_PS_INVALID_SIM__"
            {
                0x0: "Not Supported";
                0x1: "Supported";
            };
			...
			SBP_VIETTEL_3G_BAND_VARIANT_1: 1 "__SBP_VIETTEL_3G_BAND_VARIANT_1__"
			{
    ...
    modem_sbp_config[5]
       {
    	   SBP_VIETTEL_3G_BAND_VARIANT_2: 1 "__SBP_VIETTEL_3G_BAND_VARIANT_2__"
    	   {
    		   0x0: "Not Supported";
    		   0x1: "Supported";
    	   };

            AUTO_RESEL_ONLY_WHEN_NO_SERVICE: 1 "Perform AUTO RESEL only when UE is in NO_SERVICE/LIMITED_SERVICE"
            {
                0x0: "Not Supported";
                0x1: "Supported";
            };

            ENHANCED_SOR: 1 "Optimization in T3211/T3311 timer values for cause #17 (15 sec->5 sec)"
            {
                0x0: "Not Supported";
                0x1: "Supported";
            };
       ...
       modem_sbp_config[6]
       {
			...
			SAT_REISSUE_REFRESH_AFTER_SMS_ACK: 1 "Reissue Refresh after SMS ack"
			{
			    0x0: "Not Supported";
				0x1: "Supported";
			};

            MM_INVALID_SIM_REJ_CAUSE_CONSIDER_ABNORMAL: 1 "__MM_INVALID_SIM_REJ_CAUSE_CONSIDER_ABNORMAL__"
		    {
                0x0: "Not enabled";
                0x1: "Enabled";
		    };
	   ...
	   modem_sbp_config[7]
       {
           ...
           SBP_MT_CS_CALL_NOT_ALLOWED: 1 "MT_CS_CALL_NOT_ALLOWED"
           {
               0x0: "No";
               0x1: "Yes";
           };
...
#if defined(__GPS_CO_CLOCK_DATA_IN_MD__)
LID_BIT VER_LID(NVRAM_EF_GPS_CO_CLOCK_DATA_LID)
     nvram_ef_gps_co_clock_data_struct_t *NVRAM_EF_GPS_CO_CLOCK_DATA_TOTAL
     {
     };
#endif // #if defined(__GPS_CO_CLOCK_DATA_IN_MD__)
