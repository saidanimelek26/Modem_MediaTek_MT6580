 ...
 */
#if (defined(CURR_MODULE) && (CURR_MODULE == MOD_NVRAM)) || defined(NVRAM_AUTO_GEN) || defined(NVRAM_LID_SPLIT)
...
/*
*  Customer defines important data
*/
#define NVRAM_CATEGORY_IMPORTANT_C		0x8000
