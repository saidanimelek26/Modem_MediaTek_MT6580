...
#if defined(__RVCT__) || defined(__GNUC__)    
#include <stdio.h>
#include <stdarg.h>
#include <wchar.h>

#ifndef __cplusplus /* mark all using deprecated symbol as an error,except cplusplus */
#if defined(__RVCT__)
...
#endif /*defined(__RVCT__) || defined(__GNUC__) */
