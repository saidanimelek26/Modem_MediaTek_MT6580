...
#endif
#ifdef __UMTS_R7__
   TRC_MSG(EVENT_INFO_TRACE_FUNC_DEFERRED_SIB11_12_READING, "%Msim_interface_enum, Deferred SIB11/12 Reading is configured in cell(%d/%d)") 
...
#endif
#ifdef __UMTS_R7__
   TRC_MSG(EVENT_INFO_TRACE_FUNC_DEFERRED_SIB11_12_READING, "Deferred SIB11/12 Reading is configured in cell(%d/%d)") 
