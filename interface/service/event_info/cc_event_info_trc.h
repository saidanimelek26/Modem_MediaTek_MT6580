...
#ifndef _CC_EVENT_INFO_TRC_H
#define _CC_EVENT_INFO_TRC_H
...
#endif
BEGIN_TRACE_MAP_WITH_RANGE(MOD_EVENT_INFO, 1201, 1300)
/***************************************************************************
...
#ifdef __GEMINI__
   TRC_MSG(EVENT_INFO_TRACE_FUNC_CC_CCBS, "%Msim_interface_enum, [CC]CCBS received, please inform CC owner!!")
   TRC_MSG(EVENT_INFO_TRACE_FUNC_CC_AOC, "%Msim_interface_enum, [CC]AOC paramters received, please inform CC owner!!")
 #else
   TRC_MSG(EVENT_INFO_TRACE_FUNC_CC_CCBS, "[CC]CCBS received, please inform CC owner!!")
   TRC_MSG(EVENT_INFO_TRACE_FUNC_CC_AOC, "[CC]AOC paramters received, please inform CC owner!!")
 #endif
...
END_TRACE_MAP_WITH_RANGE(MOD_EVENT_INFO, 1201, 1300)
#endif
