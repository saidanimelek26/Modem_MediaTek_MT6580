...
#ifndef _SMS_EVENT_INFO_TRC_H
#define _SMS_EVENT_INFO_TRC_H
...
#endif
BEGIN_TRACE_MAP_WITH_RANGE(MOD_EVENT_INFO, 1601, 1700)
/***************************************************************************
...
#ifdef __GEMINI__
   /*Level 1 put here*/
   TRC_MSG(EVENT_INFO_GROUP1_SMS_RECEIVED, "%Msim_interface_enum, SMS Received [%d]")
   TRC_MSG(EVENT_INFO_GROUP1_SMS_SENDING_ATTEMPT, "%Msim_interface_enum, SMS Sending Attempt [%d]")
   TRC_MSG(EVENT_INFO_GROUP1_SMS_SENDING_COMPLETED, "%Msim_interface_enum, SMS Sending Completed [%d]")
   TRC_MSG(EVENT_INFO_GROUP1_SMS_SENDING_FAILED, "%Msim_interface_enum, SMS Sending Failed [%d]")
   
   /*Level 2 put here*/
   /*Level 3 put here*/
#else
   /*Level 1 put here*/
   TRC_MSG(EVENT_INFO_GROUP1_SMS_RECEIVED,"SMS Received [%d]")
   TRC_MSG(EVENT_INFO_GROUP1_SMS_SENDING_ATTEMPT,"SMS Sending Attempt [%d]")
   TRC_MSG(EVENT_INFO_GROUP1_SMS_SENDING_COMPLETED,"SMS Sending Completed [%d]")
   TRC_MSG(EVENT_INFO_GROUP1_SMS_SENDING_FAILED,"SMS Sending Failed [%d]")
#endif
...
END_TRACE_MAP_WITH_RANGE(MOD_EVENT_INFO, 1601, 1700)
#endif
