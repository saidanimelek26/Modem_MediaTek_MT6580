...
#ifndef _PPP_EVENT_INFO_TRC_H
#define _PPP_EVENT_INFO_TRC_H
...
#endif
BEGIN_TRACE_MAP_WITH_RANGE(MOD_EVENT_INFO, 2001, 2100)
/***************************************************************************
...
/***************************** Beging of Protocol Action  **************************/
   ...
   /*Level 2 put here*/
   /*Level 3 put here*/
   TRC_MSG(EVENT_INFO_PPP_TRACE_GROUP_3_DIALUP_PC_GIVE_UP_REQUESTING_DNS, "%Msim_interface_enum, Dialup PC give up requesting DNS")/* Carlson 2008.12.18 PPP Catcher Event Info */
#else
   /*Level 1 put here*/
   /*Level 2 put here*/
   /*Level 3 put here*/
   TRC_MSG(EVENT_INFO_PPP_TRACE_GROUP_3_DIALUP_PC_GIVE_UP_REQUESTING_DNS, "Dialup PC give up requesting DNS")/* Carlson 2008.12.18 PPP Catcher Event Info */
#endif
...
END_TRACE_MAP_WITH_RANGE(MOD_EVENT_INFO, 2001, 2100)
#endif
