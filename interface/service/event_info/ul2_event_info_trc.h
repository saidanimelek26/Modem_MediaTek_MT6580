...
#ifndef _UL2_EVENT_INFO_TRC_H
#define _UL2_EVENT_INFO_TRC_H
...
#endif
BEGIN_TRACE_MAP_WITH_RANGE(MOD_EVENT_INFO, 601, 700)
/***************************************************************************
...
/***************************** Beging of Protocol Action  **************************/
   ...
   /*Level 3 put here*/
   TRC_MSG(EVENT_INFO_GROUP3_ADJUST_ACTIVATION_CFN, "%Msim_interface_enum, Adjust CFN to TTI Boundary : Original CFN = %d,  Adjusted CFN = %d, Max TTI Boundary = %u")
#else
   /*Level 1 put here*/
   ...
   /*Level 3 put here*/
   TRC_MSG(EVENT_INFO_GROUP3_ADJUST_ACTIVATION_CFN, "Adjust CFN to TTI Boundary : Original CFN = %d,  Adjusted CFN = %d, Max TTI Boundary = %u")
#endif
...
#ifdef __GEMINI__
   TRC_MSG(EVENT_INFO_TRACE_WARNING_TX_DCH_DELAY, "%Msim_interface_enum, [DCH DELAY HAPPENS] : CFN = %u, Total occurence = %u")
   TRC_MSG(EVENT_INFO_TRACE_WARNING_Cipher_Activation_Time_Delayed, "%Msim_interface_enum, [Cipher Activation Time is delayed !!] : Adjusted CFN = %u, HFN = %x")
#else
   TRC_MSG(EVENT_INFO_TRACE_WARNING_TX_DCH_DELAY, "[DCH DELAY HAPPENS] : CFN = %u, Total occurence = %u")
   TRC_MSG(EVENT_INFO_TRACE_WARNING_Cipher_Activation_Time_Delayed, "[Cipher Activation Time is delayed !!] : Adjusted CFN = %u, HFN = %x")
#endif
...
END_TRACE_MAP_WITH_RANGE(MOD_EVENT_INFO, 601, 700)
#endif
