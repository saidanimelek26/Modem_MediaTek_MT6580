 ...
 * $Log$
 *
 * 12 17 2012 nicky.chou
 * [MOLY00007548] [MT6280][check-in request] Modem Warning Message stack size improvement
 * .
 *
 * 12 17 2012 nicky.chou
 * [MOLY00007548] [MT6280][check-in request] Modem Warning Message stack size improvement
 * .
 * 
 * 09 07 2012 doug.shih
 * [MOLY00003250] [Need Patch][Build Error] WR8.W1231.DC.WG.MP build error for BROADMOBI80_E2_HSPA(DEFAULT)
 * .
 *
 * 06 22 2012 adeline.chang
 * removed!
 ...
 *
 * 03 13 2012 adeline.chang
 * removed!
 * .
 *
 * 12 14 2010 justin.li
 * removed!
 * .
 *
 * removed!
