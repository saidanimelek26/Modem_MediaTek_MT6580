...
#ifndef _LLC_EVENT_INFO_TRC_H
#define _LLC_EVENT_INFO_TRC_H
...
#endif
BEGIN_TRACE_MAP_WITH_RANGE(MOD_EVENT_INFO, 1701, 1800)
/***************************************************************************
...
#ifdef __GEMINI__
   /*Level 1 put here*/
   TRC_MSG(EVENT_INFO_GROUP1_LLC_ACK_MODE, "%Msim_interface_enum, [LLC] ACK mode is activated on SAPI:%d") /* Robert for 2G LLC */
   
   /*Level 2 put here*/
   /*Level 3 put here*/
   TRC_MSG(EVENT_INFO_GROUP3_LLC_CIPHER_STATUS, "%Msim_interface_enum, [LLC] Cipher is ON. Algo:%d") /* Robert for 2G LLC */
#else
   /*Level 1 put here*/
   TRC_MSG(EVENT_INFO_GROUP1_LLC_ACK_MODE,"[LLC] ACK mode is activated on SAPI:%d") /* Robert for 2G LLC */

   /*Level 2 put here*/
   /*Level 3 put here*/
   TRC_MSG(EVENT_INFO_GROUP3_LLC_CIPHER_STATUS,"[LLC] Cipher is ON. Algo:%d") /* Robert for 2G LLC */
#endif
...
END_TRACE_MAP_WITH_RANGE(MOD_EVENT_INFO, 1701, 1800)
#endif
