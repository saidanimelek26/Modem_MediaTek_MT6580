...
#include "swtr_public.h" //for SWTR defs
...
#define TST_EVENT_LGA_LOG2FILE_REQ 0x100000
  ...
  //Per MT6268 meeting, use 512 KB as the ring buffer size
  #if defined(MT6276)
    #define TST_RING_BUFFER_SIZE (1<<17)
  #elif defined(MT6280)
    #define TST_RING_BUFFER_SIZE (1<<21) // 2M
  #else
...
#ifndef UNIT_TEST
  #ifdef __UMTS_RAT__
    #define  MAX_TST_ASSERT_RECEIVE_BUFFER_LENGTH       512
  #else //__UMTS_RAT__
...
#define  RS232_COMMAND_TYPE_OCTET_MD2				0xC0
#define  RS232_COMMAND_TYPE_OCTET_MAX				0xCF
...
#define RS232_QUERY_PRIORITY_TRACING_REPORT 0x99
#define RS232_PS_MINI_LOG_TYPE 0x9A
#define RS232_CATCHER_QUICK_SCR_CAPTURE_ACK 0x9B
#define RS232_SD_MEMORY_DUMP 0x9C
#define RS232_QUERY_SWTR_HEADER_REPORT 0x9D
#define RS232_PS_PARTIAL_INDEX_TRACE 0x9E
#define RS232_PS_PARTIAL_BRIEF_TRACE 0x9F
#define RS232_SP_META_L1_TRACE 0xA0
...
#define PS_MINI_LOG_OCTET 0x59
#define L1_MINI_LOG_OCTET 0xA6
...
/* under construction !*/
  ...
  TST_SPARE_LOG_START_CMD                   = 0x35,  
  TST_SPARE_LOG_STOP_CMD                    = 0x36,  
#if defined(UNIT_TEST) || defined(UT_ON_TARGET)  
...
#if defined(__TST_ASM_SUPPORT__) && defined(__MALMO_ASM_BUSMONITOR__)
  TST_ASM_BM_START_CMD                      = 0x3B,  
  TST_ASM_BM_STOP_CMD                       = 0x3C,  
#endif //#if defined(__TST_ASM_SUPPORT__) && defined(__MALMO_ASM_BUSMONITOR__)
#ifdef __MALMO_ASM_SWTR__
  TST_SWTR_QUERY_HEADER_CMD                 = 0x3D,
#endif //#ifdef __MALMO_ASM_SWTR__
#endif  //#ifdef __TST_MALMO_SUPPORT__  
#ifdef __SMART_PHONE_MODEM__
  TST_SP_CONFIG_CMD = 0x3E,
#endif //#ifdef __SMART_PHONE_MODEM__
  TST_SET_AUTO_DUMP_CMD = 0x3F,
...
//9: buffer 0..3, h_msg_buffer[2], e_msg_buffer[2]
  ...
  #define TST_CPHY_CONTAINER_MSG_FIELD_LEN 10  
#else
  #define TST_CPHY_CONTAINER_MSG_FIELD_LEN 9
#endif
#elif defined(__UMTS_TDD128_MODE__) //#if defined(__UMTS_FDD_MODE__)          
  #define TST_CPHY_CONTAINER_MSG_FIELD_LEN 9  
#else ////#if defined(__UMTS_FDD_MODE__)  
  #define TST_CPHY_CONTAINER_MSG_FIELD_LEN 9  
...
tst_common_enable_cmd_template;

#if defined(__TST_MALMO_SUPPORT__) && defined(__TST_ASM_SUPPORT__) && defined(__MALMO_ASM_SWLA__) 
#define SWLA_ASM_LOGGING 0x99
#endif
...
typedef struct
{
  ...
  kal_bool enable;  //specify if we would like to enable/disable SWLA
#if defined(__TST_MALMO_SUPPORT__) && defined(__TST_ASM_SUPPORT__) && defined(__MALMO_ASM_SWLA__) 
  kal_uint8 logging; //ram logging or asm logging
#endif
}
tst_swla_start_cmd_struct;


#if defined(__TST_MALMO_SUPPORT__) && defined(__TST_ASM_SUPPORT__) && defined(__MALMO_ASM_BUSMONITOR__)
typedef struct
{
  kal_uint32 token; //indicate the transaction id  
  kal_bool enable;  //specify if we would like to enable/disable SWLA
...
tst_asm_bm_start_cmd_struct;

typedef tst_common_enable_cmd_template tst_asm_bm_stop_cmd_struct;

#endif //#if defined(__TST_MALMO_SUPPORT__) && defined(__TST_ASM_SUPPORT__) && defined(__MALMO_ASM_BUSMONITOR__)


typedef tst_swla_start_cmd_struct tst_swla_stop_cmd_struct;
typedef tst_common_enable_cmd_template tst_spare_log_start_cmd_struct;
typedef tst_common_enable_cmd_template tst_spare_log_stop_cmd_struct;
typedef tst_common_enable_cmd_template tst_swla_default_start_enable_cmd_struct;
typedef tst_common_enable_cmd_template tst_swla_default_start_disable_cmd_struct;
...
typedef kal_uint8 tst_swtr_query_header_cmd_struct;
...
#if defined(__TST_MALMO_SUPPORT__) && defined(__MALMO_ASM_SWTR__)
typedef struct
{
  ST_MALMO_ASM_LoggingHeader header;
}
tst_swtr_query_header_report;
#endif
...
tst_brief_trace_header_no_mod_struct;
#endif  //#ifdef __GEMINI__
...
tst_mini_log_static_info_header_struct;
#endif
