...
#define SLEEP_32K_CALIBRATION_SHARING
#endif
...
extern kal_uint8 OSTD_GetHandle( void );
extern void OSTD_SleepEnable( kal_uint8 handle );
extern void OSTD_SleepDisable( kal_uint8 handle );
extern void OSTD_UnIRQSleepEnable( kal_uint8 handle );
extern void OSTD_UnIRQSleepDisable( kal_uint8 handle );
extern void OSTD_EnableNIRQ( void );
extern void OSTD_DisableNIRQ( void );
extern void OSTD_SetCurrentFreqOffset(kal_int32 freq_offset, OSTD_INPUT_MODULE module);
extern void OSTD_UpdateFreqOffsetBase( void );
