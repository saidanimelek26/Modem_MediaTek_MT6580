...
#define USB_DRV_CMDS \
	...
	USB_ECM_CLASS_START = 0x1200,  \
	USB_ECM_CMD_ENCM_NOTIFY,  \
	USB_ECM_CMD_CDC_TYPE,  \
	USB_ECM_CLASS_END = 0x12FF,  \
...
typedef struct
{
	...
	DCL_UINT8*	    puBuffaddr;
	DCL_BOOL	  u2Retresult;
} USB_DRV_CTRL_ECM_NOTIFY;

typedef struct
{
	DCL_UINT8 		ptype;
} USB_DRV_CTRL_CDC_CLASS;
...
#define USB_DRV_CTRLS \
  ...
  USB_DRV_CTRL_ECM_NOTIFY				rEcm_Ctrl_Fun1; \
  USB_DRV_CTRL_CDC_CLASS		        rEcm_Ctrl_Fun2; \
