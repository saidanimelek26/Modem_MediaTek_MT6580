...
typedef enum {
    ...
    MSG_ID_UEGW_CODE_BEGIN, MSG_ID_UEGW_CODE_TAIL = MSG_ID_UEGW_CODE_BEGIN + 100,
    ...
    MSG_ID_RRM_MPAL_DM_TDD_CODE_BEGIN, MSG_ID_RRM_MPAL_DM_TDD_CODE_TAIL = MSG_ID_RRM_MPAL_DM_TDD_CODE_BEGIN + 100,
