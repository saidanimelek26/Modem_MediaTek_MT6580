...
/* messages received from RAC at GMMREG  sap */
	...
	MSG_ID_GMMREG_PEER_REJECT_REQ,		//for __MMDC__
#endif
#ifdef __GEMINI__
    MSG_ID_GMMREG_SIM_STATUS_UPDATE_REQ,
#endif
    MSG_ID_GMMREG_SUSP_RESU_UPDATE_REQ, /* mtk03643: CT G+C network selection requirement */
    MSG_ID_GMMREG_SET_IMEI_REQ,
    MSG_ID_GMMREG_UE_OPLMN_UPDATE_REQ,
