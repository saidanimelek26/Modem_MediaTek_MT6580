...
MODULE_MSG_BEGIN( MSG_ID_L4_PUBLIC_CODE_BEGIN )
    ...
    MSG_ID_ATCI_PPE_PROXY_CMD_IND,
    MSG_ID_ATCI_PPE_PROXY_CMD_RSP,
    MSG_ID_ATCI_PPE_PROXY_CMD_REQ,
    MSG_ID_ATCI_PPE_PROXY_CMD_CNF,
    MSG_ID_ATCI_PPE_PROXY_URC_IND,
    /*not use
    ...
    MSG_ID_L4_PUBLIC_CODE_END = MSG_ID_LBSAP_DATA_SEND_REQ,
