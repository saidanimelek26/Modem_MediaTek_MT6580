 ...
 * $Log:$
 *
 * 03 14 2013 young.zhou
 * [MOLY00011931] [EE][HW Issue Workaround Verify][MT6589TDV1_Phone][CMCC Case][FT][Nanjing][C1.2][M] 测试点2第5th_14:28_终端在3G网络向2G网络切换时出现EE红屏_省中医院_buffer.c
 * .
 * 
 * 09 18 2012 yanfei.ding
 * [MOLY00003744] [3G TDD][__RATDM_UL_SHAQ__] Check in SHAQ Code and Enable SHAQ
 * Update UAS/interface for SHAQ. 
 * 
...
MSG_ID_URLC_CODE_END = MSG_ID_URLC_SEQ_ENTER_PCH_REQ,
