...
MODULE_MSG_BEGIN( MSG_ID_L4C_CODE_BEGIN )
   ...
   MSG_TAG_L4C_FIRST_REQ_MSG,
    ...
    MSG_ID_L4CRAC_RESTART_CLEAR_CODE_33_PROC_IND,
    
    MSG_ID_L4C_CODE_END = MSG_ID_L4CRAC_RESTART_CLEAR_CODE_33_PROC_IND,
...
MODULE_MSG_BEGIN( MSG_ID_TCM_CODE_BEGIN )
    ...
    /* HSPA Optimization, remove TCM from data path */
    MSG_ID_TCM_RATDM_CONFIG_CNF, // HSPA Optimization, remove TCM from data path
          MSG_TAG_TCM_FIRST_MSG_AFFECT_DATA_PLANE_FSM = MSG_ID_TCM_RATDM_CONFIG_CNF,
    MSG_ID_TCM_RATDM_DECONFIG_CNF, // HSPA Optimization, remove TCM from data path
    ...
    /* these messages are used for check L4CTCM callback functions */
    #ifdef __TCM_UT__
    MSG_ID_TCM_UT_CHECK_CALLBACK_L4CTCM_GET_PRI_PDP_INFO,
          MSG_TAG_TCM_FIRST_UT_MSG = MSG_ID_TCM_UT_CHECK_CALLBACK_L4CTCM_GET_PRI_PDP_INFO,
    MSG_ID_TCM_UT_CHECK_CALLBACK_L4CTCM_GET_GPRS_STATISTICS_INFO,
    MSG_ID_TCM_UT_CHECK_CALLBACK_L4CTCM_QUERY_NEG_QOS_INFO, // __GPRS_BEARER_REPORT_NEGOTIATED_QOS__
    MSG_ID_TCM_UT_CHECK_CALLBACK_L4CTCM_GET_EXT_GPRS_STATISTICS_INFO,
    MSG_ID_TCM_UT_CHECK_CALLBACK_L4CTCM_QUERY_EXT_GPRS_HISTORY,
    ...
    MSG_ID_TCM_UT_CHECK_CALL_HISTORY_CONTEXT_CONTENT,
    MSG_ID_TCM_UT_CHECK_CALL_HISTORY_CONTEXT_CONTENT_SMALL,
    ...
    MSG_ID_TCM_UT_CHECK_CALLBACK_CHECK_PDP_CONTEXT_EXIST_OR_DURING_ACTIVATING_FUNC,
          MSG_TAG_TCM_LAST_UT_MSG = MSG_ID_TCM_UT_CHECK_CALLBACK_CHECK_PDP_CONTEXT_EXIST_OR_DURING_ACTIVATING_FUNC,
    #endif // ~ __TCM_UT__
    ...
    MSG_ID_L4CTCM_SET_CONFIG_OPTION_REQ, //__WINCE__
    MSG_ID_L4CTCM_ENTER_DATA_MODE_REQ, //mtk00758: for WM +CGDATA = M-WM
    MSG_ID_L4CTCM_SET_MSQ_MODE_REQ,     /* __MEDIATEK_SMART_QOS__ */
    MSG_ID_L4CTCM_SET_MSQ_ENTRY_REQ,    /* __MEDIATEK_SMART_QOS__ */
          MSG_TAG_TCM_LAST_AT_RELATED_MSG = MSG_ID_L4CTCM_SET_MSQ_ENTRY_REQ,



    /* APN Control List related process */
    ...
    /* 3G RAT preservation related process */
    ...
    /* 2G CS suspend PS inform MOD_PPP */
    MSG_ID_SMREG_PS_SUSPEND_IND, // NSN IOT 20080901
          MSG_TAG_TCM_FIRST_PS_SUSPEND_RELATED_MSG = MSG_ID_SMREG_PS_SUSPEND_IND,
    MSG_ID_SMREG_PS_RESUME_IND, // NSN IOT 20080901
    ...
    /* Carlson 2009.04.18 PPP Type PDP Dialup Feature */
...
//SSAGPS
   ...
   MSG_ID_CSM_CODE_END  = MSG_ID_CSM_TIMER_EXPIRY,
	...
	MSG_ID_SMSAL_CODE_END = MSG_ID_L4CSMSAL_CB_MSG_REMOVAL_REQ,
	/*------------------ SMSAL_MSG_CODE_END --------------------*/
...
#if defined(__SIM_ME_LOCK__) && defined(__TMO_SIM_LOCK__)
...
#endif /* #if defined(__SIM_ME_LOCK__) && defined(__TMO_SIM_LOCK__) */
...
MODULE_MSG_BEGIN( MSG_ID_RAC_CODE_BEGIN )
   ...
   MSG_ID_GMMREG_PEER_REJECT_IND, //for __MMDC__
   MSG_ID_GMMREG_TO_PEER_INFO_IND,
#endif
   ...
   MSG_ID_GMMREG_RESTART_CLEAR_CODE_33_PROC_IND,
   MSG_ID_L4CRAC_NW_REG_STATUS_IND,
   MSG_ID_GMMREG_REG_STATUS_IND,
   MSG_ID_RAC_CODE_END = MSG_ID_GMMREG_REG_STATUS_IND,
...
MODULE_MSG_BEGIN( MSG_ID_PS_CODE_BEGIN )	    
   ...
   MSG_ID_L4C_UPS_KPALIVE_ACTIVATE_CNF,
   MSG_ID_L4C_UPS_KPALIVE_DEACTIVATE_CNF,
   MSG_ID_PS_CODE_END = MSG_ID_L4C_UPS_KPALIVE_DEACTIVATE_CNF,
   /*----------AS_MSG_CODE_END -----------------*/
MODULE_MSG_END( MSG_ID_PS_CODE_TAIL )	       

MODULE_MSG_BEGIN( MSG_ID_UEGW_CODE_BEGIN )	    
   /*----------UEGW_MSG_CODE_BEGIN -----------------*/
   MSG_ID_L4UEGW_AT_RESPONSE_IND = MSG_ID_UEGW_CODE_BEGIN,
   MSG_ID_UEGW_CODE_END = MSG_ID_L4UEGW_AT_RESPONSE_IND,
   /*----------UEGW_MSG_CODE_END -----------------*/
MODULE_MSG_END( MSG_ID_UEGW_CODE_TAIL )	    
