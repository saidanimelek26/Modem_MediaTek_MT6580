...
typedef enum {	
	MOD_ID_SRV_CODE_BEGIN, MOD_ID_SRV_CODE_TAIL = MOD_ID_SRV_CODE_BEGIN + 23,
	
	MOD_ID_MODEM_2G3G_CODE_BEGIN, MOD_ID_MODEM_2G3G_CODE_TAIL = MOD_ID_MODEM_2G3G_CODE_BEGIN + 200,
		
	MOD_ID_MIDDLEWARE_CODE_BEGIN, MOD_ID_MIDDLEWARE_CODE_TAIL = MOD_ID_MIDDLEWARE_CODE_BEGIN + 65,

	MOD_ID_DRV_CODE_BEGIN, MOD_ID_DRV_CODE_TAIL = MOD_ID_DRV_CODE_BEGIN + 65,

	MOD_ID_HISR_CODE_BEGIN, MOD_ID_HISR_CODE_TAIL = MOD_ID_HISR_CODE_BEGIN + 21,
			
  	MOD_ID_CODE_END,  
	MOD_ID_END = MOD_ID_CODE_END,
	END_OF_MOD_ID_BEGIN = 383, END_OF_MOD_ID_TAIL,
