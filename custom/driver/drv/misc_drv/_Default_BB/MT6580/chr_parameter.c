...
*************************************************************************/
   ...
   #endif // #ifdef BMT_CHARGER_ACTION_WITH_GPIO
...
#endif // #if defined(_GPIO_DETECT_USB_CHARGER_) 
#endif // #ifdef __CUST_NEW__
...
#endif // #if defined(PMIC_6305_USB_FUNCTION)
...
#endif // #if defined(PMIC_6318_USB_FUNCTION)

/* Below is just reference codes for MT6238PMU */
#if defined(PMIC_6238_USB_FUNCTION)
extern void pmic_charging_currnet_ctrl(pmic_charging_current current);
...
#define USB_CHARGE_CURRENT_TABLE_SIZE	(sizeof(USB_CHARGE_CURRENT) / sizeof(kal_uint16))
static const pmu_chr_cur_level  PMIC6318_USB_CHARGE_CURRENT[USB_CHARGE_CURRENT_TABLE_SIZE - 1] =
{
   CHR_CUR_450,
   CHR_CUR_300,
   CHR_CUR_225,
...
void usb_set_chr_current(kal_uint8 index)
{
	...
	ASSERT(index < (USB_CHARGE_CURRENT_TABLE_SIZE - 1));
	level = PMIC6318_USB_CHARGE_CURRENT[index];
...
#endif // #if defined(PMIC_6238_USB_FUNCTION)

/* Below is just reference codes for MT6326 PMIC */
#if defined(PMIC_6326_USB_FUNCTION)
extern void pmic_charging_currnet_ctrl(pmic_charging_current current);
...
#define USB_CHARGE_CURRENT_TABLE_SIZE	(sizeof(USB_CHARGE_CURRENT) / sizeof(kal_uint16))
static const chr_chr_current_enum  PMIC6326_USB_CHARGE_CURRENT[USB_CHARGE_CURRENT_TABLE_SIZE - 1] =
{
   CHR_CURRENT_450MA,
   CHR_CURRENT_300MA,
   CHR_CURRENT_225MA,
...
#endif // #if defined(PMIC_6326_USB_FUNCTION)
