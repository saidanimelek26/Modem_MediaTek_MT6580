...
#define SML_SIZE_OF_VERSION             4
#define SML_SIZE_OF_LENGTH              2
#define SML_SIZE_OF_MCC_MNC             4
#define SML_SIZE_OF_GID                 2
#define SML_SIZE_OF_MCC_MNC_GID         6
#define SML_SIZE_OF_RESERVED            2
#define SML_SIZE_OF_START_TIME          8
#define SML_SIZE_OF_END_TIME            4
#define SML_SIZE_OF_VERIFICATION_CODE   256

#define SML_SIZE_OF_MAC                 32
#define SML_SIZE_OF_SIGNATURE           256

#define SML_MAX_SLB_SIZE                NVRAM_EF_SML_SIZE

/* TMO SIM lock blob format 1.5 */
#define SML_MAX_PLMN_NUMBER             10
#define SML_MAX_GID_NUMBER              10
#define SML_SIZE_OF_NUM_PLMN            2
#define SML_SIZE_OF_PLMN_LIST           SML_SIZE_OF_MCC_MNC * SML_MAX_PLMN_NUMBER
#define SML_SIZE_OF_NUM_GID             2
#define SML_SIZE_OF_GID_LIST            SML_SIZE_OF_GID * SML_MAX_GID_NUMBER
#define SML_SIZE_OF_IMEI                16
#define SML_SIZE_OF_UNLOCK_TIME         4

/* Invalid SML context obj length */
#define SML_INVALID_CONTEXT_OBJ_LENGTH  0xFFFF

#define SML_MAX_SHARED_KEY_LENGTH       MAX_CUST_CHL_SYM_KEY_LEN
#define SML_MAX_ENCRYPTED_KEY_LENGTH    MAX_CUST_CHL_ASYM_KEY_LEN

#define SML_NVRAM_ACCESS_ID_UPDATE_VERIFICATION_CODE  0xFD
#define SML_NVRAM_ACCESS_ID_UPDATE_SLB                0xFC
#define SML_NVRAM_ACCESS_ID_RESET_SLB                 0xFB
#define SML_NVRAM_ACCESS_ID_UNLOCK_EXPIRE             0xFA

#define SML_TIMEOUT_PERIODIC_CHECK      (KAL_TICKS_1_SEC*10)//(12*60*KAL_TICKS_1_MIN)     /* 12 hours */

#define SML_TIMER_INDEX_PERIODIC_CHECK          0x01

typedef struct {
    kal_uint8   version[SML_SIZE_OF_VERSION];                       /* 4 */
    kal_uint8   protection_scheme;                                  /* 1 */
    kal_uint8   state;                                              /* 1 */
    kal_uint8   length[SML_SIZE_OF_LENGTH];                         /* 2 */
    kal_uint8   num_of_plmn[SML_SIZE_OF_NUM_PLMN];                  /* 2 */
    kal_uint8   plmn_list[SML_SIZE_OF_PLMN_LIST];                   /* N = 4 x plmn count */
    kal_uint8   num_of_gid[SML_SIZE_OF_NUM_GID];                    /* 2 */
    kal_uint8   gid_list[SML_SIZE_OF_GID_LIST];                     /* M = 2 x gid count */
    kal_uint8   reserved[SML_SIZE_OF_RESERVED];                     /* 2 */
    kal_uint8   start_time[SML_SIZE_OF_START_TIME];                 /* 8 */
    kal_uint8   end_time[SML_SIZE_OF_END_TIME];                     /* 4 */
    kal_uint8   imei[SML_SIZE_OF_IMEI];                             /* 16 */
    kal_uint8   verification_code[SML_SIZE_OF_VERIFICATION_CODE];   /* 256 */
    kal_uint8   unlock_time[SML_SIZE_OF_UNLOCK_TIME];               /* 4 */
} sml_context_struct;                                               /* 42 + N + M + 256 + 4*/
