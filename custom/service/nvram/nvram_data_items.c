...
static nvram_ef_sbp_modem_config_struct NVRAM_EF_SBP_MODEM_CONFIG_DEFAULT[] = {
{
    ...
    0x40 |  
#endif
#if defined (_SBP_VIETTEL_3G_BAND_VARIANT_1_)
    0x80 |  
#endif
    0x00,
 ...
 //byte 5
#if defined(_SBP_VIETTEL_3G_BAND_VARIANT_2_)
    0x01 |
#endif
...
#if defined(__MM_INVALID_SIM_REJ_CAUSE_CONSIDER_ABNORMAL__)
    0x40 |
#endif
...
// byte 7
#if defined(__SCA_CONFIGURED_BY_CUSTOMER__)
	0x01 |
#endif
#if defined(__CONVERT_ATTACH_REJECT_FROM_CAUSE_7_TO_14__)
    0x02 | //SBP_CONVERT_ATTACH_REJECT_FROM_CAUSE_7_TO_14
#endif
//#if defined(__SBP_MT_CS_CALL_NOT_ALLOWED__)
    0x00 | //SBP_MT_CS_CALL_NOT_ALLOWED  : Default OFF so that by default MT call is allowed .
//#endif
#if defined(__CB_CHANNEL_ONLY_STORED_IN_NVRAM__)
	0x08 | //SBP_CB_CHANNEL_ONLY_STORED_IN_NVRAM
#endif
