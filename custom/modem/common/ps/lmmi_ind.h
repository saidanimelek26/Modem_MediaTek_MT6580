...
#define l4c_eq_screen_shot_req_lind(op) NULL
...
#define l4c_ss_mtlr_begin_lind(notification, ss_id) \
        l4c_ss_mtlr_begin_lind_lbs(notification, ss_id)
#define l4c_ss_aerq_begin_lind(aerq, ss_id) \
        l4c_ss_aerq_begin_lind_lbs(aerq, ss_id)
#define l4c_ss_aecl_begin_lind(aecl, ss_id) \
        l4c_ss_aecl_begin_lind_lbs(aecl, ss_id)
#define l4c_agps_new_key_needed_lind() \
        l4c_agps_new_key_needed_lind_lbs()
#define l4c_agps_reset_positioning_lind() \
        l4c_agps_reset_positioning_lind_lbs()
#define l4c_agps_cp_start_lind() \
        l4c_agps_cp_start_lind_lbs()
#define l4c_agps_cp_end_lind() \
        l4c_agps_cp_end_lind_lbs()
#else
