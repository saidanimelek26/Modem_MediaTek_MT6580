...
#define PS_QOS_PROFILE_DEFAULT_REQ_RELIABILITY_CLASS (3) // please do not modify this before consulting with MTK (This is to avoid LLC ACK mode)
//#else
//#define PS_QOS_PROFILE_DEFAULT_REQ_RELIABILITY_CLASS (0) // please do not modify this before consulting with MTK (This is to avoid LLC ACK mode)
//#endif
...
#define PS_QOS_PROFILE_DEFAULT_REQ_SDU_ERROR_RATIO (4) // please do not modify this before consulting with MTK (This is to avoid LLC ACK mode)

#else
#define PS_QOS_PROFILE_DEFAULT_REQ_SDU_ERROR_RATIO (0) // please do not modify this before consulting with MTK (This is to avoid LLC ACK mode)
#endif
