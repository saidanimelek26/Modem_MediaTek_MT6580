...
/* use for fast roaming optimization (need to turn on by SBP 
SBP_FULLBAND_RAT_ORDER_ON_CUSTOM_SETTING), called by detecting as roaming */
const rat_enum custom_roaming_fullband_rat[MM_RAT_ENTRY_NUM] = 
    {RAT_UMTS,RAT_GSM,RAT_NONE,RAT_NONE};
#endif
...
* DESCRIPTION
*  For sim refresh cases during MM connection active
* 
*
* PARAMETERS
*
 ...
 *
 ************************************************************************/
const char *CONVERT_GPRS_NOT_ALLOWED_IN_PLMN_TO_PROTOCOL_ERROR[] = {"46000F", CONVERT_GPRS_NOT_ALLOWED_IN_PLMN_TO_PROTOCOL_ERROR_SET_END};
...
const rat_enum CUSTOM_BL_RAT[] = {RAT_UMTS, RAT_NONE};
#endif
...
* DESCRIPTION
*  This function is used to get t3x11 timer period for enhance SoR, only 
rejected by network failure start t3211 would call this function
