 ...
 * $Log$
 *
 * 03 05 2015 bart.liang
 * [MOLY00090520] [Need Patch] MT6580_DEV build error for MT6580_BASIC(DEFAULT)
 *
 * 01 09 2014 vend_bob.chiang
 * [MOLY00052621] [CMCC Case][½éæ¼«æ¸¸][MT6592]Externel (EE),0,0,99,/data/core/,1,modem,md1:[Fatal error (task)] err_code1:773 err_code2:-2004352967
 * .
 *
 * 12 28 2013 vend_bob.chiang
 * [MOLY00051916] ?G750-T00‘è¯»™IMEI·å¤±è´¥ïè·ŸALPS01209771 °è±¡ä¸?ä·ï
 * .
 *
 * 11 15 2013 vend_bob.chiang
 * [MOLY00046566] [Need Patch] [Volunteer Patch] low battery protect
 * .
 *
 * 02 08 2013 shyla.lan
 * [MOLY00009451] [FT] META MODE Trace
 * .
 *
