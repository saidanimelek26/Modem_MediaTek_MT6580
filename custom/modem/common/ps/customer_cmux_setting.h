...
#define DEFAULT_CMD_CL 				    CMUX_CL1
#else
#define DEFAULT_CMD_CL 				    CMUX_CL2
#endif
...
#ifdef __SP_RIL_SUPPORT__
#define DEFAULT_DATA_CL 			    CMUX_CL1
#else
#define DEFAULT_DATA_CL 			    CMUX_CL2
#endif
...
#define DEFAULT_VT_RX_BUFFER_SIZE       641     //161 
#define DEFAULT_VT_RX_LOW_THRESHOLD     0
#define DEFAULT_VT_RX_HIGH_THRESHOLD    320     //100
#else
...
CMUX_CH_CONFIG( 24,  DEFAULT_DATA_CL, 15, DEFAULT_DATA_N1, MOD_VT) // DLCI=24, Priority=15 (between CMD and DATA)
#endif
#endif /* __VT_TRANSPORT_SUPPORT__ */
...
CMUX_CH_CONFIG( 25,  DEFAULT_DATA_CL, 16, DEFAULT_DATA_N1, MOD_MED)
#endif /* __DATA_CARD_SPEECH__ */
